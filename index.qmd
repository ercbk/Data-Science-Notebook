...
This notebook reflects my interest in all aspects of data science: soft skills, technical skills, backend to frontend. The notebook is in an outline format, so some of the information may seem a bit fragmented. The bullets are bits of information that I've pulled from various articles, papers, books, etc.
