...
-   Process
    ...
    -   Install TensorFlow
        ...
        -   It will download and install a bunch of packages includind CUDA packages, keras, and tensorflow. The tensorflow takes an abnormally long time to install (5min?) to the point in makes you question everything is okay.
