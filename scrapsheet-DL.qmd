...
-   Example: Basic MNIST Classification
    ...
    -   Fitting the model
        ...
        -   Process
            ...
            -   After these five epochs, the model will have performed 2,345 gradient updates
                (469 per epoch), and the loss of the model will be sufficiently low that the model will be capable of classifying handwritten digits with high accuracy.
