...
-   R
    -   [Instructions](https://cran.r-project.org/bin/linux/ubuntu/) for installing R on Ubuntu

    -   Option: Install R and RStudio Server in WSL2
    ...
    -   Install package and use with a virtual environment that has TensorFlow installed

        ``` r
        pak::pak("rstudio/tensorflow")
        library(tensorflow)
        use_virtualenv("tf_env")
        ```
