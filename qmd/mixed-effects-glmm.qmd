...
- [{]{style="color: #990000"}[BayesRTMB](https://cran.r-project.org/web/packages/BayesRTMB/index.html){style="color: #990000"}[}]{style="color: #990000"} - Provides tools for Markov chain Monte Carlo (MCMC) and Maximum A Posteriori (MAP) estimation utilizing [{]{style="color: #990000"}[RTMB](https://cran.r-project.org/web/packages/RTMB/index.html){style="color: #990000"}[}]{style="color: #990000"}.
