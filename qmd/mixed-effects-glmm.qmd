...
-   [Example 1]{.ribbon-highlight}: GAMM with Varying Intercepts ([source](https://freerangestats.info/blog/2024/12/23/depression-and-vote))\
    ...
    -   The goal was to account for some of the probable spatial autorcorrelation, but the R^2^ indicates a worse fit.
    ...
    -   Centroid Calculations
        ...
        dat_votes_dep_spat <- dat_votes_dep |>
