...
-   **Coefficient of Variation (CV)**- aka **relative standard deviation (RSD)** - aka **Dispersion parameter** - Measure of the relative dispersion of data points in a data series around the mean. Usually expressed as a percentage.
    ...
    -   A more robust possibility is the quartile coefficient of dispersion, half the interquartile range divided by the average of the quartiles (the midhinge)
        ...
        ![](./_resources/Statistical_Concepts.resources/ql_4b9d5f3e627ab7f978e29b61268f9046_l3.png)

    -   For small samples (Normal Distribution)\
        ![](./_resources/Statistical_Concepts.resources/ql_12146be7d54693d0faece8583bbd9c11_l3.png)

    -   For log-normal distribution\
        ![](./_resources/Statistical_Concepts.resources/ql_abeafbaca1b20bacb081a92baccfa528_l3.png)
...
-   **Margin of Error (MoE)** - the range of values below and above the sample statistic in a confidence interval.\
    ![](./_resources/Statistical_Concepts.resources/image.2.png)
...
-   **Normalization** rescales the values into a specified range, typically \[0,1\]. This might be useful in some cases where all parameters need to have the same positive scale. However, the outliers from the data set are lost.\
    ![](./_resources/Statistical_Concepts.resources/Screenshot%20(342).png){width="232"}
...
-   **Standardization** rescales data to fit the Standard Normal Distribution which has a mean (μ) of 0 and standard deviation (σ) of 1 (unit variance).\
    ![](./_resources/Statistical_Concepts.resources/Screenshot%20(343).png){width="232"}
...
-   **Variance** (σ^2^)- measures variation of a random variable around its mean.
...
-   **Power** - 1-β where beta is the Probability of a type II error ![](./_resources/Statistical_Concepts.resources/FICztEUXMAUwvGi.png){width="632"}
...
-   **Romano and Wolf's Ccorrection**
    ...
    -   Packages
        -   [[{wildrwolf}](https://s3alfisc.github.io/wildrwolf/)]{style="color: #990000"}: implements Romano-Wolf multiple-hypothesis-adjusted p-values for objects of type fixest and fixest_multi from the fixest package via a wild cluster bootstrap.

## Bootstrapping {#sec-math-statc-boot .unnumbered}

-   [Misc]{.underline}
    -   [Post-Hoc Analysis, general](Post-Hoc%20Analysis,%20general) \>\> Frequentist \>\> Bootstrapping
...
## P-Value (aka Confidence Interval) Function {#sec-math-statc-desc-pvfun .unnumbered}
