...
-   Oja Depth
    ...
    -   Computationally intensive
    -   Use Case
        -   35 Canadian weather stations are divided into two groups — "the eastern and western coastal areas, and the northern and central southern areas — and our research question is: Is there a significant difference in the typical temperature curves between these two groups?" ([source](https://arxiv.org/abs/2411.11580))
