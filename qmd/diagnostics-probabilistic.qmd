...
- **Continuous Ranked Probability Score** (CRPS)
  - See notebook (pg 172), [paper](https://sites.stat.washington.edu/raftery/Research/PDF/Gneiting2007jasa.pdf)
  - Measures forecast distribution accuracy by combining a MAE score with the spread of simulated point forecasts
  - `fabletools::accuracy`
