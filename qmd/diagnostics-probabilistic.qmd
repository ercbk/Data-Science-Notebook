...
-   AIC vs BIC ([paper](https://t.co/6Lfs0ilrKF))\
    ![](./_resources/Diagnostics,_Probabilistic.resources/image.png){width="632"}
    -   AIC
...
-   [(Randomized) quantile-quantile residuals plot]{.underline}\
    ![](./_resources/Diagnostics,_Probabilistic.resources/Screenshot%20(310).png){width="432"}
    ...
    -   Compare with a bad model\
        ![](./_resources/Diagnostics,_Probabilistic.resources/Screenshot%20(327).png){width="432"}
...
-   [(Randomized) quantile-quantile residuals plot]{.underline}\
    ![](./_resources/Diagnostics,_Probabilistic.resources/Screenshot%20(312).png){width="432"}
    ...
    -   Compare with a bad model\
        ![](./_resources/Diagnostics,_Probabilistic.resources/Screenshot%20(325).png){width="432"}
...
-   [(Hanging) Rootogram]{.underline}\
    ![](./_resources/Diagnostics,_Probabilistic.resources/Screenshot%20(314).png){width="432"}
    ...
    -   Compare with a bad model\
        ![](./_resources/Diagnostics,_Probabilistic.resources/Screenshot%20(323).png){width="432"}
...
-   [Reliability Diagram]{.underline}\
    ![](./_resources/Diagnostics,_Probabilistic.resources/Screenshot%20(316).png){width="432"}
...
-   [Worm plot]{.underline}\
    ![](./_resources/Diagnostics,_Probabilistic.resources/Screenshot%20(318).png){width="432"}
