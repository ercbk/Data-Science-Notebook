...
- Tools
  - See [FOSS Tools for Lazy Editors](https://ropensci.org/blog/2026/07/02/editor-tools/#fn:3) for set-up of these tools
  - Spell checking with [cSpell](https://cspell.org/)
  - Linting with [Vale](https://vale.sh/)
    - With respect to text or prose means checking the style and meaning of the words
...
- Tips ([source](https://www.nature.com/articles/s41568-026-00954-8))\
  ![](_resources/Job-Reports.resources/good-talk-tips.jpeg){.lightbox width="325"}
- Resources
  - [Making Slides](https://kieranhealy.org/blog/archives/2018/03/24/making-slides/) (Healy)
- Prep
  - Create an outline
