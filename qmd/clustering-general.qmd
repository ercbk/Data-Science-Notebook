...
-   Run a decision tree on clusters![](./_resources/Clustering.resources/Screenshot%20(279).png){width="632"}
    -   Each color (orange, blue, green, purple) represents a cluster
    -   Explains how clusters were generated
    -   [[{treeheatr}](https://trang1618.github.io/treeheatr/)]{style="color: #990000"}![](./_resources/Clustering.resources/image.1.png){width="632"}
-   Radar charts![](./_resources/Clustering.resources/image.png){width="532"}
...
-   Components of the Algorithm
    -   "Color" points according to gaussians (clusters)
        ...
        -   ![](./_resources/Clustering.resources/Screenshot%20(32).png){width="532"}
        -   
    -   Fitting a Gaussian
        ...
        -   Find the spread of the points
            ...
            -   ![](./_resources/Clustering.resources/Screenshot%20(34).png){width="632"} First equation is the height of Gaussian (multi-variate Gaussian distribution equation). (Second equation is just the familiar 1-D gaussian equation for reference)
            ...
            -   Partially "colored" points affect spread and center of mass calculations
                ...
                -   ![](./_resources/Clustering.resources/Screenshot%20(36).png){width="432"}
-   Steps
...
## DBSCAN![](./_resources/Clustering.resources/1-rLkYqpNmEguxDPuhLaTtVA.png){width="532"}
...
-   Algorithm
    -   For each data point, find the points in the neighborhood within *eps* distance, and define the core points as those with at least *minPts* neighbors.![](./_resources/Clustering.resources/Screenshot%20(1418).1.png){width="432"}
    ...
    -   Define groups of connected core points as clusters.![](./_resources/Clustering.resources/Screenshot%20(1419).2.png){width="432"}
        -   All the green points have been labelled as core points
    -   Assign each non-core point to a nearby cluster if it's directly reachable from a neighboring core point, otherwise define it as an outlier.![](./_resources/Clustering.resources/Screenshot%20(1420).png){width="432"}
...
-   Advantages
    ...
    -   Clusters formed by DBSCAN can be any shape, which makes it robust to different types of data.
        -   Example: Nested Cluster Structure
            -   K-Means![](./_resources/Clustering.resources/Screenshot%20(1418).png){width="432"}
                -   K-Means wants spherical clusters which makes it grab groups of points it shouldn't
            -   DBSCAN![](./_resources/Clustering.resources/Screenshot%20(1419).png){width="432"}
