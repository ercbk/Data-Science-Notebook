...
-   Misc
    ...
    -   Notes from: [Bayesian workflow book - Digits](https://avehtari.github.io/casestudies/Digits/digits.html)
    -   [{]{style="color: #990000"}[bayestestR::rope](https://easystats.github.io/bayestestR/reference/rope.html){style="color: #990000"}[}]{style="color: #990000"} ([Vignette](https://easystats.github.io/bayestestR/articles/region_of_practical_equivalence.html)) is the Region of Practical Equivalence (ROPE)
        ...
        -   Doesn't seem like a reliable measure if the scale of the predictor can affect significance.
        -   Issues
            ...
            -   Collinearity invalidates ROPE and hypothesis testing based on univariate marginals, as the probabilities are conditional on independence.
                ...
                -   Strong collinearity makes bayesian coefficients uninterpretable, which is always a concern, so I'm not as worried about this one.
