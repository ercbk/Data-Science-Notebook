...
-   Simple methods would be Forward filling which means fill missing values with previous data or Backward filling means fill missing values with next data point.
