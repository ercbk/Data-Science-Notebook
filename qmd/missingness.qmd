...
-   Recommendations ([article](https://towardsdatascience.com/what-is-a-good-imputation-for-missing-values-e9256d45851b))
    -   N \> 200 $\rightarrow$ Nonparametric
        -   e.g. [{]{style="color: #990000"}[mice::mice.imput.cart](https://amices.org/mice/reference/mice.impute.cart.html){style="color: #990000"}[}]{style="color: #990000"} (decision trees), [{]{style="color: #990000"}[mice-drf](https://github.com/JeffNaef/MARimputation/tree/c1f5a1e48e8a60db95c727876086db5b7305f614/Useable){style="color: #990000"}[}]{style="color: #990000"} (distributional random forest)
    ...
    -   N \< 200 $\rightarrow$ Parametric
        -   e.g. [{]{style="color: #990000"}[mice::mice.impute.norm.nob](https://amices.org/mice/reference/mice.impute.norm.nob.html){style="color: #990000"}[}]{style="color: #990000"} (linear regression)
...
-   (\*\* Don't use this. Just putting it here in order to be aware of it \*\*) "Standard Procedure" for choosing an imputation method ([article](https://towardsdatascience.com/what-is-a-good-imputation-for-missing-values-e9256d45851b))
    -   Issues
        ...
        -   Chosen methods tend to artificially strengthen the association between variables. As a consequence, statistical estimation and inference techniques applied to the so-imputed data set can be invalid.
    -   Steps
...
-   [I-Score]{.underline}
    -   [{]{style="color: #990000"}[Iscores](https://github.com/missValTeam/Iscores){style="color: #990000"}[}]{style="color: #990000"}, [Paper](https://arxiv.org/abs/2106.03742)
