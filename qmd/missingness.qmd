...
* Also see
	* [EDA](EDA) >> Missingness
	* [Model Building, tidymodels](Model Building, tidymodels) >> Imputation
...
* Missness Types (MCAR, MAR, and MNAR)![](./_resources/Missingness.resources/Screenshot (541).png)
...
* Missingness in RCT due dropouts (aka _loss to follow-up_)
...
* (\*\* Don't use this. Just putting it here to be aware of \*\*) Standard Procedure for choosing an imputation method
	* Issues
		* Some methods will be favored based on the metric used
			...
			* conditional medians methos (MAE)
