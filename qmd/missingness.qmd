...
-   Packages
    ...
    -   [{]{style="color: #990000"}[DebiasInfer](https://github.com/zhangyk8/Debias-Infer/tree/main/R_Package){style="color: #990000"}[}]{style="color: #990000"} ([Paper](https://arxiv.org/abs/2309.06429)) - Debiasing method for conducting valid inference on the **high-dimensional linear regression function with missing outcomes that MAR**
