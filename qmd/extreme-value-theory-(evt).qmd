...
* Misc
* Distributional Tail Classification
...
* Packages
	* [{]{style='color: #990000'}[erf](https://www.ngnecco.com/erf/index.html){style='color: #990000'}[}]{style='color: #990000'} - able to extrapolate extimates beyond the training data since erf is based on EVT and is also flexible since it uses a RF![](./_resources/Extreme_Value_Theory_(EVT).resources/Screenshot (1395).png)![](./_resources/Extreme_Value_Theory_(EVT).resources/Screenshot (1396).png)
...
* {erf} and {gbex} peform better than regular quantile rf model types for quantiles > 0.80 ([video](https://www.youtube.com/watch?v=Mpzqz4y1oYY): from the 33min mark to 55:19, results towards the end)
...
* Why using Random Forest models that do NOT incorporate EVT usually don't produce good results.
	* Typical RF weighs every data point equally while a grf (see [Regression, Quantile](Regression, Quantile)), depending on the quantile estimate, will weigh data points closer to the quantile more heavily
	...
	* Subsets of heavy tails
		...
		* long tails
			...
			* subexponential tails
				...
				* fat tails
					* ![](./_resources/Extreme_Value_Theory_(EVT).resources/9fdb1155cb376fdb4f0b02f7135b65ea.png)
