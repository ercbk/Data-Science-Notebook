...
-   Packages
    -   [CRAN Task View](https://cran.r-project.org/web/views/ExtremeValue.html)\
        ...
        ::: {layout-ncol="2"}
        ![](_resources/Extreme_Value_Theory_(EVT).resources/primary-pkgs-1.png){.lightbox width="302"}

        ![](_resources/Extreme_Value_Theory_(EVT).resources/other-pkgs-1.png){.lightbox width="259"}
        :::

        -   List of primary packages (left) and other relevant packages (right) according the {extRemes} author in a 2015 slide deck (see below)
