...
-   Packages
    ...
    -   [{]{style="color: #990000"}[terra](https://rspatial.github.io/terra/){style="color: #990000"}[}]{style="color: #990000"} - Provides methods to manipulate geographic (spatial) data in "raster" and "vector" form
-   Resources
