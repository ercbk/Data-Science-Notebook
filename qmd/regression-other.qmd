...
-   [Continuous]{.underline}
    ...
    -   Solutions
        -   Normalize Y by a pretreatment baseline
            ...
            -   In regression, average treatment effect (ATE) would then be![](./_resources/Regression,_Other.resources/Screenshot%20(1121).png){.lightbox width="183"}
...
-   Commonly used to overcome binomial or "megaphone-shaped" types of heteroskedacity of OLS residuals\
    ![](./_resources/Regression,_Other.resources/1-lJYcKOFR88JFo76QPSdvPQ.png){.lightbox width="400"}\
    ![](./_resources/Regression,_Other.resources/1-lK2Ho8Lu_gpUXFR5bh3GPw.png){.lightbox width="400"}
-   [Misc]{.underline}
    -   Also see
