...
-   Rates between 0 and 1
    ...
    -   Outcome with 0s and 1s
        ...
        -   Quasi-Binomial GLM
            -   The link function is used in logistic regression and the relationship of the mean and variance allows the variance to be larger (or smaller) by some consistent ratio.
