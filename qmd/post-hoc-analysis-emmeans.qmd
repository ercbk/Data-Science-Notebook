...
* CIs for emmeans are wider than that of emmeans calculated by [{ggeffects}]{style='color: #990000'}. (no change when I tried different lmer.df args)
	* Can't really figure out why. There is a lmer.df arg that _should_ affect the std.errors and CIs for lmer models.
...
* Example
	...
	* Inferential question: which categories of packaging and features are _inherently_ more profitable?
...
* emmeans gives an _equally weighted_ estimation of the mean
