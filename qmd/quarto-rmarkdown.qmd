...
## Functions {#sec-quarto-fun .unnumbered}
...
## Knitr Hooks {#sec-quarto-hook .unnumbered}
...
## Multiple Programming Languages {#sec-quarto-rpy .unnumbered}
...
-   Misc
    ...
    -   Print out the code of a function from a file ([source](https://www.tjmahr.com/unenv/#forwarding-a-function-definition-into-a-knitr-code-chunk))\
        ![](_resources/Quarto_RMarkdown.resources/auto-print-code-1.jpg){.lightbox width="432"}
...
-   Template
    ...
    -   [Example 2]{.ribbon-highlight} ([source](https://www.youtube.com/watch?v=bp1SMhLoz_M&ab_channel=PositPBC))\
        ![](_resources/Quarto_RMarkdown.resources/typst-ex2-report.png){.lightbox width="256"}
        -   Show
...
-   [closeread](https://closeread.netlify.app/) ([video](https://www.youtube.com/watch?v=KqLxy66B3lQ&ab_channel=PositPBC)) - Scrollytelling
    -   Rennie example ([code](https://github.com/nrennie/scrollytelling), [source](https://fosstodon.org/@nrennie/113913420516653587))
        ...
        ::: {layout-ncol="2"}
        ![](_resources/Quarto_RMarkdown.resources/ext-clre-rennie-ex-1.png){.lightbox group="clre-renn-1" width="332"}

        ![](_resources/Quarto_RMarkdown.resources/ext-clre-rennie-ex-2.png){.lightbox group="clre-renn-1" width="332"}
        :::
