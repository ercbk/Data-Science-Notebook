...
-   Using a development verison of Quarto
    ...
    -   First Usage
        ...
        -   Should be able to use in RStudio
            ...
            -   I also rendered a qmd file using `quarto-cmd` from the root directory of quarto-cli to see if it matched the output from RStudio. (Command in the background jobs tab when you render the file in RStudio)
...
-   Knitr Hooks
    ...
    -   Chunk Hooks
        ...
        -   [Example]{.ribbon-highlight}: Chunk Timer
            ...
            -   Output\
                ![](_resources/Quarto_RMarkdown.resources/chunk-hook-timer-out-1.png){width="432"}
