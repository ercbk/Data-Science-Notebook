...
-   Packages
    ...
    -   [{]{style="color: #990000"}[froggeR](https://github.com/kyleGrealis/froggeR){style="color: #990000"}[}]{style="color: #990000"}{style="color: #990000"} - Reusable templates and project structures
