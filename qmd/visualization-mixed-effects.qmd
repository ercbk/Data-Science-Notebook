...
-   Packages
    -   [{]{style="color: #990000"}[modeldiagramR](https://cran.r-project.org/web/packages/modeldiagramR/index.html){style="color: #990000"}[}]{style="color: #990000"} - Generate Model Diagrams for Linear Mixed Effect Models
-   Papers
