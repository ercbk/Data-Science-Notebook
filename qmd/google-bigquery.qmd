    ...
    -   Pricing
        ...
        -   CloudSQL has 2 types: Per Use and Packages
            -   If usage over 450 hours monthly, then packages is a good option\
                ![](./_resources/Google,_BigQuery.resources/Cloud_SQL_vs_BigQuery_image2.png){width="427"}\
                ![](./_resources/Google,_BigQuery.resources/Cloud_SQL_vs_BigQuery_image1.png){width="575"}
                -   Left pic is Per Use pricing; Right pic is Package pricing
        -   BigQuery based on Usage\
            ![](./_resources/Google,_BigQuery.resources/Cloud_SQL_vs_BigQuery_image3.png){width="500"}
...
-   UNPIVOT\
    ![](./_resources/Google,_BigQuery.resources/image.7.png){width="144"}
...
-   Declare/Set
    ...
    -   [Example]{.ribbon-highlight}: Basic\
        ![](./_resources/Google,_BigQuery.resources/image.10.png){width="321"}
...
-   Loop/Leave
    -   [Example]{.ribbon-highlight}: Loops until a condition is met before running your SQL statements\
        ![](./_resources/Google,_BigQuery.resources/image.12.png){width="656"}
...
-   Experiment  
    ![](./_resources/Google,_BigQuery.resources/0-MbD4H5Gvm6j6oSVr.png){width="550"}  
    ![](./_resources/Google,_BigQuery.resources/0-dsIFjERRMCpXxFCZ.png){width="550"}
    ...
    -   X-axis is the duration of the query  
        ![](./_resources/Google,_BigQuery.resources/1-2JtIjC0SmJHfak7CDh5gGg.png){width="550"}
...
-   [`LIMIT` speeds up performance, but doesn't reduce costs]{.underline}
    ...
    -   Table Preview\
        ![](./_resources/Google,_BigQuery.resources/1-GUq9WkPsPxiJVsKaNDkHoA.png){width="483"}
