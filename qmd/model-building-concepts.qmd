...
-   Packages
    ...
    -   [[{broom}](https://broom.tidymodels.org/articles/available-methods.html)]{style="color: #990000"}[supported model classes](https://broom.tidymodels.org/articles/available-methods.html)
