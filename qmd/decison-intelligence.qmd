...
-   EU\[D(a)\] : Expected utility of a decision-making situation (aka lottery) for a particular action, a![](./_resources/Decison_Intelligence.resources/Screenshot%20(657).png)
    -   The goal is to choose an action that maximizes this value (aka Maximized Expected Utility (MEU))

Framework ![](./_resources/Decison_Intelligence.resources/image.2.png)
...
-   Expected Utility with prior information![](./_resources/Decison_Intelligence.resources/Screenshot%20(660).png)
    -   To calculate the Expected Utility this equation gets manipulated into![](./_resources/Decison_Intelligence.resources/Screenshot%20(667).png)
        ...
        -   Basically there are two parts:
            ...
            -   where![](./_resources/Decison_Intelligence.resources/Screenshot%20(668).png)
...
-   [Example]{.ribbon-highlight} (Decision Rule based on prior information)![](./_resources/Decison_Intelligence.resources/Screenshot%20(662).png)
...
-   [Example]{.ribbon-highlight} (Risk Averse Curve)![](./_resources/Decison_Intelligence.resources/Screenshot%20(669).1.png)
...
-   Data for examples![](./_resources/Decison_Intelligence.resources/Screenshot%20(673).png)

    -   Marker is a numeric
    -   cancerpredmarker is fitted probabilities from a logistic regression

-   [Example]{.ribbon-highlight}: Compare Multivariable model to Univariate model![](./_resources/Decison_Intelligence.resources/Screenshot%20(679).png)
...
-   Run dca `dca(data=data.set, outcome="cancer", predictors=c("high_risk", "joint", "conditional"), xstop=0.35)`![](./_resources/Decison_Intelligence.resources/Screenshot%20(681).png)
-   Interpretation
