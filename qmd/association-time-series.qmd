...
-   [**Granger Causality**]{style="color: #009499"} - Determines whether one time series is useful (i.e. containing information beyond the lagged series of the other series) in forecasting another. Assumes stationarity and linear association.
