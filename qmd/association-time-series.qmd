...
-   Hyperparameters:
    -   **Step Pattern** - Determines how the algorithm traverses the rows of the LCM to find the optimal path
    -   **Window Range** - Limits the number lcm calculations for each point
-   Steps
    1.  Calculate LCM matrix for series X and Y where X is the **Query** or **Test Series** and Y is the **Reference Series**
    2.  Simultaneously move along each row of the LCM using a chosen step pattern (see window constraint to get part of a visual of this process)
        ...
        -   Calc the cost, DTW~p~, using the LCMs in the minimum alignment
            ...
            -   $k$: Pairs of points (or position along the x-axis) in the minimum alignment
...
-   Components
    -   [Local Cost Matrix (LCM)]{.underline}
    ...
    -   [Step Patterns]{.underline}
        ...
        -   Each pattern is a set of rules and weights
            ...
            -   The **edge weights**, $m_\phi$, are used the DTW calculation\
        -   Patterns\
            ![](./_resources/Correlation,_Association,_and_Distance.resources/image.png){width="532"}
            -   Patterns in fig
            ...
            -   Only some of the patterns are normalizable (i.e. $M_\phi$ is used in the DTW equation below) (normalize arg)
    ...
    -   [Window Constraints]{.underline}
        ...
        -   Sakoe-Chiba window creates a calculation region along the diagonal of the LCM\
            ![](./_resources/Correlation,_Association,_and_Distance.resources/Screenshot%20(46).png){width="432"}
