...
* Feedback - To maintain team members’ morale, the balance between negative and positive feedback has to tilt heavily towards the positive
	* If you can’t find that balance, then you need to consider whether the team member should continue on your team.
		If you want them to remain, then you must figure out how to articulate their positives back to them, otherwise you can expect them to leave.
...
* Misc
	...
	* Other methods
		* SBI (Situation-Behavior-Impact)
				Useful for giving better feedback by removing emotions from it and making it clear and concise
...
* Announcement emails
	...
	* Example![](./_resources/Job,_Management___Leadership.resources/image.png)
* Readouts
...
* Newletter
	...
	* Example![](./_resources/Job,_Management___Leadership.resources/image.1.png)
