...
## Remote Teams {#sec-job-man-remote .unnumbered}

- Resources
  - [Gitlab's The Remote Playbook](https://handbook.gitlab.com/handbook/company/culture/all-remote/)
- Notes from
  - [Opinion: The Secret Reason Bosses Want Everyone Back in the Office, Every Day of the Week](https://bsky.app/profile/kjephd.bsky.social/post/3mov4yskrp22q)
- Most people [care more](https://slack.com/blog/news/winning-the-war-for-talent-in-the-post-pandemic-world) about when they work than where. If they can choose the hours, they’re more willing to let leaders pick the place.
...
- Coordination counts.
  - Teams need [anchor days](https://open.spotify.com/episode/5ush5jMU78uHVzEYcdJWAy) when everyone shows up — especially to welcome newcomers and mentor junior people.
  - At Microsoft, new hires who spent at least a couple of days a month with their manager and their teams were [more satisfied](https://hbr.org/2024/06/onboarding-new-employees-in-a-hybrid-workplace) with their early experiences, which in turn meant they were more likely to stay over the next year and a half.
- The software company Atlassian has found that spending a few days with your team at a well-designed quarterly team gathering [does more](https://sloanreview.mit.edu/article/hybrid-work-is-not-the-problem-poor-leadership-is/) for connection and belonging than daily schleps to the office.
- Some organizations may balk at the costs of travel and accommodation for a team assembly, but they should think of it as an investment in the team's effectiveness. Neglecting these face-to-faces leads to teams getting stuck, heading off in the wrong direction, plagued with conflict, and people losing motivation. Compared to this, saving on airplanes and hotels is a false economy.
- Frequency
...
- Hybrid work is not one-size-fits-all. Different jobs require different amounts of time in person, and so do different people.
  - Flexibility proves particularly important in [attracting](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3894404) and [retaining](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5031481) women.
  - You need to gather together more if your staff operates like a basketball team passing the ball back and forth, rather than a gymnastics team whose members do their own individual events.
    - This explains why fully remote teams [struggle](https://www.nature.com/articles/s41586-023-06767-1) to patent new technologies, but the people who examine patent applications are [more productive](https://sms.onlinelibrary.wiley.com/doi/10.1002/smj.3251) when they can work from anywhere they like.
