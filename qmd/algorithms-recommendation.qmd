...
-   Packages
    ...
    -   [{]{style="color: goldenrod"}[superlinked](https://github.com/superlinked/superlinked){style="color: goldenrod"}[}]{style="color: goldenrod"} - Framework for building high-performance search & recommendation applications that combine structured and unstructured data
-   Model Evaluation
...
-   Best for a cold start (i.e. no user ratings are available yet)
-   Various similarity scoring algorithms
    -   Density Adjusting
    -   Vector Embedding
    -   Co-Occurrence
-   Collaborative Topic Modeling/Regression (CTM/CTR) for text-based items with enhanced accuracy and out-of-matrix prediction capabilities.
