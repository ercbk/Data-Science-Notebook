...
-   Kroger's "Forget Something"
    ...
    -   Filters
        -   Seasonal - popular items they've bought during popular holiday time intervals
            -   This should be put into a separate tab or part of a filter list
        ...
        -   Items not on their current grocery list
            -   Not automatic on Kroger's but it should be done before the list is presented to the customer
-   Ethics
