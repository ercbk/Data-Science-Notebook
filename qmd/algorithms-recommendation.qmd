...
-   Model Evaluation
    ...
    -   If you have low metrics, for [Example]{.ribbon-highlight} PrecisionK below 0.1, and you don't know what the reason is --- the data or the model, or maybe the metric calculation
    ...
    -   Scenario: Outcome = F(I,C)
        ...
        -   Categoricals are 1-hot encoded and aggregation calculations of numerics per category. Then, the category and the new numeric are combined.
            -   [Example]{.ribbon-highlight}\
                ![](./_resources/Algorithms,_Recommendation.resources/image.9.png){width="532"}
                -   e.g.
...
-   Misc
    ...
    -   If your model is producing extremely low metrics, then you could have a sparsity issue
        ...
        -   Reducing overly-sparse user/item matrices can have major effects on metric scores\
            ![](./_resources/Algorithms,_Recommendation.resources/image.6.png){width="332"}

        -   Check user/item distribution\
            ![](./_resources/Algorithms,_Recommendation.resources/image.7.png){width="432"}
...
-   **Precision/Recall\@k** ([article](https://medium.com/@m_n_malaeb/recall-and-precision-at-k-for-recommender-systems-618483226c54))
    ...
    -   *Relevance* - A relevant item for a specific user-item pair means that this item is a good recommendation for the user in question.
        -   [Example]{.ribbon-highlight}: User/Movie\
            ![](./_resources/Algorithms,_Recommendation.resources/image.8.png){width="332"}
...
-   **RecList** ([article](https://towardsdatascience.com/ndcg-is-not-all-you-need-24eb6d2f1227)) - Behavior tests; black-box-ish py library that takes a sort of sentiment analysis approach to grading recommenders
    ...
    -   "Checklist" for recommender systems (see [Diagnostics, NLP](diagnostics-nlp.qmd#sec-diag-nlp){style="color: green"})
    -   Principles
...
-   The dimension of "N_latent_factors" is a tuning parameter\
    ![](./_resources/Algorithms,_Recommendation.resources/0-i3i677_vOgdg174y.png){width="432"}
...
-   Method Comparison
    -   Typical collaborative filtering (e.g. user ids, movie ids)\
        ![](./_resources/Algorithms,_Recommendation.resources/image.3.png){width="300"}
    -   LightFM\
        ![](./_resources/Algorithms,_Recommendation.resources/image.4.png){width="332"}
...
-   **Youtube**\
    ![](./_resources/Algorithms,_Recommendation.resources/6127dfb0e2efbd15a4d0370a_dkmsReLpa7AGAu_HBk05iyoMn.png){width="532"}
...
-   **TikTok**\
    ![](./_resources/Algorithms,_Recommendation.resources/image.png){width="532"}
    -   Notes from:
...
-   [RecSys 2020 --- Takeaways and Notable Papers](https://towardsdatascience.com/recsys2020-777590f51b44)
    ...
    -   Different data splitting strategies (for train and validation) can affect the relative performance of recommendation systems in offline evaluation
        ...
        -   Relative performance of recommenders changed often across splitting strategies (indicated by the rank swaps)\
            ![](./_resources/Algorithms,_Recommendation.resources/0-NgJtaIUIWeCsIRTU.jpg){width="632"}
    -   Model Evaluation
