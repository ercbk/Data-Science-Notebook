...
-   Packages
    -   [{]{style="color: #990000"}[factree](https://cran.r-project.org/web/packages/factree/index.html){style="color: #990000"}[}]{style="color: #990000"} - Implements the Factor-Augmented Clustering Tree (FACT) algorithm
        -   Constructs a classification tree where splits are determined by covariates, and the splitting criterion is based on a group factor model representation of the time series within each node
-   Types
...
-   Papers
    ...
    -   [Clustering methods for Categorical Time Series and Sequences : A scoping review](https://arxiv.org/abs/2509.07885) (2025)
        -   Provides feature comparison tables for distance, feature, and model based methods with the following columns:
            -   Name, Subfamily, Dependency Order, Continuous Time. Various Lengths, Missing Data, Multi Variable, Covariates, Main Data Type, and Data Volume
