...
-   Also see
    ...
    -   [EDA \>\> Correlation](Data-Science-Notebook/qmd/eda-general.qmd#sec-eda-gen-corr){style="color: green"}
...
-   Relationship between PDF and CDF (e.g. exponential distribution)\
    ![](./_resources/Correlation,_Association,_and_Distance.resources/Screenshot%20(1310).png){width="532"}
...
-   The inverse of the CDF give you the value of x for any probability\
    ![](./_resources/Correlation,_Association,_and_Distance.resources/Screenshot%20(1312).png){width="332"}
    ...
    -   Whichever distribution's CDF-1 is used, the output of that function will be from that distribution (e.g. 2, 0.7)
        -   Mathematically:
            ...
            x_i = \mbox{CDF}^-1(u_i)
            $$\
            ![](./_resources/Correlation,_Association,_and_Distance.resources/image.10.png)
...
-   For two random variables $S_1$, $S_2$ in $[-\infty, \infty]$. $S_1$ and $S_2$ have their own fixed, continuous CDFs, $F_1$, $F_2$.
    ...
    -   Now take the uniformly distributed quantile random variable, $U_1(S_1)$, $U_2(S_2)$. For every pair, $(u_1, u_2)$, drawn from the pair's quantile, we define the \*bivariate copula, $C: [0,1] \times [0,1] \rightarrow [0,1]$ as:
        ...
        C(u_1, u_2) &= P(U_1 \leq u_1, U_2 \leq u_2) \\
                    &= P(S_1 \leq F_1^{-1}(u_1), S_1 \eq F_2^{-1}(u2)) \\
...
-   ![](./_resources/Correlation,_Association,_and_Distance.resources/copula_marginal_dist_demo-1-1030x814.png){width="632"}
    ...
    -   Mathematically the *cumulative conditional probabilities* shown in the scatter plot are given by taking partial derivatives of the joint inverse CDF:\
        ![](./_resources/Correlation,_Association,_and_Distance.resources/ql_f33a4928dfb8981a6bb9503e7bad03eb_l3.png){width="332"}
        -   Aside: taking the derivative of a (not inverse) marginal (not joint) CDF is the pdf
    -   The *copula density* is defined as:\
        ![](./_resources/Correlation,_Association,_and_Distance.resources/ql_0ab910a450fad934b5dda1293c24b142_l3.png)
...
-   Types
    ...
    -   Archimedean
        -   Parametric and uniquely determined by generator functions, φ, that use a parameter, θ
            ...
            -   Generators:\
                ![](./_resources/Correlation,_Association,_and_Distance.resources/ql_b60450bac891bd09aefaeb365a3de92a_l3.png){width="532"}
...
-   Notes
    -   Definition\
        ![](./_resources/Correlation,_Association,_and_Distance.resources/image.1.png){width="241" height="40"}
        -   Copulas are joint cumulative distribution functions (c.d.f.) for unit-uniform random variables
    -   Probability integral transform\
        ![](./_resources/Correlation,_Association,_and_Distance.resources/image.2.png){width="282"}
        ...
        -   Transform a uniform random variable to any continuous random variable\
            ![](./_resources/Correlation,_Association,_and_Distance.resources/image.3.png){width="288" height="39"}
    ...
    -   Gaussian Copula\
        ![](./_resources/Correlation,_Association,_and_Distance.resources/image.5.png){width="259"}
-   [Example]{.ribbon-highlight}
    ...
    -   Sample from a Copula
        ...
        -   Code (Julia)
            ...
            ```
-   Visuals\
    ![](./_resources/Correlation,_Association,_and_Distance.resources/image.7.png){width="632"}
...
-   [Example]{.ribbon-highlight}: Gaussian Copula derived from beta and gamma vectors (i.e. "marginals") ([article](https://towardsdatascience.com/copulas-an-essential-guide-applications-in-time-series-forecasting-f5c93dcd6e99))![](./_resources/Correlation,_Association,_and_Distance.resources/image.11.png){width="460"}
