...
-   Packages
    ...
    -   [{]{style="color: #990000"}[hypertext](https://github.com/sigflux/hypertext){style="color: #990000"}[}]{style="color: #990000"} ([manual](https://cran.r-project.org/web/packages/hypertext/refman/hypertext.html)) - Similar to [{htmltools}]{style="color: #990000"}
        -   Differences from [{htmltools}]{style="color: #990000"}:
            -   Framework-Agnostic
            -   Zero Dependencies
