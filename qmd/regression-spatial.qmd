...
- Types
  ...
  - [**Forecast**]{style="color: #009499"} aka **Prevision**: The [newdata]{.arg-text} has the same spatial units, different values of the covariates. This is a *temporal-style* forecast — you're projecting forward with new $X$ but the same neighborhood structure and known unit identities.
    - [newdata]{.arg-text} has the *same* row names as model's [listw]{.arg-text}'s [region.id]{.arg-text} attribute
  - **Out-of-Sample**: The [newdata]{.arg-text} has new spatial units. Now $y$ is unknown, so the **signal** cannot use observed $Wy$ and must be approximated somehow. This is where most of the [pred.type]{.arg-text} proliferation comes from.
...
+------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+--------------------------------+
| ["TS1"]{.arg-text} or ["KP4"]{.arg-text}             | Single-prediction version of ["TS"]{.arg-text}.                                                                                                                                                                                                                 | Out-of-sample      | SLM, SDM, SAC, GNM             |
+------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+--------------------------------+
| ["TC"]{.arg-text}                                    | See In-sample and Forecast                                                                                                                                                                                                                                      |                    | SLM, SDM, SAC, GNM             |
+------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+--------------------------------+
| ["TC1"]{.arg-text} or ["KP1"]{.arg-text}             | Single-prediction version of ["TC"]{.arg-text}. Most broadly applicable out-of-sample predictor — works for all model types                                                                                                                                     | Out-of-sample      | All models                     |
+------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+--------------------------------+
| ["BP"]{.arg-text}                                    | See In-sample and Forecast                                                                                                                                                                                                                                      |                    |                                |
+------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+--------------------------------+
| ["BP1"]{.arg-text}; also requires [listw]{.arg-text} | The single-prediction version of ["BP"]{.arg-text}                                                                                                                                                                                                              | Out-of-sample      | SLM, SDM, SAC, GNM (caution\*) |
+------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+--------------------------------+
| ["BPW"]{.arg-text}\                                  | Same as ["BP"]{.arg-text} except it uses a weighted ($W$) average of neighbor y values for the correction. ["BPW1"]{.arg-text} is the single-prediciton version.                                                                                                | Out-of-sample      | SLM, SDM, SAC, GNM (caution\*) |
| ["BPW1"]{.arg-text}                                  |                                                                                                                                                                                                                                                                 |                    |                                |
+------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+--------------------------------+
| ["BPN"]{.arg-text}\                                  | Same as ["BP"]{.arg-text} but drops non-neighbors. For a sparse W matrix, this means ["BPN"]{.arg-text} has near identical performance as ["BP"]{.arg-text} but is more computationally efficient. ["BPN1"]{.arg-text} is the single-prediction version.        | Out-of-sample      | SLM, SDM, SAC, GNM (caution\*) |
| ["BPN1"]{.arg-text}                                  |                                                                                                                                                                                                                                                                 |                    |                                |
+------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+--------------------------------+
