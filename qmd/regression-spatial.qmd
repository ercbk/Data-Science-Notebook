...
-   [Example]{.ribbon-highlight}: Boston Housing Values ([SDS Ch.17.2](https://r-spatial.org/book/17-Econometrics.html#boston-house-value-dataset-examples))
    ...
    -   The use of weights is justified, because tract-level counts of reported housing units underlying the weighted median values vary from 5 to 3,031, and air pollution model output zone (aggregated geometries) counts vary from 25 to 12,411.
