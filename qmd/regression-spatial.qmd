...
-   Spatial Hausman Test
    ...
    -   If the processes in the covariates and the response match, we should find little difference between the coefficients of a least squares and a SEM
    -   Tests if there's correlation between an predictor variable and the error term (i.e. endogeneity)
    ...
    -   I think this compares an OLS and a spatial errors model. If the null is rejected, then there is a signifiant spatial process and a spatial model should be fit. If the null is not rejected, then fit an OLS.
