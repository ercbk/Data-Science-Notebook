...
-   [[{spatialreg}]{.underline}]{style="color: #990000"} [Model Functions]{.underline}\
    ...
    -   `summary` results for models with:
        ...
        -   The absolute values of $\rho_{\text{lag}}$ and $\rho_{\text{err}}$ and their statistical significance give you an idea of how much spatial autocorrelation is being modelled.
