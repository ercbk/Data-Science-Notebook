...
-   **Misc**
    ...
    -   Name Conventions
        -   Prefix dimension tables with [dim_]{.var-text}
        -   Prefix fact tables with [fact_]{.var-text}
        -   In general, avoid using abbreviations that might sound misleading (e.g. [stg_]{.var-text}, [int_]{.var-text}) and use full English words in database object names where possible.
