...
* See [Statistical Rethinking](Statistical Rethinking) >> Ch.9 MCMC >> Issues
...
* Solutions
	...
	* Need more data
	* Increase adapt\_delta closer to 1 (default: 0.8)
...
* Potential issues
	...
	* Minor modes in the tails of the posterior distribution
		...
		* solutions:
			* Using starting values near the main mode (brms init arg; see [Statistical Rethinking Ch 4](Statistical Rethinking) example)
...
* ![](./_resources/Bayes,_Troubleshooting_HMC.resources/Screenshot (241).png)
...
* ![](./_resources/Bayes,_Troubleshooting_HMC.resources/Screenshot (243).png)
...
* The model can be reparameterized
	...
	* solutions:
		...
		* reparameterize to "unit scale"
			...
			* See Ch 13.4 in [Statistical Rethinking](Statistical Rethinking)

* Common (misguided?) solutions
	* Increase iterations
	* Tweak adapt\_delta and max\_treedepth parameters to make it explore the space more carefully
* Other
