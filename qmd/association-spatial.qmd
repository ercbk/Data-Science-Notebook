...
- These statistics only identify the *core or center* of a cluster. The cluster itself also includes
  the neighboring locations (as defined by the spatial weights)
