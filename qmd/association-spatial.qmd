...
| Low | Polygon and its neighbors have low values; cluster of low values | Doesn't use the Moran plot; Lower than mean of input variable | $G_i^* < \mathbb{E}[G_i^*]$; negative spatial autocorrelation |
