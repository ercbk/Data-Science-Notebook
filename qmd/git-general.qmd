...
-   Diverged Branches\
    ![](_resources/Git,_general.resources/diverged-branches-1.png){.lightbox width="532"}\
    ![](_resources/Git,_general.resources/diverged-branches-2.png){.lightbox width="532"}
...
-   Pulling is fetching + merging\
    ![](./_resources/Git,_general.resources/FLG-tC-UcAEPRNk.jpeg)
