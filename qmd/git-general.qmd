...
-   Fast-Forward
    ...
    -   [Example]{.ribbon-highlight}
        ...
        -   Before the `merge`![](./_resources/Git,_general.resources/1-mO-snMtFrFEUNRlTkqR7gw.jpeg){.lightbox width="532"}
        ...
        -   After the merge![](./_resources/Git,_general.resources/1-JZfeHxjU7GV1cINEeS45OQ.jpeg){.lightbox width="532"}
...
-   [Example]{.ribbon-highlight}
    ...
    -   [iss53]{.var-text} branch ahead of master by 2 commits ([c3,]{.arg-text} [c5]{.arg-text}) and behind 1 commit ([c2]{.arg-text})![](./_resources/Git,_general.resources/basic-branching-6.png)
    ...
    -   Merge Commit\
        ![](./_resources/Git,_general.resources/basic-merging-1.png)\
        ![](./_resources/Git,_general.resources/basic-merging-2.png)
