    ...
    -   Additional `fit.variogram` arguments
        -   [fit.method]{.arg-text}: Weighting Options
            ...
            -   [2]{.arg-text}: Weights equal to $N_j/(\gamma(h_j))^2$
                -   Downweights bins where the semivariance is large
                -   Stabilizes the fit near the origin where the nugget and range are being determined, and where $\gamma(h_j)$ is small so those bins would otherwise have high relative influence. The $N_j$ in the numerator then restores precision-based weighting.
