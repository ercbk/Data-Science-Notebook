...
-   Factorial Experiments
    -   Don't use bars factorial experiments\
        ![](_resources/Visualization.resources/factorial-experiments-1.png){width="632"}
    -   Check outcome ranges by group when facetting\
        ![](_resources/Visualization.resources/Check_range_at_factor_level.svg){width="360"}
...
-   Lightest and darkest colors should have meaning (e.g. min, max, mean, zero) and not just some arbitrary numbers\
    ![](_resources/Visualization.resources/ColorScales-bidir-vs-unidir-1.svg){width="532"}
...
-   [Bar Graphs]{.underline}
    ...
    -   Guide\
        ![](./_resources/Visualization.resources/image.png){width="632"}
-   [Stacked Bar]{.underline}
    -   Replacement for pie charts et al when dealing with fractional data
    -   Always reorder stacks\
        ![](_resources/Visualization.resources/Reorder_stacked_bars-1.png){width="532"}
...
-   [Box Plots]{.underline}\
    ![](./_resources/Visualization.resources/image.1.png){width="632"}
...
-   [Network Graphs]{.underline}
    -   Always try different multiple layout methodologies\
        ![](_resources/Visualization.resources/net-graph-meth-1.svg){width="532"}
...
-   Try not to use Rainbow palettes, because they are misleading
    ...
    -   Other Alternatives\
        ![](_resources/Visualization.resources/alt-rainbow-jet-1.jpg){width="532"}
...
-   Visualizing only inferential uncertainty can lead to significant overestimates of treatment effects
    ...
    ![](_resources/Visualization.resources/uncert-inf-vs-out-1.png){width="532"}
