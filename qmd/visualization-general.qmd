...
-   Misc
    ...
    -   Resources
        ...
        -   [Bunny Fonts](https://fonts.bunny.net/) (from hrbrmstr daily drop)
            -   The motivation behind creating Bunny Fonts was to address privacy
                concerns and GDPR compliance issues with Google Fonts, offering a
                zero-logging policy and ensuring user data stays private while
                maintaining the same API compatibility as Google Fonts for easy
                migration
