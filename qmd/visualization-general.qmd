...
-   ggplot2
    ...
    -   `notebook_colors`![](_resources/Visualization.resources/notebook-colors.png){.lightbox width="332"}
...
-   Move axis labels nearest the most important chart objects (e.g. bars)\
    ![](./_resources/Visualization.resources/image.4.png){.lightbox width="524"}
    -   If the higher bars are what's most important and they're on the right, then usea right-side axis
-   Fonts for annotation\
    ![](./_resources/Visualization.resources/image.5.png){.lightbox width="524"}
...
-   Lead the eye with font sizes, styles, and colors\
    ![](./_resources/Visualization.resources/image.6.png){.lightbox width="524"}
...
-   Keep labels horizontal\
    ![](./_resources/Visualization.resources/image.8.png){.lightbox width="524"}\
    ![](./_resources/Visualization.resources/image.7.png){.lightbox width="524"}
-   Use a text outline\
    ![](./_resources/Visualization.resources/image.9.png){.lightbox width="524"}
...
-   Misc
    ...
    -   When using several subplots together to tell a story and they each have their own color scheme. Blend a color into each color scheme to produce a more unified look
        -   [Example]{.ribbon-highlight}: Blending blue into a plot with green color scheme.![](./_resources/Visualization.resources/FPsEiqSXMAMopMQ.jpeg){.lightbox width="394"}
...
-   What to do when you have a lot of categories
    ...
    -   Group categories, but keep showing them Can strokes help to tell categories apart?\
        ![](./_resources/Visualization.resources/Screenshot-2022-02-10-at-15.png){.lightbox width="524"}
...
-   [Bar Graphs]{.underline}
    ...
    -   Design Examples ([link](https://public.tableau.com/app/profile/robertrouse/viz/BarChartMenu/BarChartMenu))\
        ![](_resources/Visualization.resources/barchart-exs-1.png){.lightbox width="523"}
...
-   [Line Charts]{.underline}
    ...
    -   Having the y-axis not intersect the x-axis can minimize the risk of confusing the readers with a non-zero baseline chart\
        ![](./_resources/Visualization.resources/image.15.png){.lightbox}
    -   Time Series of ordinal discrete data by category\
        ![](./_resources/Visualization.resources/image.17.png){.lightbox}
        -   ordinal data has 3 levels
-   [Heatmaps]{.underline}
    -   Reorder rows and columns to produce a more meaningful visualization\
        ![](_resources/Visualization.resources/Heatmap_reorder.png){.lightbox}
    ...
    -   Reorder by clustering\
        ![](_resources/Visualization.resources/Reorder_rows_and_columns_for_heatmap-clustering-1.png){.lightbox}
