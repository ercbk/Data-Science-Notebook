...
-   [Heatmaps]{.underline}
    -   Reorder rows and columns to produce a more meaningful visualization\
        ![](_resources/Visualization.resources/Heatmap_reorder.png)
    ...
    -   Reorder by clustering\
        ![](_resources/Visualization.resources/Reorder_rows_and_columns_for_heatmap-clustering-1.png)
...
-   Try not to use Rainbow palettes, because they are misleading
    ...
    -   (acceptable) rainbow called "Turbo" if you need one ([article](https://ai.googleblog.com/2019/08/turbo-improved-rainbow-colormap-for.html?m=1))![](./_resources/Visualization.resources/FTBj4rfWUAE8rZq.jpeg){.lightbox width="496"}
...
-   Translate **percentages into counts** (e.g. "a 1 out of 5 chance" rather than "a 20% chance")![](./_resources/Visualization.resources/Screenshot%20(787).png){.lightbox width="615"}
...
-   **hypothetical outcome plots**
    ...
    -   [Example]{.ribbon-highlight}: NYT on interpreting jobs reports![](./_resources/Visualization.resources/Screenshot%20(789).png){.lightbox width="449"}![](./_resources/Visualization.resources/Screenshot%20(790).png){.lightbox width="449"}
