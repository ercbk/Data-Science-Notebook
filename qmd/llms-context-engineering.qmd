...
- Packages
  ...
  - [{]{style="color: #990000"}[promptmanageR](https://github.com/lazasaurus-ai/promptmanageR){style="color: #990000"}[}]{style="color: #990000"} - Provides a simple framework for managing and rendering system and user prompts for AI/LLM workflows in R.
...
- Resources
  ...
  - [Augmented Coding Patterns](https://lexler.github.io/augmented-coding-patterns/) - Learn how to collaborate successfully with AI coding assistants and avoid common pitfalls.
  ...
  - [Dagster's Dignified Python](https://dagster.io/blog/dignified-python-10-rules-to-improve-your-llm-agents)
    - Ten rules from the prompt supplied to Claude Code.
    - They reflect Dagster's engineering judgment about how Python should be written, and they are battle-tested against a large, actively maintained codebase.
  - [Claude Design prompt for redesigning a dashboard](https://github.com/thedatavist/thedatavist_web/blob/main/files/claude-design-redesign-aemo-prompt.md?plain=1) ([article](https://thedatavist.substack.com/p/are-my-dashboarding-days-numbered))
    - In the article, the author says they still had to iterate with Claude.
    - It still might be useful template to start from given the author's experience.
...
- Research
  ...
  - Architecture
    ...
    - How - Are there specific areas to be explored? Should certain items be included in the answer?
    - Sources - What are the specific papers, articles, etc. used to find the answer?
  - Examples
