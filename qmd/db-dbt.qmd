...
-   Set-Up
    ...
    -   [Example]{.ribbon-highlight}: Incremental
        ...
        -   `{{ this }}` means *filter* from "this" table, i.e. [orders]{.var-text}
        -   `is_incremental` (macro) checks:
            -   [materialized ='incremental']{.arg-text}
            -   There is an existing table for this model in the warehouse to build on
...
### Mode\`ls {#sec-db-dbt-comp-mod .unnumbered}
