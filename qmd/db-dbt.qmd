...
-   Development Workflow
    ...
    -   Make sure all the necessary atomic pieces are staged into the project,
    -   Bring them together based on the SQL written to generate the final output (mart).
    -   Finally, with a functioning model flowing in dbt, start refactoring and optimizing that mart.
...
-   [Intermediate]{.underline}
    ...
    -   Naming Convention
        -   Syntax: int\_\[entity\]s\_\[verb\]s.sql
