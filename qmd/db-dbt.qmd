...
-   Development Workflow
    ...
    -   Finally, with a functioning model flowing in dbt, start refactoring and optimizing the mart.
...
-   Also see DBT-Core Quickstart Guide (See [Misc](db-dbt-qmd#sec-db-dbt-misc){style="color: green"} \>\> Resources)
...
-   Within a python virtual environment
    ...
    -   Install plugins
        ...
        # etc...
        ```
-   Recommend using different schemas within one database to separate your environments
