...
* **Residual Deviance (G2)**: Dresid = Dsaturated - Dproposed
	* 2\*log\_likelihood between a saturated model and the proposed model
		* 2 \*(LL(sat\_mod) - LL(proposed\_mod))
		* \-2 \* (LL(proposed\_mod) - LL(sat\_mod))
	...
	* 2\*log\_likelihood between a saturated model and the intercept-only model (aka Null model)
		* 2 \*(LL(sat\_mod) - LL(null\_mod))
		* \-2 \* (LL(null\_mod) - LL(sat\_mod))
* **McFadden's Pseudo R2** = (LL(null\_mod) - LL(proposed\_mod)) / (LL(null\_mod) - LL(saturated\_mod))
...
Residuals
	...
	![](./_resources/Diagnostics,_GLM.resources/image.1.png)
