  ...
  - [{]{style="color: #990000"}[tmapverse](https://cran.r-project.org/web/packages/tmapverse/index.html){style="color: #990000"}[}]{style="color: #990000"}
    - Resources
      ...
      - Use `cols4all::c4a_palettes` for a list of available palettes.
        - Insert hash in front of palette string to reverse the color scale, e.g. ["-scico.batlow"]{.arg-text}
...
- [{tmap}]{style="color: #990000"} themes
  ...
  - `tmap_theme_charcoal` (theme for cool palettes)
    ...
    - The panel frame is necessary so the subplot titles in the top row don't get really close to the subtitle. Tried every type of margin, padding setting possible and nothing else worked.
