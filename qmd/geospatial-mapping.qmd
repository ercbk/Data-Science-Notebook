...
- Packages
  - [{]{style="color: #990000"}[ggplot2qgis](https://yutannihilation.github.io/ggplot2qgis/){style="color: #990000"}[}]{style="color: #990000"} - Takes a ggplot2 plot whose layers are backed by sf objects and writes a QGIS project.
    - Along with [Kumoy](https://www.kumoy.io/en#pricing) allows you to publish maps online
...
- openstreetmap 3-D buildings in [{mapgl}]{style="color: #990000"}:
  - Default for mapbox
  - maplibre: `maplibre(style = openfreemap_style("liberty"))`
- [{tmap}]{style="color: #990000"} themes
  - Examples

    - `tmap_theme_slate`: Association, Spatial \>\> Global \>\> Examples
    - `tmap_theme_charcoal`: Association, Spatial \>\> Local \>\> Examples
    - `tmap_theme_notebook`: Association, Spatial \>\> Local \>\> Examples
