...
-   Intervals using [{]{style="color: #990000"}[lubridate](https://lubridate.tidyverse.org/){style="color: #990000"}[}]{style="color: #990000"}
    ...
    -   Intersection Function\
        ![](_resources/Code,_Snippets.resources/calc-interval-intersection-1.svg){width="316"}
    ...
    -   Proportion of the Reference Interval\
        ![](_resources/Code,_Snippets.resources/calc-interval-prop-1.svg){width="255"}
