...
-   Intervals
    ...
    -   Intersection Function\
        ![](_resources/Code,_Snippets.resources/calc-interval-intersection-1.svg){.lightbox width="316"}
    ...
    -   Proportion of the Reference Interval\
        ![](_resources/Code,_Snippets.resources/calc-interval-prop-1.svg){.lightbox width="255"}
