...
-   Text \>\> "flow into frame" is required but it's picky as hell
    -   If you use text that isn't generated by an extension inside Inkscape, you have to paste it directly onto the canvas and NOT into a text box or other shape. Otherwise, "flow into frame" will not work.![](./_resources/Inkscape.resources/Screenshot%20(415).png)
