...
-   Steps: `dca` function (for each predictor, m, and threshold value, t)
    ...
    -   If [probability = FALSE]{.arg-text} for a predictor
...
-   [Example 3]{.ribbon-highlight}: Conditional and Joint application
    ...
    -   Run dca\
        ...
        ``` r
        dca(data=data.set, outcome="cancer", predictors=c("high_risk", "joint", "conditional"), xstop=0.35)
        ```
...
-   [Example 5]{.ribbon-highlight} Unnecessary Interventions Avoided\
    ![](./_resources/Decison_Intelligence.resources/Screenshot%20(685).png)
