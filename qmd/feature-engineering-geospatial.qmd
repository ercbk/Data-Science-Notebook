...
-   [Geocode]{.underline}
    -   Geocode Addresses to latitude and longitude
        -   [{]{style="color: #990000"}[tidygeocoder](https://jessecambon.github.io/tidygeocoder/){style="color: #990000"}[}]{style="color: #990000"} Basic
        ...
        -   Multiple Geocoders
            ...
            -   See [Scraping \>\> API \>\> GET](scraping.qmd#sec-scrap-api){style="color: green"} \>\> Example: Real Estate Addresses for a look at the [tib_addrs]{.var-text} dataset
