...
- Packages
  ...
  - [{]{style="color: #990000"}[lazysf](https://hypertidy.github.io/lazysf/){style="color: #990000"}[}]{style="color: #990000"} ([README](https://github.com/hypertidy/lazysf) has better documentation)- Provides a [{dplyr}]{style="color: #990000"} backend for any vector data source (aka shapefiles) readable by GDAL (e.g. gpkg, shp, geojson).
    ...
    - For larger datasets, enable GDAL’s columnar Arrow C stream interface for faster data transfer ([link](https://github.com/hypertidy/lazysf/tree/main?tab=readme-ov-file#arrow-stream-interface))
  ...
  - [{]{style="color: goldenrod"}[spopt](https://pysal.org/spopt/){style="color: goldenrod"}[}]{style="color: goldenrod"}, [{]{style="color: #990000"}[spopt](https://github.com/walkerke/spopt-r){style="color: #990000"}[}]{style="color: #990000"} - Spatial Optimization
    ...
    - Optimized corridor routing on cost surfaces (e.g. best routing of a pipeline over rough terrain)
- Boundary Analysis
...
- [**Areal**]{style="color: #009499"} (aka [**Lattice**]{style="color: #009499"}) [**Data**]{style="color: #009499"} - Data in a study region that is partitioned into a limited number of areas, with outcomes being aggregated or summarized within those areas (instead of at points, think choropleth). Examples include:
