...
## Nearest Neighbors {#sec-geo-anal-nn .unnumbered}

-   [Misc]{.underline}
    -   Notes from [{spdep}]{style="color: #990000"} vignette, [Creating Neighbours using sf objects](https://r-spatial.github.io/spdep/articles/nb_sf.html), and its docs.
    -   Packages
...
-   [Graph-based]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: SOI and GG ([source](https://r-spatial.github.io/spdep/articles/nb_sf.html#graph-based-neighbours))\
        ...
        # convert point matrix to neighbor list
        ...
        -   I feel the GG graph is more connected overall, but the SOI is more densely connected where the nodes are denser.
...
-   [k-NN\
    ...
    -   [Example]{.ribbon-highlight}: ([source](https://r-spatial.github.io/spdep/articles/nb_sf.html#k-nearest-neighbours))\
        ...
        -   See Graph-based \>\> Example for code for [NY8_sf]{.var-text}, [NY8_ct_sf]{.var-text}, and [coords_ct]{.var-text}
            -   Where [NY8_ct_sf]{.var-text} is point list of county centroids and [coords_ct]{.var-text} is the same thing but in a point matrix
...
-   [Distance Neighbors]{.underline}
    -   Identifies neighbors within a euclidean (default) distance range using a k-NN graph
        ...
        -   So if upper threshold is a fraction, then more connections will be made.

    -   [Example]{.ribbon-highlight}: (source)\
