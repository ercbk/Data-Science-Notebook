...
-   [Misc]{.underline}
    ...
    -   Plot differences between neighbor algorithms
        ...
        -   [Example]{.ribbon-highlight}: From Example: SOI and GG\
            ...
            -   `diffnb` currently doesn't handle directed graphs. So, make sure to check the symmetry of your graphs with `is.symmetric.nb` beforehand. Then, set [sym = TRUE]{.arg-text} in the neighbor list function if they aren't symmetric.
                -   Symmetrizing the graph adds links, so this should be a slightly inaccurate depiction of the differences between the algortihms. At least in this case though, it looks good enough.
...
-   [k-NN\
    ...
    -   [Example]{.ribbon-highlight}: ([source](https://r-spatial.github.io/spdep/articles/nb_sf.html#k-nearest-neighbours))\
        ![](_resources/Geospatial-Analysis.resources/nn-knn-ex-1.png){.lightbox group="nn-ex1-1" width="265"}
...
-   [Distance Neighbors]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: ([source](https://r-spatial.github.io/spdep/articles/nb_sf.html#distance-neighbours))\
        ![](_resources/Geospatial-Analysis.resources/nn-dist-ex-1.png){.lightbox group="nn-ex1-1"}
