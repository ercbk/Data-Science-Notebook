...
-   Also see
    ...
    -   [Mathematics, Statistics \>\> Descriptive Statistics \>\> Means and Medians](mathematics-statistics.qmd#sec-math-statc-desc-means){style="color: green"}
        -   Outlier detection and median calculation for multivariate spatio-temperal data
-   Boundary Analysis
