...
-   [Graph-based]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: SOI\
        ![](_resources/Geospatial-Analysis.resources/nn-graph-ex-soi-gg-1.png){.lightbox}
        ...
        NY85_nb_soi <- 
          graph2nb(soi.graph(NY84_nb, NY8_ct_sf))
        NY85_nb_gg <- 
          graph2nb(gabrielneigh(NY8_ct_sf))
