...
-   Randomized experiments remove all paths from the treatment variable, X\
    ![](./_resources/Causal_Inference.resources/Screenshot%20(623).png)
...
-   Partial Identification (**Handling Unobserved Confounds**)
        ...
        -   Measure proxies for the unobserved confound if it's not practical/ethical to measure
            -   i.e. If the confound is ability, then test scores, letters of recommendation, etc. could be proxies.
                -   [Example]{.ribbon-highlight}: 2022 SR Lecture 10 [video](https://www.youtube.com/watch?v=YrwL6t0kW2I&list=PLDcUM9US4XdMROZ57-OIRtIK0aOynbgZN&index=10), [code](https://github.com/rmcelreath/stat_rethinking_2022/blob/main/scripts_animation/10_confounds_poisson.r)\
                    ![](./_resources/Causal_Inference.resources/Screenshot%20(886).png)
    ...
    -   Steps for using sensitivity analysis
        1.  Perform a sensitivity analysis to determine plausibly how much of the causal effect is due to confounding paths
            ...
            -   [Example]{.ribbon-highlight}: 2022 SR Lecture 10 [video](https://www.youtube.com/watch?v=YrwL6t0kW2I&list=PLDcUM9US4XdMROZ57-OIRtIK0aOynbgZN&index=10), [code](https://github.com/rmcelreath/stat_rethinking_2022/blob/main/scripts_animation/10_confounds_poisson.r)\
                ![](./_resources/Causal_Inference.resources/Screenshot%20(884).png)
...
-   The [**causal effect**]{style="color: #14adff"} is the distribution of Y when we change x, averaged over the distributions of the adjustment variables (Z)![](./_resources/Causal_Inference.resources/ql_14ca188fe155c25bae7b65ee05f51391_l3.png){width="683"}
...
![](./_resources/Causal_Inference.resources/unknown_filename.png)![](./_resources/Causal_Inference.resources/unknown_filename.2.png){width="2800"}
            ...
            -   Sometimes you DO condition on these variables
                ...
                -   The mediation path can have an important interpretation depending on your research question
                    -   e.g. indirect descrimination
                        -   See [Statistical Rethinking >> Chapter 11](statistical-rethinking.qmd){style='color: green'} \>\> Conclusion of Berkeley Admissions example
...
-   The fourth DAG is an elemental confound or relation called a "**Collider**."  
    ![](./_resources/Causal_Inference.resources/Screenshot%20(621).png)
    -   In general, do NOT add these variables to your model
...
-   The last elemental confound or relation is called a "**Descendent**."![](./_resources/Causal_Inference.resources/Screenshot%20(132).png)
...
-   [Example]{.ribbon-highlight}
    -   Causal effect of Z on U is confounded by X because in addition to the legitimate causal path Z→Y→W→U, there is also an unblocked path Z←X→W→U which confounds the causal effect
        ...
        -   There are some descendant nodes that make the confounding a little difficult to parse out, but this graph is essentially
            -   ![](./_resources/Causal_Inference.resources/unknown_filename.9.png) which is the same as the second example DAG for confounding in the Association section
    ...
    -   Note that conditioning on W would also block this spurious path; however, it would also block the causal path, Z→Y→W→U.
        -   ![](./_resources/Causal_Inference.resources/unknown_filename.10.png) If we breakdown the complete DAG into the modular components involving W, we can see these are the same as the first example DAG in the Association section.
...
-   ![](./_resources/Causal_Inference.resources/unknown_filename.20.png)  so our calculated effect will be unconfounded.
...
-   [Example]{.ribbon-highlight} (2 Moms)
    ...
    -   Causal Effects![](./_resources/Causal_Inference.resources/Screenshot%20(641).png)
...
-   [Example]{.ribbon-highlight} (Bayesian 2 Moms)
    -   See previous example for link, hypothesis, and definition of the variables![](./_resources/Causal_Inference.resources/Screenshot%20(649).png)
    ...
    -   Results![](./_resources/Causal_Inference.resources/Screenshot%20(650).png)
        -   Truth: no effect
...
-   [Example]{.ribbon-highlight} (Bayesian Peer Bias)
    ...
    -   DAG and Code![](./_resources/Causal_Inference.resources/Screenshot%20(652).png)
    ...
    -   Results![](./_resources/Causal_Inference.resources/Screenshot%20(654).png)
        -   Truth: -0.8
...
Mediation Analysis ![](./_resources/Causal_Inference.resources/Screenshot%20(850).png)
...
-   Misc
    -   Notes from: [Mediation Models](https://m-clark.github.io/posts/2019-03-12-mediation-models/)
        -   Overview of packages (Aug 2020)![](./_resources/Causal_Inference.resources/Screenshot%20(853).png)
    ...
    -   Also see
        ...
        -   [Statistical Rethinking](Statistical%20Rethinking) \>\> Chapter 11 \>\> Conclusion of Berkeley Admissions example
            -   also Lecture 9 2022 [video](https://www.youtube.com/watch?v=nPi5yGbfxuo)
...
-   `Example:` Tingley, 2014 Method
    -   Equations![](./_resources/Causal_Inference.resources/Screenshot%20(848).png)![](./_resources/Causal_Inference.resources/Screenshot%20(844).png)
...
-   Exact same brms syntax (except priors are specified) as in [Statistical Rethinking](Statistical%20Rethinking) \>\> Chapter 5 \>\> Counterfactual Plots
    -   Example has a mediator DAG as well.
-   `hypothesis` tests H0: a\*b == 0
    -   pval \< 0.05 says there is a mediation effect.
-   [{sjstats}]{style="color: #990000"}![](./_resources/Causal_Inference.resources/Screenshot%20(854).png)
...
Moderation Analysis ![](./_resources/Causal_Inference.resources/moderation.png)
...
-   Moderation can be tested by interacting variables of interest (moderator x IV) and plotting the simple slopes of the interaction, if present.
    -   See [Regression, Interactions](Regression,%20Interactions) for simple slopes/effects analysis
...
-   Plot the simple slopes (1 SD above and 1 SD below the mean) of the moderating effect![](./_resources/Causal_Inference.resources/unnamed-chunk-7-1.png)
    -   For details on this plot and analysis, see [Regression, Interactions](Regression,%20Interactions) \>\> OLS \>\> numeric:numeric \>\> Calculate simple slopes for the IV at 3 representative values for the moderator variable
    -   Interpretation
...
-   **Misc**
    ...
    -   (*Total* ) Causal Effect and *Direct* Causal Effect![](./_resources/Causal_Inference.resources/Screenshot%20(707).png)
...
-   **Testable Implications**
    ...
    -   DAGs that are consistent with the data associations (M & N are associated but the causal relationship isn't known)![](./_resources/Causal_Inference.resources/Screenshot%20(111).png) where U is an unknown variable. Unobserved variables are circled.
...
-   **Frontdoor Adjustment**
    ...
    -   [Example]{.ribbon-highlight} 1
        -   Our goal is to estimate P(Y\|do(X)). Unfortunately, this relationship between X and Y is confounded by the unobserved variable U, via this backdoor path: X←U→Y. Therefore, we cannot estimate the causal quantity of interest *directly.*![](./_resources/Causal_Inference.resources/unnamed-chunk-2-1.png)
