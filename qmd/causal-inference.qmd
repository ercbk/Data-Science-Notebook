...
-   The [**causal effect**]{style="color: #009499"} is the distribution of Y when we change x, averaged over the distributions of the adjustment variables (Z)![](./_resources/Causal_Inference.resources/ql_14ca188fe155c25bae7b65ee05f51391_l3.png){width="483"}
...
-   [Example]{.ribbon-highlight} (Bayesian 2 Moms)
    -   See previous example for link, hypothesis, and definition of the variables\
        ![](./_resources/Causal_Inference.resources/Screenshot%20(649).png){width="272"}
...
-   [Example]{.ribbon-highlight} (Bayesian Peer Bias)
    ...
    -   DAG and Code\
        ![](./_resources/Causal_Inference.resources/Screenshot%20(652).png){width="205"}
...
-   [Example]{.ribbon-highlight}(code in article): Test whether Grandma's home remedy can speed recovery time for the common cold
    ...
    -   From fitting the model, we find μ = 7, β = -2, Τ = 0, ε~1~ = 0.78
        -   Therefore, the Individual Causal Effect for patient 1\
            ![](./_resources/Causal_Inference.resources/countfact-ice.png){width="300"}
...
![](./_resources/Causal_Inference.resources/Screenshot%20(850).png){width="500"}
...
-   Misc
    ...
    -   Notes from: [Mediation Models](https://m-clark.github.io/posts/2019-03-12-mediation-models/)
        -   Overview of packages (Aug 2020)\
            ![](./_resources/Causal_Inference.resources/Screenshot%20(853).png){width="486"}
...
-   [Example]{.ribbon-highlight}: Tingley, 2014 Method
    ...
    -   [{mediation}]{style="color: #990000"}
        ...
        -   Summary - `summary(mediation_result)`\
            ![](./_resources/Causal_Inference.resources/Screenshot%20(846).png){width="419"}
...
-   [Example]{.ribbon-highlight}: product-of-paths (or difference in coefficients)
    ...
    -   [{sjstats}]{style="color: #990000"}\
        ![](./_resources/Causal_Inference.resources/Screenshot%20(854).png){width="263"}
...
![](./_resources/Causal_Inference.resources/moderation.png){width="555"}
...
-   [Example]{.ribbon-highlight}: What is the relationship between the number of hours of sleep (X, independent variable (IV)) a graduate student receives and the attention that they pay to this tutorial (Y, outcome) and is this relationship influenced by their consumption of coffee (Z, moderator)
    ...
    -   Plot the simple slopes (1 SD above and 1 SD below the mean) of the moderating effect\
        ![](./_resources/Causal_Inference.resources/unnamed-chunk-7-1.png){width="473"}
...
-   Notation
    -   X is not independent of Y, i.e ![](./_resources/Causal_Inference.resources/ql_b610f9bb0614dc064c09e0854f572246_l3.png){width="49"}
    -   **conditional independence**: Y is not associated with some variable X, after conditioning on some other variable Z, i.e. ![](./_resources/Causal_Inference.resources/ql_ef21391bca130a6e9d5b600964aa3b19_l3.png){width="67" height="16"}
...
-   (*Total* ) Causal Effect and *Direct* Causal Effect\
    ![](./_resources/Causal_Inference.resources/Screenshot%20(707).png){width="426"}
...
-   [Example]{.ribbon-highlight}
    ...
    -   Plausible DAGs (note: marriage cannot influence your age... technically)
        1.  ![](./_resources/Causal_Inference.resources/Screenshot%20(90).png){width="131"}
        ...
        2.  ![](./_resources/Causal_Inference.resources/Screenshot%20(92).png){width="159"}
    ...
    -   Testable implications
        -   DAG 1
            -   The DAG shows all three are associated to each other, i.e. ![](./_resources/Causal_Inference.resources/ql_e69972d8fda85bb78dbb36718aecad23_l3.png){width="179" height="15"}
        ...
        -   DAG 2
            ...
            -   The testable implication is that D is independent of M, conditional on A, i.e. ![](./_resources/Causal_Inference.resources/ql_1537f13742e0be4122a8d8a30a61b41a_l3.png){width="63" height="15"}
...
-   DAGs that are consistent with the data associations (M & N are associated but the causal relationship isn't known)\
    ![](./_resources/Causal_Inference.resources/Screenshot%20(111).png){width="510"}\
...
-   [Examples]{.ribbon-highlight}:
    -   ![](./_resources/Causal_Inference.resources/Screenshot%20(134).png){width="200"}
    ...
    -   ![](./_resources/Causal_Inference.resources/Screenshot%20(136).png){width="200"}
...
-   [Frontdoor Adjustment]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: 1
        -   Our goal is to estimate P(Y\|do(X)). Unfortunately, this relationship between X and Y is confounded by the unobserved variable U, via this backdoor path: X←U→Y. Therefore, we cannot estimate the causal quantity of interest *directly.*\
            ![](./_resources/Causal_Inference.resources/unnamed-chunk-2-1.png){width="260"}
    ...
    -   [Example]{.ribbon-highlight} 2
        -   Same as first example but using [{dosearch}]{style="color: #990000"} package
            ...
            -   Output:![](./_resources/Causal_Inference.resources/Screenshot%20(203).png){width="300"}
