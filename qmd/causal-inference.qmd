...
- Packages
  - [{]{style="color: #990000"}[BCDAG](https://cran.r-project.org/web/packages/BCDAG/index.html){style="color: #990000"}[}]{style="color: #990000"} - **Bayesian** Structure and Causal Learning of **Gaussian** Directed Graphs
...
- [Example 2]{.ribbon-highlight}: Estimate the direct and total effects from A to Y ([source](https://bsky.app/profile/rmcelreath.bsky.social/post/3m6yhqbn3gc2c))
  ...
  - Note: Set-up code is folded above
