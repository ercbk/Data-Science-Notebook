...
-   Packages
    ...
    -   [{]{style="color: #990000"}[dagitty](https://cran.r-project.org/web/packages/dagitty/index.html){style="color: #990000"}[}]{style="color: #990000"} ([tool](https://www.dagitty.net/dags.html)) - A port of the web-based software 'DAGitty' for analyzing structural causal models (also known as directed acyclic graphs or DAGs).
