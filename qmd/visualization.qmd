...
* Bar Graphs
	...
	* Guide![](./_resources/Visualization.resources/image.png)
* Box Plots![](./_resources/Visualization.resources/image.1.png)
...
* ggplot2: Don't use stat calculating geoms _and_ set axis limits with scale\_y\_continuous![](./_resources/Visualization.resources/FTCVXwJXsAElSDd.png)
	* See examples of the behavior in this [thread](https://twitter.com/CedScherer/status/1526878907949010944)
* Defaults for any {ggplot2} geom using the default\_aes field (i.e. `GeomBlah$default_aes` )
...
* Facetting vs Single Graph![](./_resources/Visualization.resources/image.2.png)
* Layout based on experiement design![](./_resources/Visualization.resources/image.3.png)
* 
...
* Free - fonts.google.com
	...
	* Fira Code Retina
		...
		* @import url("https://cdn.rawgit.com/tonsky/FiraCode/1.205/distr/fira\_code.css");
	* Alegreya
	* Reforma family
...
* People love annotations ([thread](https://twitter.com/chasejstokes/status/1583472474704216064), paper). More text, the better.
	* Their takeaway from the chart is more likely to resemble the annotation if it takes the form of L2 and/or L4 and is close to the data![](./_resources/Visualization.resources/image.11.png)
	* Example: Financial Times![](./_resources/Visualization.resources/image.12.png)
...
* Move axis labels nearest the most important chart objects (e.g. bars)![](./_resources/Visualization.resources/image.4.png)
	* If the higher bars are what's most important and they're on the right, then usea right-side axis
* Fonts for annotation![](./_resources/Visualization.resources/image.5.png)
...
* Lead the eye with font sizes, styles, and colors![](./_resources/Visualization.resources/image.6.png)
...
* Keep labels horizontal![](./_resources/Visualization.resources/image.8.png)![](./_resources/Visualization.resources/image.7.png)
* Use a text outline![](./_resources/Visualization.resources/image.9.png)
	* Set the stroke around your letters, using the background color of your chart.
* Be conversational first and precise later![](./_resources/Visualization.resources/image.10.png)
...
* Misc
	...
	* When using several subplots together to tell a story and they each have their own color scheme. Blend a color into each color scheme to produce a more unified look
		* Example: Blending blue into a plot with green color scheme.![](./_resources/Visualization.resources/FPsEiqSXMAMopMQ.jpeg)
...
* Charts
	(see prismatic PKG to do this manipulation within ggplot)
...
* Adjustments once you chosen a color (hue) to create variations
	1. Move brightness _up_ for lighter variations and _down_ for darker variations
...
* What to do when you have a lot of categories
	...
	* Group categories, but keep showing them Can strokes help to tell categories apart?![](./_resources/Visualization.resources/Screenshot-2022-02-10-at-15.png)
	...
	* Add other indicators Can you add symbols, patterns, line widths, or dashes?![](./_resources/Visualization.resources/Screenshot-2022-02-10-at-15.1.png)
...
* Remove as many extraneous elements as possible
	* hard because maps have so many necessary elements
		* borders, labels, etc.
	* In cloropleths, remove unnecessary borders (e.g. along coastlines)![](./_resources/Visualization.resources/image.13.png)
...
* Numeric values ([thread](https://twitter.com/CedScherer/status/1526827081342062593))
	* Palettes: use a sequential (top row) or diverging (bottom row)![](./_resources/Visualization.resources/Screenshot (841).png)
		* For diverging palettes![](./_resources/Visualization.resources/Screenshot (843).png)
			* The middle value should be light on a light background (top left) or dark on a dark background (bottom left)
	* Backgrounds: ![](./_resources/Visualization.resources/Screenshot (840).png)
...
* Try not to use Rainbow palettes, because they are misleading
	* (acceptable) rainbow called "Turbo" if you need one ([article](https://ai.googleblog.com/2019/08/turbo-improved-rainbow-colormap-for.html?m=1))![](./_resources/Visualization.resources/FTBj4rfWUAE8rZq.jpeg)
...
* Translate **percentages into counts** (e.g. “a 1 out of 5 chance” rather than “a 20% chance”)![](./_resources/Visualization.resources/Screenshot (787).png)
...
* **hypothetical outcome plots**
	...
	* Example: NYT on interpreting jobs reports![](./_resources/Visualization.resources/Screenshot (789).png)![](./_resources/Visualization.resources/Screenshot (790).png)
	...
	* 
* **Fan charts**![](./_resources/Visualization.resources/Screenshot (785).png)
	* shows a 90% interval broken divided into 30% increments (left) or 10% increments (right)
* **Show previous forecasts**![](./_resources/Visualization.resources/Screenshot (792).png)
