...
-   Base Image Build Times\
    ![](./_resources/Shiny,_Production.resources/Screenshot%20(1054).png){width="432"}
...
-   Order of Image Layers\
    ![](./_resources/Shiny,_Production.resources/Screenshot%20(1055).png){width="432"}
...
![](./_resources/Shiny,_Production.resources/Screenshot%20(1058).png){width="432"}
...
-   Options
    ...
    -   Keep data in cloud storage
        ...
        -   Optimization (loading in secs instead of mins)
            ...
            -   Pipeline\
                ![](./_resources/Shiny,_Production.resources/image.png){width="342"}
                -   Partition data:
...
-   AWS deployment\
    ![](./_resources/Shiny,_Production.resources/architecture.png){width="432"}
    -   Notes from
...
-   Aetna Insurance Notes from Q&A [Shatrunjai Singh \| R in Insurance \| RStudio](https://www.youtube.com/watch?v=rK2N47r78hc)
    -   RStudio Connect
...
-   [{backendlessr}]{style="color: #990000"}
    ...
    -   Demo login: `backendlessr::shiny_demo_login` (http://0.0.0.0:3838)\
        ![](./_resources/Shiny,_Production.resources/Screenshot%20(521).png){width="232"}
    ...
    -   Steps
        ...
        -   Register you app\
            ![](./_resources/Shiny,_Production.resources/Screenshot%20(523).png){width="332"}
...
-   Install package and run functions in your shiny app
    -   Example (basic)\
        ![](./_resources/Shiny,_Production.resources/Screenshot%20(525).png){width="432"}
