# Google, Analytics, Analysis {#sec-goog-anal-anal}
...
-   View of nesting schema for event_params![](./_resources/Google,_Analytics,_Analysis.resources/image.1.png)
...
-   `Example 24`
    ...
    -   From [Looking for Power User Journeys](https://towardsdatascience.com/looking-for-power-user-journeys-in-e-commerce-746f5f68b697)
    -   Also see [Product Development](Product%20Development) \>\> Metrics \>\> Growth Metrics \>\> Power User Curve
