...
-   **Stepped Wedge**(https://www.rdatagen.net/post/alternatives-to-stepped-wedge-designs/)\
    ...
    ![](./_resources/Experiments,_Stepped_Wedge_Cluster_Design.resources/unknown_filename.1.png)
...
-   ![](./_resources/Experiments,_Stepped_Wedge_Cluster_Design.resources/unknown_filename.2.png)
...
-   *Different within- and between-period ICCs*
    ...
    -   ![](./_resources/Experiments,_Stepped_Wedge_Cluster_Design.resources/unknown_filename.13.png) (see b_ct distribution specification above)
