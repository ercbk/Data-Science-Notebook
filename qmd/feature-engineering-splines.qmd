...
-   Packages
    ...
    -   [{]{style="color: #990000"}[pspline](https://cran.r-project.org/web/packages/pspline/){style="color: #990000"}[}]{style="color: #990000"} - Penalized Smoothing Splines. Smoothing splines with penalties on order m derivatives
...
-   Resources
    ...
    -   Navarro's deep-dive [Splines, B-splines, P-splines, and a disapproving kitten](https://blog.djnavarro.net/posts/2025-09-06_p-splines/)
