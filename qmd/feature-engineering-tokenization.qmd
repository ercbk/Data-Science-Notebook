...
-   Packages
    ...
    -   [{]{style="color: #990000"}[textrecipes](https://textrecipes.tidymodels.org/){style="color: #990000"}[}]{style="color: #990000"} - Extra steps for the recipes package for preprocessing text data
    -   [{]{style="color: #990000"}[tokenizers](https://docs.ropensci.org/tokenizers/){style="color: #990000"}[}]{style="color: #990000"} - Fast, Consistent Tokenization of Natural Language Text
-   Resources
