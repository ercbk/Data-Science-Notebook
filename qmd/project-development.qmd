...
-   [Misc]{.underline}
    ...
    -   Milestones
        -   Break down the project deliverables into milestones and sub-milestones. It is easier to derive and estimate the required time and manage dependencies when breaking down the project into its different components
