...
- Protyping and Testing
  ...
  - Even if the product is far from finished, showing it to users helps you test assumptions and prioritize features. When you start the project, commit to a prototype date as soon as possible.
...
- Create a project brief for stakeholders
  - It shouldn’t be overly technical, but it should explain the main concepts in plain language and give a good sense of the plan, the timeline, and the current state of the project.

  - Example: ([source](https://towardsdatascience.com/4-claude-skills-every-data-scientist-needs-in-2026/))\
    ![](_resources/Project,_Development.resources/comms-proj-brief-1.png){.lightbox width="432"}
