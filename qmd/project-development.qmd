# Development {#sec-proj-dev}

## Misc {#sec-proj-dev-misc}
    ...
    -   Encode Decision Making Algorithms
        ...
        3.  Use systematic decision-making algorithms to improve decision making
            -   Example: Employee Churn
                ...
                ![](_resources/Project,_Development.resources/decision-alg-app-1.png){width="432"}

                ![](_resources/Project,_Development.resources/decision-alg-1.png){width="432"}
...
## Agile {#sec-proj-dev-agile}

### Misc {#sec-proj-dev-agile-misc}
...
### Terms {#sec-proj-dev-agile-terms}
...
### Values for Data Analysis {#sec-proj-dev-agile-vfda}
...
### Data Science Lifecycle {#sec-proj-dev-agile-dslife}
...
### Product Roadmap Examples {#sec-proj-dev-agile-prodroad}
...
### Sprint Workflow {#sec-proj-dev-agile-spwkflw}
