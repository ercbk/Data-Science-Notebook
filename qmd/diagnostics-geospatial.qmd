...
- [Misc]{.underline}
  ...
  - **Global Measures** - A single value of autocorrelation for the total study area. These measures consider the average autocorrelation level across all observations
    - Can be biased by edge effects where important spatial process components fall outside the study area.
  - **Local Measures** - Values of autocorrelation for each areal unit
