...
- Packages
  ...
  - [{]{style="color: #990000"}[spdep](https://r-spatial.github.io/spdep/index.html){style="color: #990000"}[}]{style="color: #990000"} - Spatial autocorrelation functions
...
- [Moran's I]{.underline}
  ...
  - [{]{style="color: #990000"}[spdep::lm.morantest](https://r-spatial.github.io/spdep/reference/lm.morantest.html){style="color: #990000"}[}]{style="color: #990000"}
  ...
  - Other flavors
    - [{]{style="color: #990000"}[spdep::lm.morantest.exact](https://r-spatial.github.io/spdep/reference/lm.morantest.exact.html){style="color: #990000"}[}]{style="color: #990000"}
    - [{]{style="color: #990000"}[spdep::lm.morantest.sad](https://r-spatial.github.io/spdep/reference/lm.morantest.sad.html){style="color: #990000"}[}]{style="color: #990000"}
- [Rao's Score]{.underline}
  - Estimates of tests chosen among five statistics for testing for spatial dependence
  - See [Regression, Spatial \>\> Econometric \>\> Diagnostics](regression-spatial.qmd#sec-reg-spat-econ-diag){style="color: green"} \>\> Rao's Score
  - [{]{style="color: #990000"}[spdep::lm.RStests](https://r-spatial.github.io/spdep/reference/lm.RStests.html){style="color: #990000"}[}]{style="color: #990000"}
