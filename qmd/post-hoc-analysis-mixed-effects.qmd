...
-   [Example]{.ribbon-highlight}: Is there a statistically significant difference between the estimated effects of the categories of the fixed effect, "Season" Data from [Multilevel Modeling and Effects Statistics for Sports Scientists in R](https://ryan-curtis.netlify.app/post/multilevel-modeling-and-effects-statistics-for-sports-scientists-in-r/)
    ...
    ::: panel-tabset
    ## [{]{style="color: #990000"}[multcomp](https://cran.r-project.org/web/packages/multcomp/index.html){style="color: #990000"}[}]{style="color: #990000"}
    ...
    ## [{]{style="color: #990000"}[emmeans](https://github.com/rvlenth/emmeans){style="color: #990000"}[}]{style="color: #990000"}
...
-   [Example]{.ribbon-highlight}: Distance (outcome), Season (Grouping variable)
    ...
    ::: panel-tabset
    ## [{]{style="color: #990000"}[effsize](https://cran.r-project.org/web/packages/effsize/effsize.pdf){style="color: #990000"}[}]{style="color: #990000"}
...
-   The correction for eta squared ($\eta^2$) is known as omega squared ($\omega^2$).
