...
- [Normalization Styles]{.underline}
  - **Row-Standardized (W)**
    ...
    - Issue: Has some **undesirable properties when some non-contigutiy based neighbour methods** are used, such as distance based neighbours. ([source](https://ruettenauer.github.io/Geodata_Spatial_Regression/03_weights.html#row-normalization))
