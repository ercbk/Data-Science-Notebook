...
-   Also see
    ...
    -   Caveats [page](https://rstudio.github.io/renv/articles/renv.html#caveats) in the docs lists things that renv does not cover.

        -   R version, Pandoc, Operating system, versions of system libraries, compiler versions

        -   Packages like {sf} versions that require certain versions of system libraries ([Thread](https://mastodon.social/@eddelbuettel/112671629388329644)) need to have docker images associated with them.
