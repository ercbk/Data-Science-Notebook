...
* Misc
	* \*\* Restoring an environment comes with a few [caveats](https://rstudio.github.io/renv/articles/renv.html#caveats): \*\*
		...
		* The same is true for packages with external dependencies. Those libraries, their headers and binaries also need to be installed by the user in the correct version, which is _not_ recorded in the lockfile.
...
* steps
	...
	2. run \`systemfonts::match\_font("<name of font you have installed>") and copy path (don't include file (i.e. .ttf))
	3. run extrafont::
