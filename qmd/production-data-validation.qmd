...
* Pipeline
* Python
	* [{{pydantic}}]{style='color: goldenrod'}
	* {{pandas\_dq}}
...
* packages
	* [{pointblank}]{style='color: #990000'}
	* {{great expectations}}
	* [{{pydantic}}]{style='color: goldenrod'}
* Also see [DB, Engineering](DB, Engineering) >> Data Quality
...
* Misc
	* Comparison between [{{pydantic}}]{style='color: goldenrod'} and {{pandas\_dq}}
...
* [Example]{.ribbon-highlight}: {{pandas\_dq}}
	* Check schema![](./_resources/Production,_Data_Validation.resources/image.png)
...
* Fix issues![](./_resources/Production,_Data_Validation.resources/image.2.png)
