...
-   Use variatios of the primary color ([source](https://www.learnui.design/blog/color-in-ui-design-a-practical-framework.html))
    ...
    -   Navbar, Search, Icons\
        ![](_resources/Shiny,_UI.resources/des-col-var-1.png){.lightbox width="432"}
    -   One color as a theme (e.g. ocean)\
        ![](_resources/Shiny,_UI.resources/des-col-var-2.png){.lightbox width="532"}
    -   Tabs and Buttons: Active, Inactive, Hover\
        ![](_resources/Shiny,_UI.resources/des-col-var-3.png){.lightbox width="482"}
