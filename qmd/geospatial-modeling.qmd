...
-   Types
    ...
    -   RFsp
        -   Tends to give worse results than coordinates when its use was inappropriate for either interpolation or extrapolation.
        -   But, together with EDFs, it also yielded the largest gains when the use of proxies was beneficial.
-   Factors that could affect the effectiveness of spatial proxies
    -   Model Objectives
        -   Interpolation - There is a geographical overlap between the sampling and prediction areas
            ...
            -   For Random or Regular distributions, the model should likely benefit, especially if there's a large amount of spatial autocorrelation.
            -   For clustered distributions
                -   For weakly clustered data, strong spatial autocorrelation, and there's only a subset of informative predictors or no predictors at all, then models can expect some benefit.
