...
-   Packages
    ...
    -   [SLGP](https://cran.r-project.org/web/packages/SLGP/index.html) - Spatial Logistic Gaussian Process for Field Density Estimation
...
## Interaction Modeling {#sec-geo-gen-intmod .unnumbered}
