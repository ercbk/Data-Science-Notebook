...
-   **Conditional Simulation**
    ...
    -   Uses the data of the convenience sample as *conditioning* data.
    -   Conditional simulation is only recommended if the quality of these legacy data is sufficient, and we may trust that the study variable at the legacy points has not changed since these legacy data have been collected.
    -   Process
