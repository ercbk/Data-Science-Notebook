...
-   Resources
    -   [Geospatial Analysis in R and Python, R Lesson 6](https://kodu.ut.ee/~kmoch/geopython2023/R_06/Spatial_interpolation.html)
...
-   [Example]{.ribbon-highlight}: Exponential Model\
    ...
    -   Additional `variogram` arguments:
        ...
        -   cressie: Cressie's estimator that's robust against outliers
...
-   [Example 3]{.ribbon-highlight}: Universal Kriging
    ...
    -   A 10km x 10km grid is created from the shape file and the population data is aggregated to that grid.
