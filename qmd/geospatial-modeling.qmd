...
-   **Conditional Simulation**
    ...
    -   Used to estimate areal mean values using a nonlinear function
        -   e.g. the areal fraction where $Z(s)$ exceeds a threshold
    -   Used to predict the sampling variance of the estimator of the mean using a geostatistical model with a non-constant mean.
    -   Process
...
-   Process: Optimize the parameters of variogram model to fit to the sample variogram estimates.
    ...
    -   Instead of the constant mean, denoted by `~ 1`, a mean function can be specified,
