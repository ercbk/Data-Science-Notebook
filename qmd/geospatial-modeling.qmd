...
-   [Example 3]{.ribbon-highlight}: Universal Kriging
    ...
    -   Process
        ...
        -   Every 100 m population cell is intersected with each 10 km grid cell.
        -   The variable is allocated based on the exact overlap area.
        -   Therefore border cells, partial overlaps, and all area corrections are handled automatically.
