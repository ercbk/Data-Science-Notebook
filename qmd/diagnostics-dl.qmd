...
-   Raschka ([thread](https://twitter.com/rasbt/status/1565798671781961728))
    -   General
        -   Make sure training loss converged
            -   Want to see a plateau in the loss (y-axis)![](./_resources/Diagnostics,_DL.resources/image.png){.lightbox width="632"}
                -   Left: bad; Right: better
        -   Check for overfitting
            -   Don't want the gap between training and validation accuracy to be too large![](./_resources/Diagnostics,_DL.resources/image.1.png){.lightbox width="632"}
                -   Left: bad; Right: better
        -   Compare accuracy to a zero-rule baseline
            -   Check that the validation accuracy is substantially better than a baseline based on always predicting the majority class (aka zero-rule classifier)![](./_resources/Diagnostics,_DL.resources/image.2.png){.lightbox width="632"}
