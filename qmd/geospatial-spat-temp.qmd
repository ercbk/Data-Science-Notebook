...
- [Example 1]{.ribbon-highlight}: Cross-Validation
  ...
  **tl;dr**
  ...
  - Catboost performs the best out of the ML models by barely beating the RF, but krigeST outperformed Catboost after extensive tuning of nmax and bufferNmax.
...
- [Example 2]{.ribbon-highlight}: Diagnostics
  ...
  **tl;dr**
  ...
  - No real obvious spatial or temporal patterns regarding prediction performance or bias. A few fuzzy ones though.
    ...
    - Both models seem to predict better in the winter months, so there's probably less PM10 pollution during that time.
  ...
  - There is a bias when back-transforming logged variables. I tested four options: exponentiation, gaussian bias correction, Duan's global smear, and Duan's local smear.
  ...
  - Both distributions have sharper peaks (leptokurtic) and median's slightly left of zero indicating an overprediction bias.
  ...
  - The assymetries of residual distributions can also obvious
  ...
  - Label Locations:
    - Two Top Locations: top-left and top-right
  ...
  - January 2006 is interesting — sort opposite and relatively large spikes.
  ...
  - Overall average coverage is 98.1% (see code) which is pretty convservative. This is likely caused by the Gaussian assumption of the residuals failing and inflating the prediction variance calculated by `krigeST`.
    - The interval could still be useful.
