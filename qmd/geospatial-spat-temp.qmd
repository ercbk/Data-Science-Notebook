...
- [Time-wide]{.underline} - Each time unit is a column
  ...
  - [Example]{.ribbon-highlight}: Space × Time Matrix to [{stars}]{style="color: #990000"} Object (i.e. [STFDF]{.arg-text})
    ...
    - Similar contruction to a [STFDF]{.arg-text} object. Guessing order of dates and stations object need to have the same order as they are in the space-time matrix
      - See Long \>\> Example 2 and Space-wide \>\> Example 2 for more details on what this means.
