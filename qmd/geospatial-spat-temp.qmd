...
-   Fitting tips, notes, etc.
    ...
    -   Get rid of the "range should be positive error" (and other errors that are the result from some parameter estimate being negative) from the get-go by restricting the search space to being positive for all parameters.
        ...
        -   [Example]{.ribbon-highlight}:
            ...
            fit.StVariogram(
              vario_emp, 
              mod, 
              # get rid of "range should be positive" error
              lower = c(
