...
- [Example 1]{.ribbon-highlight}: Cross-Validation
  ...
  **tl;dr** Catboost performs the best out of the ML models by barely beating the RF, but krigeST outperformed Catboost after extensive tuning of nmax and bufferNmax. Catboost nor the krigeST model considered "weakly predictive," so not good models but better than naive models on average.

  Alternative idea for the future: Using a Catboost model along with a krigeST model trained on the Catboost's residuals would probably peform better (i.e. the Catboost and krigeST predictions would be added together)
  ...
  - Neither the Catboost nor this kriging model are *good* models, but they're better than taking the mean. They're also basic models with no real predictors. Adding informative predictors (e.g. wind speed, distance from factories, interstates, elevation, weather, population, etc.) would hopefully make these much better.
    ...
    - Claude has suggested more than once that using a Catboost model along with a krigeST model trained on the Catboost's residuals would peform better.
  :::
...
- [Example 2]{.ribbon-highlight}: Diagnostics
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-resid-dens-1.png){.lightbox gjroup="krig-interp-ex2-resid" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-resid-qq-1.png){.lightbox gjroup="krig-interp-ex2-resid" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-resid-pred-1.png){.lightbox gjroup="krig-interp-ex2-resid" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-resid-robust-box-1.png){.lightbox gjroup="krig-interp-ex2-resid" width="632"}
  ...
  ::: {layout-ncol="2"}
  ![krigeST](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-resid-vario-krig-1.png){.lightbox gjroup="krig-interp-ex2-resid" width="382"}

  ![Catboost](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-resid-vario-cat-1.png){.lightbox gjroup="krig-interp-ex2-resid" width="382"}
  :::
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-spat-rmse-loc-1.png){.lightbox gjroup="krig-interp-ex2-spat" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-spat-me-loc-1.png){.lightbox gjroup="krig-interp-ex2-spat" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-temp-mean-resid-1.png){.lightbox gjroup="krig-interp-ex2-temp" width="582"}
  ...
  - This is different from the non-logged PM10 experiment which saw a more even mix of under and over-predictions for both models.

  ###### RMSE and ME by Season

  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-temp-season-resid-1.png){.lightbox gjroup="krig-interp-ex2-temp" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-temp-mean-pred-dis-1.png){.lightbox gjroup="krig-interp-ex2-resid" width="582"}
  ...
  - Says krigeST's predictions are on average greater than Catboost's per month which tracks from the first chart which says Catboost under-predicition errors have a greater magnitude than krigeST's under-prediction errors.

  ## Model-specific

  ###### Kriging PI Coverage

  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-krig-pi-cov-1.png){.lightbox gjroup="krig-interp-ex2-modspec" width="432"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-cat-feat-imp-1.png){.lightbox gjroup="krig-interp-ex2-modspec" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-cat-cp-prof-1.png){.lightbox gjroup="krig-interp-ex2-modspec" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-comp-obs-pred-1.png){.lightbox gjroup="krig-interp-ex2-other" width="582"}
  ...
  ![](_resources/Geospatial-Spatio-Temporal.resources/krig-interp-ex2-comp-rmse-range-1.png){.lightbox gjroup="krig-interp-ex2-other" width="582"}
