...
-   EDA
    -   Autocorrelation
        ...
        -   BTW, the titles will ALL be the last element of [rn]{.var-text}. Couldn't find a solution. Maybe there's a package that doesn't rely on the base R acf function that can produce plots with the correct titles. Maybe it's because [r5to10]{.var-text} is a spacetime class object. None of the current main LLMs could figure out why though.
    ...
    -   Cross-Autocorrelation: `acf(na.omit(as(r5to10[4:10,], "xts")))`
        ...
        -   If there is no autocorrelation between a pair of locations, is it because there's a large distance between those locations? `print(spDists(r5to10[4:10,]@sp), digits=3)`
            -   Maybe this can give a hint about the appropriate neighborhood size or area
