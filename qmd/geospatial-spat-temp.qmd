...
- \[Irregular Grids\]{.underline} ![](_resources/Geospatial-Spatio-Temporal.resources/layouts-irregular-grid-1.png){.lightbox width="232"}
...
- \[Trajectory Grids\]{.underline} ![](_resources/Geospatial-Spatio-Temporal.resources/layouts-trajectory-grid-1.png){.lightbox width="232"}
