...
-   Fitting tips, notes, etc.
    ...
    -   Tune the weighting method ([fit.method]{.arg-text}) for `fit.StVariogram`
...
-   [Example 1]{.ribbon-highlight}: Germany's PM10 Polution Data
    ...
    ![](_resources/Geospatial-Spatio-Temporal.resources/krig-vario-ex1-mod-comp-line-lattice.png){.lightbox width="632"}
    ...
    ![](_resources/Geospatial-Spatio-Temporal.resources/krig-vario-ex1-mod-comp-heat-lattice.png){.lightbox}
    ...
    ![](_resources/Geospatial-Spatio-Temporal.resources/krig-vario-ex1-mod-comp-surface-lattice.png){.lightbox width="632"}
    ...
    ![](_resources/Geospatial-Spatio-Temporal.resources/krig-vario-ex1-mod-comp-line.png){.lightbox width="632"}
    ...
    ![](_resources/Geospatial-Spatio-Temporal.resources/krig-vario-ex1-mod-comp-heat.png){.lightbox width="632"}
    ...
    ![](_resources/Geospatial-Spatio-Temporal.resources/krig-vario-ex1-mod-comp-surface.png){.lightbox width="632"}
    ...
    annotations_list <- purrr::map2(
      ...
      function(name, pos) {
        list(
          ...
          x = pos$x, 
          y = pos$y,
          xref = "paper",      # Use paper coordinates (0 to 1 across figure)
          yref = "paper",      
          showarrow = FALSE,
          font = list(size = 16),
          xanchor = "center",
