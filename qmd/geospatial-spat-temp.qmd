...
-   [Example]{.ribbon-highlight}:
    ...
    | n samples: 150         |                           |                                                                                               |
    +------------------------+---------------------------+-----------------------------------------------------------------------------------------------+
    | time slices: 504 days\ | 42 min on 12 workers      | Still good median/mean spreads; nugget spread affected most                                   |
    | block length: 42 days\ |                           |                                                                                               |
    | n samples: 150         |                           |                                                                                               |
    +------------------------+---------------------------+-----------------------------------------------------------------------------------------------+
    ...
    -   Execution took 2.02 hrs on 14 workers. I felt this configuration (504 [time_slices]{.var-text}, 42 [block_length]{.var-text}, and 200 [n_samples]{.var-text}) gave me the best trade-off between precision and run time.
