...
-   [Example]{.ribbon-highlight}:
    ...
    -   Spatial variograms are analyzed and bootstrap distributions for the partial sill and range are calculated. These could give us a potential range of starting values if we use the same model (exponential) in the spatio-temporal variogram.
