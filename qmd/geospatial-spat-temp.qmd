...
-   Using the joint variogram based on metric distance to visually estimate the range and sill\
    ...
    -   Spoiler: The best variogram models estimated the range to be around 360. So if I used this estimate, I overshot by about a factor of 3. ¯\\\_(ツ)\_/¯
        ...
        -   The heuristic I went with in the example that doesn't assume well-filled bins and overshot by a factor of 2. It was still close enough to get converged fitted models though ¯\\\_(ツ)\_/¯ .
...
-   [Example 1]{.ribbon-highlight}
    ...
    -   Urban stations have been removed as they have a dgp and should be modelled separately
    ...
    -   Heuristic methods are used to get [psill]{.arg-text}, [range]{.arg-text}, and [nugget]{.arg-text} starting values
