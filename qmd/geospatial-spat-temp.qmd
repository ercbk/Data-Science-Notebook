...
-   [**Anisotropy**]{style="color: #009499"}
    ...
    -   *Spatio-Temporal Anisotropy* means the data are "moving."

        -   Static Anisotropy: High correlation with points at the *same location in the past*
        -   Dynamic Anisotropy: High correlation with points *upstream in the past*.
...
-   arguments such as sill (the joint sill), nug (the joint nugget component) or stAni (the spatio-temporal anisotropy used in the jointVgm)
-   Covariance Models
    -   [Separable]{.underline}
