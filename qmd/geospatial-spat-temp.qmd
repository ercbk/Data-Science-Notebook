...
-   [Example 2]{.ribbon-highlight}: Pooled Temporal Variogram
    ...
    The goal is to find starting values for temporal `vgm` portions spatio-temporal variogram models.
...
-   st vig
    -   spatio-temporal variogram settings
...
-   statninja vid
    ...
    -   vid 4 fires
        -   convex hull
        -   time only variogram
        -   make sure there's no kappa in the separable model
        -   starting values
            -   cutoff max?/2 of spdist
            -   range
            -   siil as var
