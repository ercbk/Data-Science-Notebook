...
- [{]{style="color: #990000"}[spDBL](https://cran.r-project.org/package=spDBL){style="color: #990000"}[}]{style="color: #990000"} - Provides tools for **Bayesian** learning of spatiotemporal dynamical mechanistic models. Includes methods for parameter estimation, simulation, and inference using **hierarchical** and **state-space** modeling approaches
...
- [{]{style="color: #990000"}[ZINB.GP](https://kingjms1.github.io/GP_ZINB_R/){style="color: #990000"}[}]{style="color: #990000"} - Fits **Bayesian zero-inflated negative binomial regression models with Gaussian process random effects** for spatial, temporal, or spatiotemporal count data
:::

- Resources
  - Geospatial Health Data: Modeling and Visualization with R-INLA and Shiny [Ch.7](https://www.paulamoraga.com/book-geospatial/sec-arealdataexamplest.html), [Ch.10](https://www.paulamoraga.com/book-geospatial/sec-geostatisticaldataexamplest.html)
    - Models lung cancer risk using a bernardinelli model with INLA
    - Models air pollution using a SPDE (Stochastic Partial Differential Equation) model in INLA
  - Spatial Data Science With Applications in R, [Ch.13](https://r-spatial.org/book/13-Geostatistics.html)
