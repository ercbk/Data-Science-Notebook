...
- [Example 5]{.ribbon-highlight}: Which destination gets the most visitors per mode of transportation
...
- [Example 6]{.ribbon-highlight}: [{gglinedensity}]{style="color: #990000"}\
...
- [Example 7]{.ribbon-highlight}: [{daiquiri}]{style="color: #990000"}\
