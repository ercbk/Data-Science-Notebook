...
-   Weighting Options for `fit.variogram`\
    ...
    -   Depending on the target neighborhood size of the desired interpolation, it might be beneficial to narrow down the spatial and temporal distances and to introduce a cutoff.
