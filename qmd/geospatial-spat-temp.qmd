...
- [Example 1]{.ribbon-highlight}: Cross-Validation
  ...
  - This code is taking the original [r5to10]{.var-text} object from the [{spacetime}]{style="color: #990000"} vignette and transforming it into a tibble with some minor preprocessing along the way.
  ...
  - Learners (i.e. models) are specified and tacked on the end of the paths to create Graph objects. One graph object per learner.
  ...
  #>           <char>              <char>     <num>
  #> 1:   regr.ranger repeated_sptcv_cstf  9.387355
  #> 2: regr.lightgbm repeated_sptcv_cstf  9.515735
  #> 3: regr.catboost repeated_sptcv_cstf  9.279322
  ...
  - Catboost eeks out the victory with a 9.27 RMSE. SD is low so it looks like a stable algorithm for this data.
