...
-   Packages
    ...
    -   [{]{style="color: #990000"}[simDAG](https://robindenz1.github.io/simDAG/){style="color: #990000"}[}]{style="color: #990000"} - Generate data from a known directed acyclic graph (DAG) with associated information on distributions and causal coefficients
