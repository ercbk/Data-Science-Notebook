...
- Packages
  ...
  - [{]{style="color: goldenrod"}[adtk](https://github.com/arundo/adtk){style="color: goldenrod"}[}]{style="color: goldenrod"} - Toolkit for rule-based/unsupervised anomaly detection in time series
  ...
  - [{]{style="color: #990000"}[rarefun](https://cran.r-project.org/web/packages/rarefun/index.html){style="color: #990000"}[}]{style="color: #990000"} - Functions for detecting and analyzing rare events in data. Implements isolation forest and clustering for anomaly detection in time series residuals
  - [{]{style="color: #990000"}[sdf.test](https://cran.r-project.org/web/packages/sdf.test/index.html){style="color: #990000"}[}]{style="color: #990000"} - Nonparametric Two Sample Test for Equality of Spectral Densities
