...
* Common Questions
		_“I need to know why your model detected an anomaly. I need sound root cause analysis before I adjust my manufacturing process.”_ (see variable importance tracking)
	...
	Common Criticisms
		_“There are some false positives, I don’t have time to investigate each event!”_ (see event rates)
...
* Horizon Chart![](./_resources/Anomaly_Detection.resources/Screenshot (830).png)
...
* Also see [Algorithms, ML](Algorithms, ML) >> Trees >> Isolation Forests
...
* Misc
	* Also see [Feature Reduction](Feature Reduction) >> Autoencoders
