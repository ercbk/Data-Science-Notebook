...
-   Loss Functions If you care about errors measured in percent (i.e. "relative") and your data are strictly positive, then "relative" metrics such as the MALE and RMSLE MAPE and sMAPE are also in this class of metrics but have issues (See [Loss Functions](loss-functions.qmd#sec-lossfun){style="color: green"})
    -   If you care about errors measured in real units (e.g. number of apples), or your data can be zero or negative, then "raw" metrics such as MAE or MSE are more appropriate.
        -   See [Loss Functions \>\> Misc](loss-functions.qmd#sec-lossfun-misc){style="color: green"} \>\> re Stochastic Gradient Descent
...
-   How does the amount of data affect prediction
    ...
    -   [Example]{.ribbon-highlight}: Relative Absolute Error vs number of rows in the training set\
        ![](./_resources/Diagnostics,_Forecasting.resources/0-iuvsqiepyynQVak-.png){width="432"}
    ...
    -   [Example]{.ribbon-highlight}: MAE vs prediction horizon (colored by the number of weeks of data in training set)\
        ![](./_resources/Diagnostics,_Forecasting.resources/0-BGiEy_2VPo9SGDnQ.png){width="432"}
...
-   Does the model predict values close to zero\
    ![](./_resources/Diagnostics,_Forecasting.resources/0-0yCF9TwIqRZfKEvT.png){width="532"}
