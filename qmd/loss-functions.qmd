...
-   A quadratic loss function that's calculation is based on the squared errors, so it is more sensitive to the larger deviations associated with tail events ![](./_resources/Loss_Functions.resources/image10.png)
