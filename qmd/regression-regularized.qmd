...
-   For sample sizes less than around n = 1000 or sparse data, using Firth Estimator that uses Jeffrey's Penalized Likelihood is recommended
...
-   Maximum Likelihood vs Firth's Correction
    ...
    -   Bias\
        ![](_resources/Regression,_Logistic.resources/firth-pen-ml-vs-pml-1.webp){width="532"}

    -   Variance\
        ![](_resources/Regression,_Logistic.resources/firth-pen-ml-vs-pml-2.webp){width="532"}

    -   Coefficient and CI bar comparison on a small dataset (n = 35, k = 7)\
        ![](_resources/Regression,_Logistic.resources/firth-pen-ml-vs-pml-3.webp){width="532"}
...
-   Limitations
    ...
    -   Not invariant to linear transformations of the design matrix (i.e. predictor variables), which is a convenient property of ridge regression.
