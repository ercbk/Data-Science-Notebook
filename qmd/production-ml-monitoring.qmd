# Production, ML Monitoring {#sec-prod-mlmon}
...
-   Misc
    ...
    -   Other tracking
        ...
        -   [SHAP for Drift Detection: Effective Data Shift Monitoring](https://towardsdatascience.com/shap-for-drift-detection-effective-data-shift-monitoring-c7fb9590adb0) Feeds distribution of SHAP values into a logistic regression, then applies ks test on probability predictions for Y==1, Y==0
            ...
            Measuring Precision and Recall Actions taken by model Soft Actions - Events are flagged for humans to take action
...
-   Track distance metrics between reference variable distribution and a production variable distribution
    ...
    -   Thresholds
        ...
        -   Closed method for PSI
            ...
            -   Final Solution for the threshold 🥴![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(555).png)
...
-   Population Stability Index (PSI)
    ...
    -   Guidelines Also see Thresholds section above from https://scholarworks.wmich.edu/cgi/viewcontent.cgi?article=4249&context=dissertations ![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(160).png)
    ...
    -   Example from [arize ai](https://arize.com/take-my-drift-away/) (model monitoring platform) ![](./_resources/Production,_ML_Monitoring.resources/0-qz6NhHDCS3FYbONl.png)
...
-   Misc
    -   Also see [Project, Management](Project,%20Management) \>\> Event Auditing
...
-   Email
    -   Example: to developers![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(1185).png)
        -   "jarvis" is an internal package and this function probably wraps a template and email package function
    -   Example: to users![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(1188).png)
        -   "CHARTWatch" is the name of the data product
        -   Alerts user that the product is down and other pertinent information
-   Slack
    -   Example![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(1186).png)
