...
- Packages
  ...
  - [{]{style="color: #990000"}[APS](https://cran.r-project.org/web/packages/APS/index.html){style="color: #990000"}[}]{style="color: #990000"} ([Paper](https://link.springer.com/article/10.1186/s12859-025-06097-1)) - Provides methods to analyse the stability of non-deterministic prediction models. Prediction stability is quantified either as data-based prediction stability (phi) or as model-based prediction stability (psi)
    - Implements measures for categorical, ordinal, and metric predictions based on repeated model fitting and corresponding predictions
