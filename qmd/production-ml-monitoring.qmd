    ...
    -   Thresholds
        ...
        -   Closed method for PSI
            ...
            -   Final Solution for the threshold 🥴\
                ![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(555).png){.lightbox width="532"}
...
-   Also see this [article](https://www.r-bloggers.com/2022/09/kantorovich-distance-with-the-ompr-package/) for examples of computing wasserstein (aka Kantorovich) distance in R, py, Julia.
-   Packages
...
-   Jensen-Shannon Divergence
    ...
    -   Formula ![](./_resources/Production,_ML_Monitoring.resources/ql_39dea25ce67b8612aaabfee7409061f5_l3.png){.lightbox width="362"}

        -   Where pmix = 0.5(pref + pprod) and\
            ![](./_resources/Production,_ML_Monitoring.resources/ql_ac1542a437de134369e4c2fd6712bda0_l3.png){.lightbox width="298" height="34"}
            -   i ∈ length(bins)
            -   p is the percent of total observations in bin i
