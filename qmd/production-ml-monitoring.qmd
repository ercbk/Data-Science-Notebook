...
-   Track distance metrics between reference variable distribution and a production variable distribution
    ...
    -   Thresholds
        ...
        -   Closed method for PSI
            ...
            -   Final Solution for the threshold 🥴![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(555).png){width="532"}
...
-   Population Stability Index (PSI)
    ...
    -   Example from [arize ai](https://arize.com/take-my-drift-away/) (model monitoring platform) ![](./_resources/Production,_ML_Monitoring.resources/0-qz6NhHDCS3FYbONl.png){width="632"}
...
-   where pmix = 0.5(pref + pprod) and![](./_resources/Production,_ML_Monitoring.resources/ql_ac1542a437de134369e4c2fd6712bda0_l3.png){width="298" height="34"}
    -   i ∈ length(bins)
    -   p is the percent of total observations in bin i
...
-   Invariance testing
    ...
    -   Example![](./_resources/Production,_ML_Monitoring.resources/image.4.png){width="332"}
-   Directional Testing
    ...
    -   See [{{]{style="color: goldenrod"}[behave](https://github.com/behave/behave){style="color: goldenrod"}[}}]{style="color: goldenrod"}, [Write Readable Tests for Your Machine Learning Models with Behave](https://towardsdatascience.com/write-readable-tests-for-your-machine-learning-models-with-behave-ec4a27b91490)
    -   Example![](./_resources/Production,_ML_Monitoring.resources/image.5.png){width="332"}
...
-   Testing for drift![](./_resources/Production,_ML_Monitoring.resources/image.png){width="532"}
...
-   Architectures
    -   Azure ML![](./_resources/Production,_ML_Monitoring.resources/image.2.png){width="632"}
...
-   Email
    -   Example: to developers![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(1185).png){width="432"}
        -   "jarvis" is an internal package and this function probably wraps a template and email package function
    -   Example: to users![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(1188).png){width="532"}
        -   "CHARTWatch" is the name of the data product
        -   Alerts user that the product is down and other pertinent information
-   Slack
    -   Example![](./_resources/Production,_ML_Monitoring.resources/Screenshot%20(1186).png){width="432"}
