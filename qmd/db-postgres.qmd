# PostgreSQL {#sec-db-pstgr .unnumbered}
...
-   [Network-Attached Block Storage]{.underline} (e.g. EBS)\
    ![](_resources/DB-PostgreSQL.resources/distr-net-att-1.avif){width="332"}
...
-   [Read Replicas]{.underline}\
    ![](_resources/DB-PostgreSQL.resources/distr-read-rep-1.avif){width="332"}
...
-   [DBMS-Optimized Cloud Storage\
    ]{.underline}![](_resources/DB-PostgreSQL.resources/distr-dbms-opt-1.avif){width="532"}
...
-   [Active-Active]{.underline} (e.g. BDR)\
    ![](_resources/DB-PostgreSQL.resources/distr-active-active-1.avif){width="432"}
...
-   [Transparent Sharding]{.underline} (e.g. Citus)\
    ![](_resources/DB-PostgreSQL.resources/distr-trans-shard-1.avif){width="432"}
...
-   [Distributed Key-Value Stores With SQL]{.underline} (e.g. Yugabyte)\
    ![](_resources/DB-PostgreSQL.resources/distr-distr-key-1.avif){width="432"}
