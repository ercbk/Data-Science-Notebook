...
Docker Desktop 4.3.2 from Dec 2021
...
* Start postgres db in docker
	* Steps
		...
		* close powershell
		* In docker desktop, the "pg\_database" container should be running
* Connect to the db
	* Steps
...
* Create a db
	* Steps
		* `createdb -h localhost -p 5432 -U postgres -O eric two_trees`
			...
			* "two\_trees" is the name of the new db
...
* Create a table
	...
	* Via sql
		...
		* Run CREATE TABLE statement
			* If you don't include the schema as part of the table name, pgadmin automatically places it into the "public" schema directory (e.g. public.table\_name)
