...
-   SoftRank (2008 [paper](https://www.researchgate.net/publication/221520227_SoftRank_optimizing_non-smooth_rank_metrics))
    -   Instead of predicting a deterministic score s = f(x) like lambdaRank, a smoothened probabilistic score s\~ 𝒩(f(x), σ²) is predicted. ![](./_resources/Algorithms,_Learn-to-Rank.resources/image.6.png){width="618"}
