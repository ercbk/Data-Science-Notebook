...
-   Packages
    -   [{]{style="color: #990000"}[BayesMallowsSMC2](https://cran.r-project.org/web/packages/BayesMallowsSMC2/index.html){style="color: #990000"}[}]{style="color: #990000"} - Provides nested sequential Monte Carlo algorithms for performing sequential inference in the Bayesian Mallows model, which is a widely used probability model for rank and preference data
