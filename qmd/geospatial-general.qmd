...
-   Misc
    -   [Explainer](https://www.abc.net.au/news/2022-05-20/federal-election-map-lying/101076016#top): Why using hexbins to visualize Australian electoral map is better than a typical provincial map.
        ...
        -   Keep unit at constant size (like hexabins) but alter hex shape to keep state shape.![](./_resources/Geospatial,_General.resources/Screenshot%20(1176).png)
...
-   Uber's H3 grid system -
    ...
    -   16 Resolutions
        ...
        -   Example of resolution 6 in Iowa![](./_resources/Geospatial,_General.resources/Screenshot%20(105).png)
...
-   Kriging![](./_resources/Geospatial,_General.resources/1-9BQ6w68VCYLqBrPLkggWSg.png)
    ...
    -   Uses a correlated Gaussian process to guess at values between data points![](./_resources/Geospatial,_General.resources/1-LLa0n6goR2q_eqbfHnLbXQ.png)
        ...
        -   Correlated - smooth
            ...
            -   Example: temperature
    -   Fewer known points means greater unceretainty![](./_resources/Geospatial,_General.resources/1-QPOryrEMh61jUAjKOfpMdA.png) Inputs:
        ...
        -   the "calibrated" probabilistic model, with the spatial correlation obtained by data outputs:
