...
-   Misc
    -   [Explainer](https://www.abc.net.au/news/2022-05-20/federal-election-map-lying/101076016#top): Why using hexbins to visualize Australian electoral map is better than a typical provincial map.
        -   tl;dr: Geographical size distorts what the value is trying to measure. The value is the party that wins the parliamentary seat\
            ...
            ::: {layout-ncol="2"}
            ![](./_resources/Geospatial,_General.resources/Screenshot%20(1160).png){width="332"}

            ![](./_resources/Geospatial,_General.resources/Screenshot%20(1159).png){width="332"}

            ![](./_resources/Geospatial,_General.resources/Screenshot%20(1162).png){width="332"}
            :::
        ...
        -   Keep unit at constant size (like hexabins) but alter hex shape to keep state shape.\
            ![](./_resources/Geospatial,_General.resources/Screenshot%20(1176).png){width="432"}
...
-   Uber's H3 grid system -
    -   Misc
        -   Packages: [{h3r}]{style="color: #990000"}, [{h3-r}]{style="color: #990000"}
    ...
    -   16 Resolutions
        ...
        -   Example of resolution 6 in Iowa\
            ![](./_resources/Geospatial,_General.resources/Screenshot%20(105).png){width="432"}
...
-   Comparisons ([[{potential}](https://riatelab.github.io/potential/articles/web_only/exemple.html)]{style="color: #990000"}[article](https://riatelab.github.io/potential/articles/web_only/exemple.html))
    -   GDP per capita (cloropleth)\
        ![](./_resources/Geospatial,_General.resources/image.png){width="414"}
        -   Typical cloropleth at the municipality level
        -   Values have been binned
    -   Potential GDP per Capita (interaction)\
        ![](./_resources/Geospatial,_General.resources/image.1.png){width="414"}
    ...
    -   Smoothed GDP per Capita (interpolation)\
        ![](./_resources/Geospatial,_General.resources/image.2.png){width="414"}
...
-   Measurements can have strong regional variance, so the geographical distribution of measurements can have a strong influence on statistical estimates.
    -   [Example]{.ribbon-highlight}: Temperature\
        -   Two different geographical distributions of sensors\
            ![](_resources/Geospatial,_General.resources/geospatial-distribution-1.svg)
        ...
        -   Distribution of temperatures across the region for 1 day.\
            ![](_resources/Geospatial,_General.resources/geospatial-distribution-2.png)
        ...
        -   Interpolation *evens* *out* the geographical distribution of measurments\
            ![](_resources/Geospatial,_General.resources/geospatial-distribution-3.png){width="261"}
...
-   Misc
    -   [{gstat}]{style="color: #990000"} - Has various interpolation methods.
-   [Kriging]{.underline}\
    ![](./_resources/Geospatial,_General.resources/1-9BQ6w68VCYLqBrPLkggWSg.png){width="532"}
    ...
    -   Uses a correlated Gaussian process to guess at values between data points\
        ![](./_resources/Geospatial,_General.resources/1-LLa0n6goR2q_eqbfHnLbXQ.png){width="532"}
    ...
    -   Fewer known points means greater unceretainty\
        ![](./_resources/Geospatial,_General.resources/1-QPOryrEMh61jUAjKOfpMdA.png){width="532"}
        -   Inputs:
