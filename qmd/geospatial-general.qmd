...
* spatiotemporal data — data _cubes_ with spatial and regular temporal dimensions — such as
...
* **Census Block Groups** - ~600–3,000 population; the smallest geography reported; [Wiki](https://en.wikipedia.org/wiki/Census_block_group)
* **Census Tract** - ~4,000 average population; [Docs](https://www2.census.gov/geo/pdfs/education/CensusTracts.pdf)
	* Also see [Survey, Census Data](Survey, Census Data) >> Geographies
...
* Regarding "abs\_mesh\_blocks": [{mvtview}]{style='color: #990000'} provides a way to fetch the metadata table from .mbtiles as json by querying a json file with the same name as the .mbitles file.
...
* Misc
	* [Explainer](https://www.abc.net.au/news/2022-05-20/federal-election-map-lying/101076016#top): Why using hexbins to visualize Australian electoral map is better than a typical provincial map.
		* tl;dr: Geographical size distorts what the value is trying to measure. The value is the party that wins the parliamentary seat![](./_resources/Geospatial,_General.resources/Screenshot (1160).png)![](./_resources/Geospatial,_General.resources/Screenshot (1159).png)![](./_resources/Geospatial,_General.resources/Screenshot (1162).png)
		...
		* Keep unit at constant size (like hexabins) but alter hex shape to keep state shape.![](./_resources/Geospatial,_General.resources/Screenshot (1176).png)
...
* Uber's H3 grid system - 
	...
	* 16 Resolutions
		...
		* Example of resolution 6 in Iowa![](./_resources/Geospatial,_General.resources/Screenshot (105).png)
...
* Carto Spatial Features dataset ($) - https://carto.com/spatial-data-catalog/browser/?country=usa&category=derived&provider=carto
	...
	* Features
		...
		* Population by age and gender (e.g. female\_0\_to\_19)
		* POIs by category
			* retail stores
			* education
...
* Comparisons ([[{potential}]{style='color: #990000'} article](https://riatelab.github.io/potential/articles/web_only/exemple.html))
	* GDP per capita (cloropleth)![](./_resources/Geospatial,_General.resources/image.png)
		* Typical cloropleth at the municipality level
		* Values have been binned
	* Potential GDP per Capita (interaction)![](./_resources/Geospatial,_General.resources/image.1.png)
	...
	* Smoothed GDP per Capita (interpolation)![](./_resources/Geospatial,_General.resources/image.2.png)
...
* Kriging![](./_resources/Geospatial,_General.resources/1-9BQ6w68VCYLqBrPLkggWSg.png)
	* Misc
		* [{gstat}]{style='color: #990000'}
	* Uses a correlated Gaussian process to guess at values between data points![](./_resources/Geospatial,_General.resources/1-LLa0n6goR2q_eqbfHnLbXQ.png)
		...
		* Correlated - smooth
			...
			* Example: temperature
	* Fewer known points means greater unceretainty![](./_resources/Geospatial,_General.resources/1-QPOryrEMh61jUAjKOfpMdA.png)
		Inputs:
