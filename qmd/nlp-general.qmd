...
-   [**Flood Words**]{style="color: #14adff"} - words that are too common in the domain (i.e. noise)
-   [**Hypernym**]{style="color: #14adff"} - a word with a broad meaning constituting a category into which words with more specific meanings fall
...
-   [**Hyponym**]{style="color: #14adff"} -  opposite of Hypernym; a word of more specific meaning than a general term applicable to it.
-   [**Named Entity Recognition (NER)**]{style="color: #14adff"} - a subtask of information extraction that seeks to locate and classify named entities mentioned in unstructured text into pre-defined categories such as person names, organizations, locations, medical codes, time expressions, quantities, monetary values, percentages, etc.![](./_resources/NLP,_General.resources/image.1.png)
...
-   [**sequence to sequence**]{style="color: #14adff"} (aka \[**string transduction**) -  problems where the input and output is text
    -   e.g. Text summarization, Text simplification, Question answering, Chatbots, Machine translation
-   [**Spam Words**]{style="color: #14adff"} - Words that don't belong in the domain (i.e. noise)

Hearst Patterns ![](./_resources/NLP,_General.resources/image.png)
