...
-   Monitoring
    ...
    -   Tables (e.g. large partitions leading to disk spillage)\
        ![](_resources/Apache,_Spark.resources/spill-mon-jobs-1.webp){width="532"}
        -   Summary\
            ![](_resources/Apache,_Spark.resources/spill-mon-stats-sum-1.webp){width="532"}
        -   Aggregated\
            ![](_resources/Apache,_Spark.resources/spill-mon-stats-agg.webp){width="532"}
        -   Task\
            ![](_resources/Apache,_Spark.resources/spill-mon-stats-task-1.webp){width="532"}
        -   SQL Plan (On sort step)\
            ![](_resources/Apache,_Spark.resources/spill-mon-sqlplan-1.webp){width="332"}
