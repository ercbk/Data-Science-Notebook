...
-   Packages
    ...
    -   [{]{style="color: #990000"}[VectrixDB](https://cran.r-project.org/web/packages/VectrixDB/index.html){style="color: #990000"}[}]{style="color: #990000"} - Lightweight Vector Database with Embedded Machine Learning Models
