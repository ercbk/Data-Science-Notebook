...
## POST {#sec-scrap-post .unnumbered}
...
-   [Example]{.ribbon-highlight}: Table ([source](https://www.etiennebacher.com/posts/2023-05-09-making-post-requests-with-r/))\
    ...
    -   Find Query String and Header Parameters
