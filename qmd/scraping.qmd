...
-   Retrieve Sidebar Content ([source](https://www.youtube.com/watch?v=30AOpjLeOyI&ab_channel=TheCoatlessProfessor))
...
-   [Example]{.ribbon-highlight}: Real Estate Addresses
    ...
    -   Get API Parameters From Network Tab
        ...
        -   Copy the request url from the Headers and the query parameters that were used from the Payload tab
    ...
    -   Call API and Get the Data
        ...
        -   To grap the property characteristics, you can adjust the `pull_addrs` function
            ...
            -   Each characteristic is a list element. It would take some additional wrangling to get it tidy. I didn't look at this result too closely, but it shouldn't be too much trouble.
        :::
