...
-   Packages
    ...
    -   [{]{style="color: #990000"}[selenider](https://ashbythorpe.github.io/selenider/){style="color: #990000"}[}]{style="color: #990000"} - Wrapper functions around {chromote} and {selenium} functions that utilize lazy element finding and automatic waiting to make scraping code more reliable
