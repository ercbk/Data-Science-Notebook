...
-   CSV Editors
    ...
    -   [OpenRefine]{.underline} - Has read-only, Several add-ons, Completely open source.
        ...
        -   Starts with a 1024 MB RAM usage limit which is proably fine for around a 100MB csv. Need to [set the limit higher](https://openrefine.org/docs/manual/installing#increasing-memory-allocation) in a config file in order to edit larger files.
