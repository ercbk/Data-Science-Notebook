...
-   Also see [CLI, General \>\> AWK](cli-general.qmd#sec-cli-gen-awk){style="color: green"}
...
-   [duckreg](https://github.com/apoorvalal/duckreg) - Run stratified/saturated regressions out-of-memory with duckdb
