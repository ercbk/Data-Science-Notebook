...
-   Packages
    ...
    -   [{]{style="color: #990000"}[embedplyr](https://rimonim.github.io/embedplyr/){style="color: #990000"}[}]{style="color: #990000"} ([JOSS](https://joss.theoj.org/papers/10.21105/joss.08262)) - Enables common operations with word and text embeddings within a ‘tidyverse’ and/or ‘quanteda’ workflow
