...
-   `brms::pairs(model_fit)` (SR Ch 4)\
    ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-80-1.png){width="432"}

-   [Example]{.ribbon-highlight}: SR Ch 8,9\
    ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-44-1.png){width="432"}
...
-   Misc
    ...
    -   Values potentially indicate multimodal distribution (Vehtari, [Thread](https://bayes.club/@avehtari/110054516509768541))\
        ![](./_resources/Diagnostics,_Bayes.resources/image.png){width="182"}
...
-   Autocorrelation plots for chains\
    ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-48-1.png){width="632"}
...
-   [Posteriors and Trace Plots]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: Ch 8,9 Statistical Rethinking\
        ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-46-1.png){width="632"}
...
-   [Trank Plot (Trace Rank Plot)]{.underline}\
    ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-53-1.png){width="632"}
...
-   [Example]{.ribbon-highlight}:
    ...
    -   Bad Fit\
        ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-8-1.png){width="432"}
    ...
    -   Good Fit\
        ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-21-1.png){width="432"}

-   With [{bayesplot}]{style="color: #990000"}\
    ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-22-1.png){width="432"}
...
-   Data with regression line\
    ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-81-1.png){width="332"}
...
-   Predicted vs Observed with PI and CI around regression line\
    ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-101-1.png){width="332"}
...
-   [{DHARMa}]{style="color: #990000"}
    ...
    -   [Example]{.ribbon-highlight}:
        -   Bad Fit\
            ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-7-1.png){width="532"}
        ...
        -   Good Fit\
            ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-20-2.png){width="532"}

            -   Hierarchical dataset fit with a hierarchical negative binomial model.

-   [Example ]{.ribbon-highlight}Group Variation Check\
    ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-13-1.png){width="532"}
...
-   [Example]{.ribbon-highlight}: Overdispersion
    ...
    -   Bad fit\
        ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-14-1.png){width="432"}
    ...
    -   Good Fit\
        ![](./_resources/Diagnostics,_Bayes.resources/unnamed-chunk-18-1.png){width="432"}
