...
-   **Bayes Factor**
    -   Packages
        -   [{]{style="color: #990000"}[bfpwr](https://cran.r-project.org/web/packages/bfpwr/index.html){style="color: #990000"}[}]{style="color: #990000"} - Closed-Form Power and Sample Size Calculations for Bayes Factors
