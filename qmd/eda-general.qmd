...
-   Find duplicate rows
    -   See
        -   [Code, Snippets \>\> Cleaning](r-snippets.qmd#sec-r-snippets-cleaning){style="color: green"}
...
-   [{explore}](https://rolkra.github.io/explore/) - Interactive data exploration or automated report
...
-   Also see [Distributions \>\> Fitting Distributions](distributions.qmd#sec-distr-fitdist){style="color: green"}
...
-   [Multicollinearity]{.underline}
    ...
    -   If multicollinearity is a present, see [Feature Selection \>\> Basic](feature-selection.qmd#sec-featsel-basic){style="color: green"}
