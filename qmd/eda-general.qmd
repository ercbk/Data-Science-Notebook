...
-   Use domain knowledge to assess peculier relationships
    -   Example: Is there a nonlinear relationship between Driver hours and Incentive Level\
        ![](./_resources/EDA.resources/0-FmfHLkDICNkqaV1u.png){width="432" height="189"}
...
-   Find duplicate rows
    -   See
        -   [Code, Snippets \>\> Cleaning](code-snippets.qmd#sec-code-snippits-cleaning){style="color: green"}
...
-   [{]{style="color: #990000"}[trelliscopejs](https://hafen.github.io/trelliscopejs/){style="color: #990000"}[}]{style="color: #990000"} - quick, interactive, facetted pairwise plots
...
-   [{Hmisc::describe}]{style="color: #990000"}
    ...
    -   "continuous"\
        ![](./_resources/EDA.resources/Screenshot%20(1434).png){width="632"}
    -   "categorical"\
        ![](./_resources/EDA.resources/Screenshot%20(1433).png){width="532"}
...
-   Categoricals for binary classification\
    ![](./_resources/EDA.resources/Screenshot%20(244).png){width="408"}
...
## What is the problem? {#sec-eda-gen-wtp .unnumbered}

### General {#sec-eda-gen-wtp-gen .unnumbered}
...
### TROPICS framework {#sec-eda-gen-wtf-trop .unnumbered}
...
-   Also see [Outliers](outliers.qmdoutliers.html#sec-outliers){style="color: green"}
...
-   [Histogram - Check shape of distribution]{.underline}
...
-   [Q-Q plot to check fit against various distributions]{.underline}
    ...
    -   Skewed Variables
        ...
        ![](_resources/EDA.resources/cont-qq-skew-1.png){width="632"}
    ...
    -   Good fits
        ...
        -   normal distribution\
            ![](./_resources/EDA.resources/image.png){width="332"}
        -   Bad fits
            -   Uniform data tested against a normal distibution\
                ![](./_resources/EDA.resources/image.1.png){width="332"}
            -   Uniform data tested against an exponential distribution\
                ![](./_resources/EDA.resources/image.2.png){width="332"}
...
-   [Is the mean/median above or below any important threshold?]{.underline}
    ...
    -   [Empirical Cumulative Density function (ecdf)]{.underline}\
        ![](./_resources/EDA.resources/image.3.png){width="432"}
...
-   Visualize value counts for multiple variables
    ...
    -   Facetted bar by variable with counts of the values\
        ![](./_resources/EDA.resources/Screenshot%20(1370).png){width="632"}
...
-   [Pairwise plots for patterns]{.underline}
    ...
    -   Example: {{ggforce}}
        ...
        ![](_resources/EDA.resources/facet-matrix1.png){width="632"}
...
-   [For binary outcome, look for]{.underline} [variation between numeric variables and each outcome level]{.underline}\
    ![](./_resources/EDA.resources/Screenshot%20(347).png){width="432"}
    ...
    -   Normalize the x-axis with `rank_percentile(value)`\
        ![](./_resources/EDA.resources/Screenshot%20(349).png){width="432"}
...
-   [Estimated AUC for binary outcome \~ numeric predictor]{.underline}
...
-   [Boxplot by Categorical]{.underline}
    ...
    -   `fct_lump`  can be used to create an "other" group.
        ...
        ![](./_resources/EDA.resources/Screenshot%20(331).png){width="532"}
...
-   [Boxplot by Categorical]{.underline} (Titanic5 dataset)\
    ![](./_resources/EDA.resources/newplot.png){width="432"}
...
-   [Binary Outcome vs Two Binned Continuous]{.underline}
    ...
    ![](./_resources/EDA.resources/Screenshot%20(357).png){width="432"}
...
-   [Numeric vs Numeric, Scatter with Smoother by a Categorical]{.underline}\
    ![](./_resources/EDA.resources/image.4.png){width="532"}
...
-   [Continuous vs Binary by Binary]{.underline}\
    ![](./_resources/EDA.resources/Screenshot%20(499).png){width="332"}
...
-   Continuous vs Continuous by Categorical
    ...
    ![](_resources/EDA.resources/inter-cont-cont-cat-1.png){width="632"}
...
-   Continuous vs Continuous by Categorical by Categorical
    ...
    ![](_resources/EDA.resources/inter-cont-cont-cat-2.png){width="532"}
...
-   [Correlation Heatmaps]{.underline}
    ...
    -   Example: PM 2.5 pollution (outcome) vs complete dataset and filtered for Wind Direction = NE
        -   Complete\
            ![](./_resources/EDA.resources/1-AdMrKIjcDnVHl3PXLfmVWg.png){width="432"}
        -   Wind Direction = NE\
            ![](./_resources/EDA.resources/1-qk97V3pj37kpo1-NyF3cEA.png){width="432"}
        -   Interpretation
...
-   [Boxplot by Discrete (Binned) Continuous]{.underline}
    ...
    -   `pmin` can be similarily used as fct_lump (see below) but for discrete integer variables
        ...
        -   If the distribution is skewed to the left, `pmax` can be used similarily.\
            ![](./_resources/EDA.resources/Screenshot%20(332).png){width="332"}
...
-   [Numeric vs Numeric by Cat Outcome]{.underline}
    ...
    -   **Scatter** with linear smooth (or loess)\
        ![](./_resources/EDA.resources/Screenshot%20(351).png){width="432"}
...
-   [Binary Outcome (pct_event) vs Discrete by Discrete]{.underline} (or binary in this case)\
    ![](./_resources/EDA.resources/Screenshot%20(354).png){width="432"}
    ...
    -   Example of likely no interaction\
        ![](./_resources/EDA.resources/Screenshot%20(358).png){width="432"}
...
-   [Binary Outcome (pct_event) vs Categorical by Categorical]{.underline}
    ...
    -   Sliding Window Continuous vs Binary Outcome (Proportion of Event) by Categorical\
        ![](./_resources/EDA.resources/image.5.png){width="432"}
    ...
    -   Sliding Window Continuous vs Binary Outcome (Proportion of Event) by 2 Categoricals\
        ![](./_resources/EDA.resources/image.6.png){width="532"}
    ...
    -   Grouped Bar\
        ![](./_resources/EDA.resources/Screenshot%20(345).png){width="432"}
...
-   [Binary Outcome vs Binary by Categorical]{.underline}\
    ![](./_resources/EDA.resources/Screenshot%20(505).png){width="432"}
