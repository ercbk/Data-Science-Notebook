...
-   Fast Plotting
    ...
    -   [{]{style="color: #990000"}[ggpmisc](https://docs.r4photobiology.info/ggpmisc/){style="color: #990000"}[}]{style="color: #990000"} - Nice correlation, line fitting functions, mean difference tests
    ...
    -   [{]{style="color: #990000"}[tinyplot](https://grantmcdermott.com/tinyplot/){style="color: #990000"}[}]{style="color: #990000"} - Fast group by and facetting via formula
        -   See [Continuous Predictor vs Outcome \>\> Continuous Outcome](eda-general.qmd#sec-eda-gen-contout-cont){style="color: green"}
        -   See [Categorical Predictor vs Outcome \>\> Continuous Outcome](eda-general.qmd#sec-eda-gen-catout-cont){style="color: green"}
    -   [{]{style="color: #990000"}[tidyplots](https://jbengler.github.io/tidyplots/){style="color: #990000"}[}]{style="color: #990000"} - Fast plots w/annotations, heatmaps, mean difference tests, beeswarm boxplots.
...
-   Packages
    ...
    -   [{]{style="color: #990000"}[GGally](https://ggobi.github.io/ggally/){style="color: #990000"}[}]{style="color: #990000"} - Pairwis Plot Matrices
