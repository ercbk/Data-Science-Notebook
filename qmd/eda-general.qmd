...
-   Numeric![](./_resources/EDA.resources/Screenshot%20(1434).png)

-   Categorical![](./_resources/EDA.resources/Screenshot%20(1433).png)
...
-   Also see
    ...
    -   [Model Building, tidymodels](Model%20Building,%20tidymodels) \>\> Recipe \>\> Missingness
-   Packages
...
-   Categoricals for binary classification![](./_resources/EDA.resources/Screenshot%20(244).png)
...
-   Break down the problem into parts and focus on those during EDA
    -   Also see [Decison Theory](Decison%20Theory) \>\> Mental Models for details on methods to break down components
...
-   Visualize value counts for multiple variables
    ...
    -   Facetted bar by variable with counts of the values![](./_resources/EDA.resources/Screenshot%20(1370).png)
...
-   Is it multi-modal
    -   See [Regression, Other](Regression,%20Other) \>\> Multi-Modal (visuals, tests, modelling, etc.)
...
-   Is the mean/median above or below any important threshold?
    ...
    -   Binning (Harrell supports splines, see [Feature Engineering, General](Feature%20Engineering,%20General) \>\> Numeric \>\> Binning \>\> Harrell)
...
-   Also see
    -   [Correlation, Association, and Distance](Correlation,%20Association,%20and%20Distance)
...
-   For binary vs. binary, also see [Correlation, Association, and Distance](Correlation,%20Association,%20and%20Distance) \>\> Binary Similarity Measures and Cramer's V
...
-   Numeric outcome
    -   Scagnostics ([paper](https://www.cs.uic.edu/~aanand/publications/INFOVIS05-scagnostics.pdf)) - metrics to examine numeric vs numeric relationships
        ...
        -   Score Guide![](./_resources/EDA.resources/Screenshot%20(974).png)
            -   High value: Red
            -   Low value: Blue
...
-   Categorical outcome
    -   For binary outcome, look for variation between numeric variables and each outcome level![](./_resources/EDA.resources/Screenshot%20(347).png)
...
-   Normalize the x-axis with `rank_percentile(value)`![](./_resources/EDA.resources/Screenshot%20(349).png)
...
-   See [Regression, Interactions](Regression,%20Interactions) for details
-   Interpretation
...
-   **Scatter** with linear smooth (or loess)![](./_resources/EDA.resources/Screenshot%20(351).png)
...
-   Binary Outcome (pct_event) vs Discrete by Discrete (or binary in this case)![](./_resources/EDA.resources/Screenshot%20(354).png)
...
-   Example: the cut points for avg_trans_amt were chosen from its distribution
    ...
    -   Also see [Regression, Other](Regression,%20Other) \>\> Mult-Modal
-   Example of likely no interaction![](./_resources/EDA.resources/Screenshot%20(358).png)
...
-   **Grouped Bar**![](./_resources/EDA.resources/Screenshot%20(345).png)
...
-   numeric (DV) vs categorical (IV) by categorical (IV)![](./_resources/EDA.resources/Screenshot%20(499).png)
...
-   boxplot by discrete (binned) numeric
    -   `pmin` can be similarily used as fct_lump (see below) but for discrete integer variables
        ...
        -   If the distribution is skewed to the left, `pmax` can be used similarily.![](./_resources/EDA.resources/Screenshot%20(332).png)
...
-   3-way Categorical Interaction![](./_resources/EDA.resources/Screenshot%20(505).png)
