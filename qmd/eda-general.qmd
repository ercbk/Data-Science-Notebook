...
- [Fast Plotting]{.underline}
  ...
  - [{]{style="color: #990000"}[ggauto](https://nrennie.rbind.io/ggauto/){style="color: #990000"}[}]{style="color: #990000"} - Automatically create an appropriate ggplot2 chart type based on the classes of the provided variables.
...
- [Reports]{.underline}
  ...
  - [{Hmisc::describe}]{style="color: #990000"}
    - [Example]{.ribbon-highlight}: Overview
  ...
  - [{]{style="color: #990000"}[pointblank::scan_data](https://rstudio.github.io/pointblank/reference/scan_data.html){style="color: #990000"}[}]{style="color: #990000"}, [{]{style="color: goldenrod"}[pointblank::col_summary_tbl](https://posit-dev.github.io/pointblank/user-guide/col-summary-tbl.html){style="color: goldenrod"}[}]{style="color: goldenrod"}, [{]{style="color: goldenrod"}[pointblank::missing_vals_tbl](https://posit-dev.github.io/pointblank/user-guide/missing-vals-tbl.html){style="color: goldenrod"}[}]{style="color: goldenrod"}
...
- Also see
  ...
  - [Geospatial, Spatio-Temporal \>\> Kriging \>\> Examples](geospatial-spat-temp.qmd#sec-geo-sptemp-krig-ex){style="color: green"} \>\> Example2 \>\> Residuals
    - Last chart shows a robust distributional boxplot using the median and MAD
- Packages
...
- Packages
  ...
  - [{]{style="color: #990000"}[sshist](https://cran.r-project.org/web/packages/sshist/index.html){style="color: #990000"}[}]{style="color: #990000"} - Optimal Histogram Binning Using Shimazaki-Shinomoto Method
    - Minimizes the mean integrated squared error (MISE) and features a C++ backend for high performance and shift-averaging to remove edge-position bias
...
- Packages
  ...
  - [{]{style="color: #990000"}[SimTablR](https://matheustg-14.github.io/SimtablR/){style="color: #990000"}[}]{style="color: #990000"} - Frequency and summary tables with:
