...
-   Packages
    ...
    -   [{]{style="color: #990000"}[HDANOVA](https://khliland.github.io/HDANOVA/){style="color: #990000"}[}]{style="color: #990000"} - High-Dimensional Analysis of Variance
        -   Main methods:
            ...
            -   PERMANOVA - Permutation Based MANOV
...
-   [Misc]{.underline}
    ...
    -   Mixed ANOVA: Subjects that undergo each condition are different.
        -   e.g. Testing how men vs. women (between-subjects) perform on a memory test measured at three time points (within-subjects)
    -   Two-Way Repeated Measures ANOVA: The same subjects undergo both conditions. It examines the effects of two within-subject factors on a dependent variable.
