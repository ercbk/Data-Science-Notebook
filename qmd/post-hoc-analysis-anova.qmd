...
## Repeated Measures {#sec-phoc-anova-rmanova .unnumbered}

-   [Example]{.ribbon-highlight}; Relationship to Mixed Effects Models ([source](https://bsky.app/profile/mattansb.bsky.social/post/3le32ed4hrk2q))
    ...
    A <- afex::aov_ez(id = "pno", dv = "rt", data = stroop_sub, 
    ...
    -   Ommitting the varying slopes results in a model that doesn't detect the significance of the interaction even using aggregated data (see source)
