...
-   Also see [Post-Hoc Analsyis \>\> Frequentist Difference-in-Means \>\> Post-ANOVA Tests](post-hoc-analysis-general.qmd#sec-phoc-gen-fdim-panov){style="color: green"}
-   Assumptions
...
-   [Example]{.ribbon-highlight}: 1 control, 2 Test groups
    ...
    -   Dunnett's Test
        ...
        -   Also see [Post-Hoc Analsyis \>\> Frequentist Difference-in-Means \>\> Post-ANOVA Tests](post-hoc-analysis-general.qmd#sec-phoc-gen-fdim-panov){style="color: green"} \>\> Dunnett's Test\
    ...
    -   Tukey's HSD
        ...
        -   Also see [Post-Hoc Analsyis \>\> Frequentist Difference-in-Means \>\> Post-ANOVA Tests](post-hoc-analysis-general.qmd#sec-phoc-gen-fdim-panov){style="color: green"} \>\> Tukey's Test
...
-   Does the effect differ by treatment
    ...
    -   Also see [Post-Hoc Analysis, Mixed Effect \>\> Tukey's Test](post-hoc-analysis-mixed-effects.html#sec-phoc-mixeff-tukey){style="color: green"}
