...
-   How brms fits models\
    ![](./_resources/Model_Building,_brms.resources/Screenshot%20(1364).png){width="247"}
...
-   [Example]{.ribbon-highlight}: Basis Splines (SR, Ch.4)\
    ![](./_resources/Model_Building,_brms.resources/ql_1ce75c1d952219fd5f6d8db1e3984252_l3.png){width="176"}
