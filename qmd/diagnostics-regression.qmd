...
-   [Pearson Standardized Residuals]{.underline}: R = (Y - Y_hat) / SD(Y), where SD(Y) is an estimation of the standard deviation of Y.
    ...
    -   Residuals vs Fitted scatter
        -   Heteroskedastic\
            ...
            -   Solutions:
                ...
                -   Weighted Least Squares (see [Regression, Other \>\> Weighted Least Squares](regression-other.html#sec-reg-other-wls){style="color: green"}) Also see Feasible Generalized Least Squares (FGLS) in the same note
