...
-   `performance::check_model`\
    ![](./_resources/Diagnostics,_Regression.resources/performance_check_model_plot.jpg){width="532"}
...
-   [Check for heteroskedacity or Non-Linear Patterns]{.underline}
    ...
    -   Residuals vs Fitted scatter
        ...
        -   Nonlinear\
            ![](./_resources/Diagnostics,_Regression.resources/1-yP8OulKEBavWukcnJLixCw.png){width="332"}![](./_resources/Diagnostics,_Regression.resources/1-jkwegbRDZKqjnT8w9yWE6A.png){width="332"}
...
-   For prediction, if coefficients vary significantly across the test folds their robustness is not guaranteed (see coefficient boxplot below), and they should probably be interpreted with caution.\
    ![](./_resources/Diagnostics,_Regression.resources/sphx_glr_plot_linear_model_coefficient_interpretat.png){width="532"}
    ...
    -   Variability in coefficients (i.e. high std.errors) can also be explained by collinearity between predictors\
        ![](./_resources/Diagnostics,_Regression.resources/sphx_glr_plot_linear_model_coefficient_interpretat.1.png){width="432"}
