...
-   Packages
    ...
    -   [{]{style="color: #990000"}[querychat](https://posit-dev.github.io/querychat/){style="color: #990000"}[}]{style="color: #990000"} for both R and Python
        -   [Python Shiny template](https://shiny.posit.co/py/templates/querychat/), [Joe Cheng's app](https://shiny.posit.co/py/templates/sidebot/), [Machlis article](https://www.infoworld.com/article/4040535/chat-with-your-data-the-easy-way-in-r-or-python.html)
...
-   Resources
    ...
    -   Posit deep dive series on LLMS
