...
- Packages
  - [{]{style="color: #990000"}[actionsMonitoR](https://github.com/smach/actionsMonitoR){style="color: #990000"}[}]{style="color: #990000"} - See info about all the GitHub Actions in one GitHub account
...
- Installing dependencies from a R package's DESCRIPTION file ([source](https://mastodon.social/@eddelbuettel/117167419838831635))
