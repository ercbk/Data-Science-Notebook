...
-   Allows you to see how predictor variables contribute to prediction.
    -   Maybe compare between models.
-   breakdown obj shows numbers.
-   Baseline is the avg predicted response value (at least it is for shapley force plots) and origin point in plot. Think its there to make graph more readable.
-   Top bar (final prognosis) is predicted value. Rest of bars add up to that value. Doesn't give observed value to show how much predicted value is off by.
