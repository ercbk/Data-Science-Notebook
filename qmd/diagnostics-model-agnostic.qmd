...
-   [Example]{.ribbon-highlight}: [{localModel}]{style="color: #990000"}
    ...
    -   Note the dichotomization of the continuous variable, [age]{.var-text}
        ...
        -   Cutpoint chosen using ceteris-paribus profiles. The point at which the largest change in the response is chosens as the cutpoint.
            -   CP Profile: `localModel::plot_interpretable_feature(locMod_johnny, "age")`
                ...
                ![](_resources/Diagnostics,_Model_Agnostic.resources/dalex-lime-locmod-1.png){width="432"}
    ...
    -   Visualizaton: `plot(locMod_johnny)`
        ...
        ![](_resources/Diagnostics,_Model_Agnostic.resources/dalex-lime-locmod-2.png){width="432"}
...
-   [Example]{.ribbon-highlight}: Compare 2 observations
    ...
    ![](_resources/Diagnostics,_Model_Agnostic.resources/dalex-cp-2obs-1.png){width="532"}
...
-   [Example]{.ribbon-highlight}: Compare Multiple Models
    ...
    ![](_resources/Diagnostics,_Model_Agnostic.resources/dalex-cp-multmod-1.png){width="532"}
...
-   [Example]{.ribbon-highlight}: Basic
    ...
    ![](_resources/Diagnostics,_Model_Agnostic.resources/dalex-cp-oscill-1.png){width="382"}
...
-   [Example]{.ribbon-highlight}
    -   Local-Fidelity
        ...
        ![](_resources/Diagnostics,_Model_Agnostic.resources/dalex-local-fidelity-1.png){width="532"}
    ...
    -   Local-Stability
        ...
        ![](_resources/Diagnostics,_Model_Agnostic.resources/dalex-local-stab-1.png){width="532"}
...
-   [Example]{.ribbon-highlight}
    ...
    ![](_resources/Diagnostics,_Model_Agnostic.resources/dalex-funnel-1.png){width="632"}
