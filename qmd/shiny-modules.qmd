...
-   Packages
    ...
    -   [{]{style="color: #990000"}[shinydataviewer](https://ryan-w-harrison.github.io/shinydataviewer/){style="color: #990000"}[}]{style="color: #990000"} - A reusable Shiny module for viewing tabular data with a searchable table and a variable summary sidebar inspired by the Positron data explorer
