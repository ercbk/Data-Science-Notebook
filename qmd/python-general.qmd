...
-   [Dictionaries]{.underline}
    ...
    -   `defaultdict`
        ...
        -   From [{{]{style="color: goldenrod"}[collections](https://docs.python.org/3/library/collections.html#defaultdict-examples){style="color: goldenrod"}[}}]{style="color: goldenrod"}, Pybites [video](https://www.youtube.com/watch?v=fzdVyP9SQFw)
...
-   [{{]{style="color: goldenrod"}[pipx](https://pypa.github.io/pipx/){style="color: goldenrod"}[}}]{style="color: goldenrod"}
