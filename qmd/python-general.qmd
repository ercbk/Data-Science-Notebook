...
-   [**classes**]{style="color: #14adff"} - code template for creating objects, we can think of it as a blueprint. It describes the possible states and behaviors that every object of a certain type could have.
-   [**object**]{style="color: #14adff"} - data structure storing information about the state and behavior of a certain entity and is an instance of a class
-   [**stub file**]{style="color: #14adff"} - a file containing a skeleton of the public interface of that Python module, including classes, variables, functions -- and most importantly, their types. ([Source](https://mypy.readthedocs.io/en/stable/getting_started.html#stubs-intro))
...
## Data Types {#sec-py-gen-dattyp .unnumbered}
...
-   [Sets]{.underline}
    -   If performing set logic, always more performant to use sets instead of dicts or lists\
        ![](./_resources/Python,_General.resources/1-2v8giMDPDPLsrPIAlFEFmg.png){width="370"}
...
-   Create project\
    ![](./_resources/Python,_General.resources/1-KLxvDRTkiYVy4VeovWJqSg.png){width="300"}
...
-   [{{]{style="color: goldenrod"}[pip-compile-multi](https://pip-compile-multi.readthedocs.io/en/latest/){style="color: goldenrod"}[}}]{style="color: goldenrod"}
    ...
    -   [Example]{.ribbon-highlight}: DAG (directionality of the arrows is opposite compared to library docs)\
        ![](./_resources/Python,_General.resources/image.8.png){width="386"}
...
-   Misc
    -   Benchmarking a function
        ...
        -   Using a decorator\
            ![](./_resources/Python,_General.resources/image.3.png){width="434"}
...
-   Misc
    ...
    -   \*\* Args are not reset to default values after each call \*\*
        ...
        -   [Example]{.ribbon-highlight}:\
            ![](./_resources/Python,_General.resources/image.1.png){width="335"}
    ...
    -   "None" + conditional must be used to get the arg to reset back to the default value\
        ![](./_resources/Python,_General.resources/image.2.png){width="217"}
...
-   Populated objects within functions persist *if* you instantiate the object in the argument\
    ![](./_resources/Python,_General.resources/FCDnQ_wWQAEI-qf%20(2).jpg){width="262"}
...
-   Usage\
    ![](./_resources/Python,_General.resources/image.10.png){width="299"}
...
-   Reusable generator\
    ![](./_resources/Python,_General.resources/FGoz2zDWYAQywgq.jpeg){width="237"}
...
![](./_resources/Python,_General.resources/image.11.png){width="428"}
...
-   [Iterate over a sliding window]{.underline}\
    ![](./_resources/Python,_General.resources/FFhFvD6XwAIaslG.png){width="542"}
...
-   Misc
-   Terms
    -   [**Exception Errors**]{style="color: #14adff"} - Raised when the syntax is correct but the program results in an error.
    -   [**Syntax Errors**]{style="color: #14adff"} - Occur when the interpreter detects invalid syntax (relatively easier to fix)
        -   e.g. unmatched parenthesis
    -   [**Traceback**]{style="color: #14adff"} - A report that helps us understand the reason for an exception.
