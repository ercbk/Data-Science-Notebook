...
-   **Scope**
    -   Populated objects within functions persist *if* you instantiate the object in the argument![](./_resources/Python,_General.resources/FCDnQ_wWQAEI-qf%20(2).jpg)
...
-   Shows the other advantage of using "yield from": it automatically includes the code to stop prime and stop the loop.
    ...
    Reusable generator ![](./_resources/Python,_General.resources/FGoz2zDWYAQywgq.jpeg)
