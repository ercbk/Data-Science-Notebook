...
-   [Currently supported](https://duckplyr.tidyverse.org/articles/limits.html) base functions, dplyr verbs, operations, etc.
...
-   [Geospatial]{.underline}
    -   Create a table with spatial data filtered by a bounding box ([source](https://pmassicotte.github.io/r-spatial-cookbook/filtering.html#filtering-spatial-data-with-duckdb))
