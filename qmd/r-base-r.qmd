...
## Reading and Writing {#sec-r-baser-raw .unnumbered}

-   Downloading and reading .rda (or other types) via URL
    ...
    -   `mget` accepts a character vector of object names. So, if the .rda file contains multiple objects, option 4 will load them all in a list.
