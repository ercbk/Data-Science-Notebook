...
-   [Example 5]{.ribbon-highlight}: From points of 100m cells to 10km cells
    ...
    -   Redistributes the population from the source polygons (100m cells) to the target polygons (10km cells) based on the proportion of overlap
    ...
    -   This method produces what's effectively a 100% accuracy although it's much more computationally intensive
    ...
    # derive bounding box from sf_pop_poly
