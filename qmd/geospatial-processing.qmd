...
-   Read data that have been filter via SQL query ([source](https://pmassicotte.github.io/r-spatial-cookbook/filtering.html#refining-the-filter-with-a-user-defined-sql-query))
