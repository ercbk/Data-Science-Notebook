...
-   WGS 84
    ...
    -   Google "epsg code" + "your region name" to find a reasonable projection code to use
        ...
        -   Standard projection is [4326]{.arg-text} aka [WGS84]{.arg-text} (required by leaflet)
...
-   United States:
    ...
    -   [EPSG:26901]{.arg-text} to [EPSG:26923]{.arg-text} for NAD83 UTM zones are very common
    -   Each state also has its own State Plane coordinate system

-   Europe:

    -   ETRS89-LAEA ([EPSG:3035]{.arg-text}) is commonly used for pan-European analysis
    -   Individual countries often have their own systems
        -   e.g. British National Grid [EPSG:27700]{.arg-text}
...
-   [Distances]{.underline}
    ...
    -   [Spherical Distances]{.underline} (latitude, longitude, km)
        -   Measured along a small circle parallel to the equator (constant latitude). This is simpler to calculate than Great Circle distance, but less accurate, especially at high latitudes.
