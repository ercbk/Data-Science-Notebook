...
-   [Example]{.ribbon-highlight}: Aggregate extensive variable into quadrants ([source](https://www.redhat.com/en/ansible-collaborative))\
...
-   [Example]{.ribbon-highlight}: Large data may crash R when doing aggregations
