...
-   Misc
    ...
    -   If your computation takes in the 30 sec to a few minutes range, then use duckdb and its spatial extensions (See [Databases, DuckDB \>\> Geospatial](db-duckdb.qmd#sec-db-duckdb-geo){style="color: green"})
