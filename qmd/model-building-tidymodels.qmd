...
## Recipe {#sec-modbld-tidymod-recipe .unnumbered}

### Misc

-   [Docs](https://recipes.tidymodels.org/), [Function Reference](https://recipes.tidymodels.org/reference/index.html#step-functions-dummy-variables-and-encodings)
...
-   splines
    ...
    -   both have deg_free args where larger values --\> more complex curves
...
-   [`step_discretize_cart`](https://embed.tidymodels.org/reference/step_discretize_cart.html), [`step_discretize_xgb`](https://embed.tidymodels.org/reference/step_discretize_xgb.html), [`step_pca_sparse`](https://embed.tidymodels.org/reference/step_pca_sparse.html), [`step_pca_sparse_bayes`](https://embed.tidymodels.org/reference/step_pca_sparse_bayes.html), [`step_pca_truncated`](https://embed.tidymodels.org/reference/step_pca_truncated.html)
