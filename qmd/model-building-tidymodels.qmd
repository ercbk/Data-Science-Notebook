...
-   Utilizing a sparse matrix ([article](https://www.tidymodels.org/learn/work/sparse-recipe/), [article](https://www.tidymodels.org/learn/work/sparse-matrix/))
    ...
    -   In many cases *you don’t need to change anything*, the steps will know when to produce sparse data or not.
    ...
    -   [Example]{.ribbon-highlight}: Manually
