...
-   Misc
    ...
    -    If after training the model, you'd like to add additional metrics, you can used `compute_metrics`. Need [save_pred = TRUE]{.arg-text} in the `control_grid` object.
        -   e.g. `compute_metrics(xgb_res, metric_set(huber_loss, mape))` adds huber loss and mape to the `tune_grid` object
