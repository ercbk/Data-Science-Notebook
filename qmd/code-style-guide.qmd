...
- Tools
  - [Air](https://posit-dev.github.io/air/) - A R formatter and language server, written in Rust.
  - [Jarl](https://github.com/etiennebacher/jarl) - A fast linter for R: it does static code analysis to search for programming errors, bugs, and suspicious patterns of code.
  - [ry](https://github.com/sims1253/ry) - A fast static checker for the R language, written in Rust and inspired by astral-sh/ty.
    - It parses R source with tree-sitter-r, infers types across your whole project, and reports likely bugs before you run the code:
      - Calling a non-function
      - Arithmetic on incompatible types
      - Misspelled data frame columns
      - Unbound variables
...
- Resources
  ...
  - Video: [Why you shouldn't nest your code](https://www.youtube.com/watch?v=CFRhGnuXG-4)
