...
-   Components
    ...
    -   **Analysis Function**: Accepts a single dataset and additional parameters from the grid, runs a method on this dataset, and yields one or more outputs of interest.
