...
-   [Example]{.ribbon-highlight}: Forecast Manufactured Total Output for December
...
-   [Example]{.ribbon-highlight}: What's the probability of producing a certain amound of items or more?
    -   Create an ecdf using the simulated distribution counts
    -   Manual Process\
        ![](_resources/Stochastic_Processes.resources/mc-ex1-ecdf-1.png){.lightbox width="265"}
