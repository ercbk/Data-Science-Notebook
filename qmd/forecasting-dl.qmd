...
-   Create a matrix with lags and leads
    -   [Example]{.ribbon-highlight}: Univariate\
        ![](./_resources/Forecasting,_DL.resources/image.png){width="528"}
    ...
    -   [Example]{.ribbon-highlight}: Global\
        ![](./_resources/Forecasting,_DL.resources/image.1.png){width="428"}
...
-   [Example]{.ribbon-highlight}\
    ![](./_resources/Forecasting,_DL.resources/1-ENY_yH2HIWsjVQY9D6jXxA.png){width="370"}
...
-   Robustness and Model Size\
    ![](./_resources/Forecasting,_DL.resources/Screenshot%20(801).png){width="477"}
