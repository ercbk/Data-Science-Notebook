...
-   Packages
    ...
    -   [{]{style="color: #990000"}[LocalCop](https://cran.r-project.org/web/packages/LocalCop/index.html){style="color: #990000"}[}]{style="color: #990000"} ([Intro](https://arxiv.org/abs/2403.18245)): Local Likelihood Inference for Conditional Copula Models
...
-   ![](./_resources/Correlation,_Association,_and_Distance.resources/copula_marginal_dist_demo-1-1030x814.png){.lightbox width="632"}
    ...
    -   Mathematically the *cumulative conditional probabilities* shown in the scatter plot are given by taking partial derivatives of the joint inverse CDF:\
        ![](./_resources/Correlation,_Association,_and_Distance.resources/ql_f33a4928dfb8981a6bb9503e7bad03eb_l3.png){.lightbox width="332"}
...
-   Types
    ...
    -   Archimedean
        -   Parametric and uniquely determined by generator functions, φ, that use a parameter, θ
            ...
            -   Generators:\
                ![](./_resources/Correlation,_Association,_and_Distance.resources/ql_b60450bac891bd09aefaeb365a3de92a_l3.png){.lightbox width="532"}
...
-   [Example]{.ribbon-highlight}: Gaussian Copula derived from beta and gamma vectors (i.e. "marginals") ([article](https://towardsdatascience.com/copulas-an-essential-guide-applications-in-time-series-forecasting-f5c93dcd6e99))![](./_resources/Correlation,_Association,_and_Distance.resources/image.11.png){.lightbox width="460"}
