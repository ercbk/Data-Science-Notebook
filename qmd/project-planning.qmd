...
-   A clearly defined business problem and targeted success metrics that's agreed upon by data scientists and stakeholders are essential before starting a project.
    ...
    -   Reported model metrics should include "explainable" metrics (i.e. model agnostic metrics) and not just accuracy, f1 score, etc.
        -   For ML, DL, see [Diagnostics, Model Agnostic](diagnostics-model-agnostic.qmd#sec-diag-modagn){style="color: green"}
        -   Steps
...
## Smaller Projects {#sec-proj-plan-smol .unnumbered}

-   Notes from [Pipeline Design and Implementation for Small-Scale Data Pipelines](https://pipeline2insights.substack.com/p/pipeline-design-and-implementation)
...
-   [Design Principles]{.underline}\
    ![](_resources/Project,_Planning.resources/smol-design-1.webp){.lightbox width="432"}
...
-   [Choose the right tools]{.underline}
...
-   [Implementation Approach]{.underline}
    -   What decision or action will this pipeline support?
        ...
        -   [Example]{.ribbon-highlight}: A stakeholder wants a cleaned dataset or a weekly report
            -   Who’s using it?
            -   How often?
    ...
    -   Start with a quick ETL
        ...
        -   Example:
            ...
            -   The load step might be `to_sql()` or a file export. However, always isolated so I can rerun transformations without re-downloading the source.
    ...
    -   Parameterize
        ...
        -   For CLIs, possibly add a simple `--dry-run` flag or `--start-date` input.
    -   Document
        -   Remove unused code
        -   Add a short README or comment block explaining inputs and outputs
        -   Leave clear TODOs or assumptions
-   [Monitor for Refactoring Signs]{.underline}
...
1.  Gather Information
    -   Also see [Logistics, Demand Planning \>\> Stakeholder Questions](https://ercbk.github.io/Domain-Knowledge-Notebook/qmd/logistics-demand-planning.html#sec-log-demfcast-stakho){style="color: green"}
...
3.  Figure Out What You Need and the Cost
...
5.  Calculate How Much Data You Need to Collect
6.  Make sure you've answered these questions
...
-   Also see
    -   [Algorithms, Product \>\> Cost-Benefit Analysis](algorithms-product.qmd#sec-alg-prod-cba){style="color: green"}
    -   [Optimization \>\> Budget Allocation](optimization-equation-systems.qmd#sec-opt-ba){style="color: green"}
    -   [Budget Allocation](https://ercbk.github.io/Domain-Knowledge-Notebook/qmd/budget-allocation.html){style="color: green"}
...
-   Packages
    -   [{]{style="color: #990000"}[bidux](https://jrwinget.github.io/bidux/){style="color: #990000"}[}]{style="color: #990000"} - Helps Shiny developers implement the Behavior Insight Design (BID) framework in their workflow. BID is a 5-stage process that incorporates psychological principles into UI/UX design:
...
-   Feedback from users are important, but feedback from fellow developers are also crucial and may even highlight important improvements that are not apparent to the main users. A fresh perspective, an eye that has not seen the dashboard and does not know how it works, can reveal if the dashboard is really effective.
    -   Also see
        -   [User Tests - Build Better Shiny Apps with Effective User Testing](https://www.appsilon.com/post/user-tests-build-better-shiny-apps-with-effective-user-testing)
        -   [Actions Speak Louder: Building Dashboard Features Users Actually Want](https://www.appsilon.com/post/user-driven-dashboards?utm_campaign=9337902-Shiny%20dashboards&utm_medium=email&_hsenc=p2ANqtz-8ePZWTnEoJ1dA5a4A10NyiOg_7y8JI0dKpVkVJPfNJQpeGJf5bgLDYg_zcwQU7nk83l8sR-9sCuzegwddqWA4xoCQWPw&_hsmi=355531771&utm_content=355531771&utm_source=hs_automation) which shows how to use [{logger}]{style="color: #990000"} to create a log of user actions
