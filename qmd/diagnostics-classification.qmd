...
-   **McNemar's Test**
    ...
    -   Use this matrix format\
        ![](./_resources/Diagnostics,_Classification.resources/Untitled.png){width="200"}
...
-   [Misc]{.underline}
    -   Also see
        - [Scores](diagnostics-classification.qmd#sec-diag-class-scores){style="color: green"} \>\> No-information Rate for a baseline
        - [Scores](diagnostics-classification.qmd#sec-diag-class-scores){style="color: green"} \>\> Brier-Score \>\> Polytomous Outcomes
