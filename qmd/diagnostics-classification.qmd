...
-   Curves
    ...
    -   Threshold Analysis
    -   Decision Curves
    -   Determine the Probability Threshold Using Expected Utility
-   Calibration
...
-   Precision-Recall (PR)![](./_resources/Diagnostics,_Classification.resources/Precision-Recall-Plot-for-a-No-Skill-Classifier-an.png)
...
-   Determine the Probability Threshold Using Expected Utility ([article](https://towardsdatascience.com/what-data-scientists-can-learn-from-economists-a08b40c13fee))![](./_resources/Diagnostics,_Classification.resources/1-M3NrQUJ5yVeHscFeZ_LCuA.jpeg)
...
-   Misc
    ...
    -   packages
        ...
        -   [{]{style="color: #990000"}[probably](https://probably.tidymodels.org/){style="color: #990000"}[}]{style="color: #990000"}
            -   Calibration Curve: ![](./_resources/Diagnostics,_Classification.resources/image.7.png)
