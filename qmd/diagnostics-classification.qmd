# Classification  {#sec-diag-class}

## Misc  {#sec-diag-class-misc}

-   Also see [Diagnostics, Regression](Diagnostics,%20Regression) \>\> Residuals
...
-   **McNemar's Test**
    ...
    -   Use this matrix format![](./_resources/Diagnostics,_Classification.resources/Untitled.png)
...
-   **Custom Cost Functions**
    ...
    -   Examples
        ...
        -   See notebook
        -   [Visualizing Machine Learning Thresholds to Make Better Business Decisions](https://blog.insightdatascience.com/visualizing-machine-learning-thresholds-to-make-better-business-decisions-4ab07f823415)![](./_resources/Diagnostics,_Classification.resources/1-vSxUtKZDg6PcRKWFU4bpSw.png)
...
-   **Brier Score**
    ...
    -   Binary outcomes![](./_resources/Diagnostics,_Classification.resources/image.2.png)
        -   f is the predicted probability
        -   o is the observed outcome
        -   Range is from 0 to 1
        -   mean of brier loss
    -   Multi-category outcomes![](./_resources/Diagnostics,_Classification.resources/image.3.png)
        -   R is the number of categories
        -   \*\*Range is from 0 to 2
    -   Brier Skill Score (BSS)![](./_resources/Diagnostics,_Classification.resources/image.4.png)
...
-   **F scores** - each score weights FP and FN differently. A trade-off between Precision and Recall
    ...
    -   F_beta![](./_resources/Diagnostics,_Classification.resources/1-cHOhrncdnWK0vA2baH0AWA.jpeg)
    ...
    -   F1![](./_resources/Diagnostics,_Classification.resources/1-fiygHJpGZliNTL03VI5r7A.jpeg)
        -   harmonic mean of precision and recall
        -   recall and precision are of the same importance
    -   F2 and F3![](./_resources/Diagnostics,_Classification.resources/1-2nb4adBfeUljDZUWRPZIrQ.jpeg)![](./_resources/Diagnostics,_Classification.resources/1-gqh29G5M-pjUAG0fxxt7Pw.jpeg)![](./_resources/Diagnostics,_Classification.resources/1-cr78VUptSIOqdriYU1EBMQ.jpeg)
        -   F2: 80/20
...
-   **Lift Score**: compares model predictions to randomly generated predictions![](./_resources/Diagnostics,_Classification.resources/Screenshot%20(998).png)
...
-   **Mean Log Loss (aka Cross-Entropy)**\[\](./\_resources/Diagnostics,\_Classification.resources/0-aFJ20tvcPK3Gbrc0.gif\]\]
    ...
    -   Also see [Loss Functions](Loss%20Functions) for issues with this metric
...
## Class Imbalance Metrics  {#sec-diag-class-imbmet}
...
## Multinomial  {#sec-diag-class-multinom}
...
-   Misc
    ...
    -   `sklearn::classification_report` calculates the maps and waps for precision, recall, and f1-score
        ...
        -   See [Model building, sklearn](Model%20building,%20sklearn) \>\> Misc \>\> Score Model for code
    -   **Mean Log Loss** in [{yardstick}]{style="color: #990000"}
-   Confusion Matrix![](./_resources/Diagnostics,_Classification.resources/image.png)
...
-   [Precision-Recall (PR)]{.underline}![](./_resources/Diagnostics,_Classification.resources/Precision-Recall-Plot-for-a-No-Skill-Classifier-an.png)

    -   When the observations with true positive labels are rare, then PR curves are preferred (See Class Imbalance)

-   [Threshold Analysis]{.underline}

    -   [{]{style="color: #990000"}[runway](https://github.com/ml4lhs/runway){style="color: #990000"}[}]{style="color: #990000"}![](./_resources/Diagnostics,_Classification.resources/image.1.png)

-   [Decision Curves]{.underline}

    -   See also [Decison Intelligence](Decison%20Theory)
...
-   [Determine the Probability Threshold Using Expected Utility]{.underline} ([article](https://towardsdatascience.com/what-data-scientists-can-learn-from-economists-a08b40c13fee))![](./_resources/Diagnostics,_Classification.resources/1-M3NrQUJ5yVeHscFeZ_LCuA.jpeg)
    ...
    -   See also [Decison Intelligence](Decison%20Theory)
    -   Algebraically equivalent expected utility equation![](./_resources/Diagnostics,_Classification.resources/1-RWVlT9BZHuxQ9QrFWT9law.jpeg)
        -   c is the expected utility
        -   Linear equation in the form, c = yb + xa where slope, s = -a/b
        -   Slope![](./_resources/Diagnostics,_Classification.resources/1-bzFWzwMCO6iBFrq_zYetvA.jpeg)
...
## Calibration  {#sec-diag-class-calib}
...
-   Misc
    ...
    -   packages
        ...
        -   [{]{style="color: #990000"}[probably](https://probably.tidymodels.org/){style="color: #990000"}[}]{style="color: #990000"}
            -   Calibration Curve: ![](./_resources/Diagnostics,_Classification.resources/image.7.png){width="304"}
...
-   Tests for Miscalibration
    ...
    -   Spiegelhalter z statistic![](./_resources/Diagnostics,_Classification.resources/Screenshot%20(1101).png)
...
-   Integrated Calibration Index (ICI, Eavg) ([paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6771733/))
    ...
    -   Manually ([paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7075534/), [github](https://github.com/easonfg/cali_tutorial/blob/master/ici.R))
...
-   Interpretation
    ...
    -   Example 1![](./_resources/Diagnostics,_Classification.resources/1-862Gd5xzAt2fvp6o2hwuRg.png)
    ...
    -   Example 2 ([paper](https://bmcmedicine.biomedcentral.com/articles/10.1186/s12916-019-1466-7))![](./_resources/Diagnostics,_Classification.resources/image.6.png)
