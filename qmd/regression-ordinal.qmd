...
-   Harrell summary and comparison of a PO model vs Logistic in the case of an ordinal outcome\
    ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(763).png)
...
-   Types
    ...
    -   proportional hazards model - CLM with a log-log link, for grouped survival times\
        ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(1130).png)
...
-   Link functions\
    ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(1139).png)
...
-   Model\
    ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(1136).png)
...
-   Response variable follows the Multinomial distribution\
    ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(1132).png)
...
-   Cumulative Logits (Logit Link)\
    ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(1129).png)
