...
-   Harrell summary and comparison of a PO model vs Logistic in the case of an ordinal outcome\
    ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(763).png){width="632"}
...
-   3.) Plot `plot(s, which=1:3, pch=1:3, xlab='logit', main=' ', xlim=range(s[,3:4]))`\
    ![](./_resources/Regression,_Ordinal.resources/image.1.png)
...
-   Interpretation
    -   "If p1960(x) is proportion of the population with an income larger than \$x in 1960 and p1970(x) is the equivalent in 1970, then approximately"\
        ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(1164).png)
...
-   Model\
    ![](./_resources/Regression,_Ordinal.resources/Screenshot%20(1142).png)
...
-   Interpretation:
    ...
    -   Plot Predictions\
        ![](./_resources/Regression,_Ordinal.resources/image.2.png)
