...
-   Formula
    ...
    -   Same formula can be used for both within and between designs
...
-   Code
    ...
    cles <- function(data, variable, group, baseline) {
      ...
      # Variances will be weighted by each group's proportion of the sample size in case the study is not balanced.
      ...
      # Weighted standard deviation of difference
