...
-   Notebook
    ...
    -   Workflow
        -   Add Data
            -   Right Panel, Top $\rightarrow$ {{< fa paperclip >}} Attachments
-   Framework - Static Site Generator (SSG) for data apps (e.g. dashboards)
    ...
    -   Traditional BI app architecture (Dynamic Websites)\
        ![](_resources/JS.resources/obs-frame-trad-app-arch-1.png){.lightbox width="382"}
    ...
    -   SSG approach
        ...
        ::: {layout-ncol="2"}
        ![](_resources/JS.resources/obs-frame-ssg-1.png){.lightbox width="332"}

        ![](_resources/JS.resources/obs-frame-ssg-2.png){.lightbox width="332"}
        :::
