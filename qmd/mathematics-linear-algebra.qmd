...
-   Packages
    -   [{]{style="color: #990000"}[anvil](https://github.com/r-xla/anvil/){style="color: #990000"}[}]{style="color: #990000"} - Composable code transformation framework for R, allowing you to run numerical programs at the speed of light.
        -   It currently implements JIT compilation for very fast execution and backward-mode automatic differentiation. Programs can run on various hardware backends, including CPU and GPU.
...
-   Resources
    ...
    -   [Unmixing Using NMF. Part 3: Assessing Accuracy of End Members](https://dblog.vitumbre.tech/dart/unmixing-using-nmf-part-3-assessing-accuracy-of-end-members/)
