...
-   Also see [Business Plots](business-plots.qmd#sec-bizplots){style="color: green"}
-   Packages
    -   [{]{style="color: #990000"}[fpa](https://usrbinr.codeberg.page/fpa/){style="color: #990000"}[}]{style="color: #990000"} - A Business Intelligence Toolkit for Financial Planning & Analysis (FP&A)
        -   ABC classification: Categorizes items, customers, or any group members according to their relative contribution to a total metric.
            -   Example: Order stores according to sales, highest to lowest. Starting from the store with the highest sales, find the stores that contribute 40% to overall corporation sales. Label them category A. Same process for 70% of overall corporation sales and label them B, etc. I think the stores can be in multiple groups (e.g. A, B, etc.)
        -   Time intelligence analysis such as Year-over-Year(`yoy`), Month-to-Date(`mtd`), Current Year-to-Date over Previous Year-to-Date (`ytdopy`) analysis, and more.
        -   Cohort Analysis which provides insights into retention rates, lifetime value (LTV), feature usage, and behavioral trends
    -   [{]{style="color: #990000"}[ti](https://cran.r-project.org/web/packages/ti/index.html){style="color: #990000"}[}]{style="color: #990000"} - Time Intelligence and Customer Segmentation for Financial Analysis
        ...
        -   Includes customer segmentation (ABC analysis, cohorts)
...
-   Misc
    ...
    -   Papers
        -   [We Have It Covered: A Resampling-based Method for Uplift Model Comparison](https://arxiv.org/abs/2509.04315)
    -   Potential Features
...
### Misc {#sec-alg-mark-clv-misc .unnumbered}
...
-   Packages:
    -   [{]{style="color: #990000"}[CLVTools](https://github.com/bachmannpatrick/CLVTools){style="color: #990000"}[}]{style="color: #990000"} - Provides an efficient and easy to use implementation framework for probabilistic customer attrition models in non-contractual settings
    -   [{]{style="color: #990000"}[BTYD](https://cran.r-project.org/web/packages/BTYD/index.html){style="color: #990000"}[}]{style="color: #990000"} - Implementing Buy Till You Die Models with the Log Sum Exponential Patch
        -   Functions for data preparation, parameter estimation, scoring, and plotting for the BG/BB, BG/NBD, Pareto/NBD, and Gamma/Gamma models
    -   [{]{style="color: #990000"}[BTYDplus](https://github.com/mplatzer/BTYDplus){style="color: #990000"}[}]{style="color: #990000"} - Complements [{BTYD}]{style="color: #990000"} by providing several additional buy-till-you-die models, that have been published in the marketing literature, but whose implementation are complex and non-trivial. These models are: NBD, MBG/NBD, BG/CNBD-k, MBG/CNBD-k, Pareto/NBD (HB), Pareto/NBD (Abe) and Pareto/GGG.
    -   [{]{style="color: goldenrod"}[btyd](https://github.com/ColtAllen/btyd){style="color: goldenrod"}[}]{style="color: goldenrod"} - Buy Till You Die and Customer Lifetime Value statistical models
    -   [{]{style="color: goldenrod"}[pymc_marketing](https://www.pymc-marketing.io/en/stable/index.html){style="color: goldenrod"}[}]{style="color: goldenrod"} - Bayesian Marketing Mix Models and Customer Lifetime Value (CLV) models
...
### Description {#sec-alg-mark-clv-desc .unnumbered}
...
### Non-Contractual (Continuous) {#sec-alg-mark-clv-cont .unnumbered}
...
### Ccontractual (Discrete) {#sec-alg-mark-clv-disc .unnumbered}
