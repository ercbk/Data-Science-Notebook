...
-   Limitations of a simple rules based approach (typical baseline model)![](./_resources/Algorithms,_Marketing.resources/1-qLX-4LMYX70IpLMml7AOMg.png)
...
-   Example: Using Google Analytics data
    ...
    -   Data
        -   Used GA360 so the raw data is nested at the session-level
            -   See [Google, Analytics](Google,%20Analytics) \>\> Misc \>\> Google Analytics data in BigQuery for more details on this type of data
        -   After processing you want 1 row per customer
        -   GA keeps data for 3 months by default
    -   Create features![](./_resources/Algorithms,_Marketing.resources/1-shiin_SbsaPP8btmh8E3Mg.png)
...
-   Also see
    -   [Marketing](Marketing) \>\> Customer Segmentation, Customer Journey
...
-   Models
    ...
    -   ![](./_resources/Algorithms,_Marketing.resources/unknown_filename.png){width="350"}  add probabilities from a multi-class model where the classes of your target variable are:
    ...
    -   **BG/NBD Gamma-Gamma** model
        ...
        -   BG/NBD
            ...
            -   Frequency-Recency Heatmap\
                ![](./_resources/Algorithms,_Marketing.resources/image.png){width="302"}
            ...
            -   Churn Heatmap\
                ![](./_resources/Algorithms,_Marketing.resources/image.1.png){width="296"}
...
-   contractual and discrete
    -   customers are cohorted based on how many consecutive years they've been active customers. An active customer is a customer with a current contract/subscription.
        -   Cohort 1 has customers who have their initial contract + 3 contract renewals.
            -   ![](./_resources/Algorithms,_Marketing.resources/e295f2a57ea5b86e8ea07b80659ef91a.png){width="354"}
...
-   Survival Model
    ...
    -   Example: Given a customer has contacted support, predict the probability of unsubscribing over time. ([article](https://towardsdatascience.com/survival-analysis-predict-time-to-event-with-machine-learning-part-i-ba52f9ab9a46))
        ...
        -   Cox proportional hazards
            ...
            -   Coefficients![](./_resources/Algorithms,_Marketing.resources/image.5.png){width="456"}
        -   ML methods
