...
-   Cloud-based data integration service that makes it easy to move data between data stores.
    ...
    -   Cost Charged by Data Processing Unit (DPU) multiplied by usage hours ([Pricing](https://aws.amazon.com/glue/pricing/))
        -   Job types:
...
-   Process\
    ![](./_resources/Production,_Tools.resources/promarchitecture.png){.lightbox}
