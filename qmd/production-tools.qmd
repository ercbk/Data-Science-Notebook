...
-   Overview of some 2021 tools Descriptions in [article](https://continual.ai/post/the-modern-data-stack-ecosystem-fall-2021-edition?utm_source=Data_Elixir&utm_medium=social) ![](./_resources/Production,_Tools.resources/617add909a1e134d1f9e14b9_Modern-20Data-20Stack-20F.png){width="632"}
-   **AWS Batch** - managed service for computational jobs. Alternative to having to maintain a kubernetes cluster![](./_resources/Production,_Tools.resources/image.png){width="632"}
...
-   Deployments ([docs](https://docs.prefect.io/concepts/deployments/))![](./_resources/Production,_Tools.resources/image.1.png){width="432"}
