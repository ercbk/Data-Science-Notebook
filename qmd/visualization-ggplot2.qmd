...
-   `theme_notebook`
    ...
    theme_notebook <- function(...) {
      theme_minimal() %+replace%
        theme(
          plot.title = element_text(family = "anybody_cond_bold", 
                                    size = 16),
          plot.subtitle = element_text(family = "anybody_cond_reg", 
                                       size = 14),
          axis.title = element_text(family = "anybody_reg", 
                                    size = 12),
          axis.text = element_text(family = "anybody_reg", 
                                   size = 10),
