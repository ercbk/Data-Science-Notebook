...
- Packages
  ...
  - [{]{style="color: goldenrod"}[polarsgrid](https://github.com/vankesteren/polarsgrid){style="color: goldenrod"}[}]{style="color: goldenrod"} - [{tidyr::expand_grid}]{style="color: #990000"} for polars
...
- [Example 1]{.ribbon-highlight}: Column type transformation
  ...
  - [mixed_columns]{.var-text} is a list of columns that have mixed types (e.g. numeric, character, etc.) and `cast` transforms them to string columns.

- [Example 2]{.ribbon-highlight}: Ratio variables
...
- [Example 3]{.ribbon-highlight}: Case-When
...
- [Example 4]{.ribbon-highlight}: String Extraction
...
- [Example 5]{.ribbon-highlight}: Basic `map_batches` ([source](https://www.emilyriederer.com/post/py-rgo-udf/#map-batches))
...
- [Example 6]{.ribbon-highlight}: `map_batches` multiple input columns ([source](https://www.emilyriederer.com/post/py-rgo-udf/#map-batches))
...
- [Example 7]{.ribbon-highlight}: `map_batches` w/array output ([source](https://www.emilyriederer.com/post/py-rgo-udf/#map-batches))
