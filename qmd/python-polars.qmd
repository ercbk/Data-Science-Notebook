...
-   [Example]{.ribbon-highlight}: Split Dataframe and Loop
    ...
    #> ('a',)  : shape: (4, 6)
    #> ┌───────┬───────┬─────────┬─────────┬─────────┬─────────┐
    #> │ group ┆ truth ┆ mod_bad ┆ mod_bst ┆ mod_rnd ┆ mod_mix │
    #> │ ---   ┆ ---   ┆ ---     ┆ ---     ┆ ---     ┆ ---     │
    #> │ str   ┆ i64   ┆ f64     ┆ f64     ┆ f64     ┆ f64     │
    #> ╞═══════╪═══════╪═════════╪═════════╪═════════╪═════════╡
    #> │ a     ┆ 1     ┆ 0.25    ┆ 0.99    ┆ 0.5     ┆ 0.99    │
    #> │ a     ┆ 1     ┆ 0.25    ┆ 0.75    ┆ 0.5     ┆ 0.75    │
    #> │ a     ┆ 0     ┆ 0.75    ┆ 0.25    ┆ 0.5     ┆ 0.25    │
    #> │ a     ┆ 0     ┆ 0.75    ┆ 0.01    ┆ 0.5     ┆ 0.01    │
    #> └───────┴───────┴─────────┴─────────┴─────────┴─────────┘
    #> ('b',)  : shape: (4, 6)
    #> ┌───────┬───────┬─────────┬─────────┬─────────┬─────────┐
    #> │ group ┆ truth ┆ mod_bad ┆ mod_bst ┆ mod_rnd ┆ mod_mix │
    ...
    #> │ str   ┆ i64   ┆ f64     ┆ f64     ┆ f64     ┆ f64     │
    #> ╞═══════╪═══════╪═════════╪═════════╪═════════╪═════════╡
    #> │ b     ┆ 1     ┆ 0.25    ┆ 0.99    ┆ 0.5     ┆ 0.5     │
    #> │ b     ┆ 1     ┆ 0.25    ┆ 0.75    ┆ 0.5     ┆ 0.5     │
    #> │ b     ┆ 0     ┆ 0.75    ┆ 0.25    ┆ 0.5     ┆ 0.5     │
    #> │ b     ┆ 0     ┆ 0.75    ┆ 0.01    ┆ 0.5     ┆ 0.6     │
    #> └───────┴───────┴─────────┴─────────┴─────────┴─────────┘
