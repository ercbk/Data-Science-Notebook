...
## RCT Features {#sec-exp-rct-feats}
...
## Assignment Options {#sec-exp-rct-assopts}
...
-   Treatment Strategy
    ...
    -   **Crossover Group** - subjects are randomly allocated to study arms where each arm consists of a sequence of two or more treatments given consecutively.
        ...
        -   Misc
            ...
            -   Also see
                -   Senn SJ. Cross-over trials in clinical research. Chichester: John Wiley; 1993, 2002.
...
## Sources of Bias {#sec-exp-rct-sbias}
