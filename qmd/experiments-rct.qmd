...
-   Futility Interim Analysis
    ...
    -   Frequentist: Both point estimates and confidence intervals need corrections, and the sampling distribution can even be bimodal. ([Harrell](https://bsky.app/profile/f2harrell.bsky.social/post/3mbwkj3mhd22e))
        -   Anytime-valid confidence intervals might be an option ([Thread](https://bsky.app/profile/judithterschure.bsky.social/post/3mbvuabbjbs22))
    -   Bayesian: If the analysis at the planned study end is valid, all interim Bayesian analyses must be equally valid regardless of the stopping rule, and they require no modification, no consideration of sampling distributions. ([Harrell](https://bsky.app/profile/f2harrell.bsky.social/post/3mbwkj3rgis2e))
...
-   [Rerandomization]{.underline}
    ...
    -   Packages
        ...
        -   [{]{style="color: #990000"}[randotools](https://ctu-bern.github.io/randotools/){style="color: #990000"}[}]{style="color: #990000"} - Functions for creating randomization lists, and other related tasks, in R.
...
-   [Sequential Multiple Assignment Randomised Trial (SMART)\
    ]{.underline}![](_resources/Experiments,_RCT.resources/assign-misc-smart-1.jpg){.lightbox width="432"}
    -   Notes from [Thread](https://bsky.app/profile/marionkcampbell.bsky.social/post/3m3m7gc4eds2q)
    -   Papers
        -   [Sequential, Multiple Assignment, Randomized Trial Designs](https://jamanetwork.com/journals/jama/article-abstract/2800681) (\$) - Primer
        -   [Sequential multiple assignment randomized trial studies should report all key components: a systematic review](https://www.sciencedirect.com/science/article/abs/pii/S0895435621003590) (\$) - Review
    -   [{]{style="color: #990000"}[smartDesign](https://cran.r-project.org/web/packages/smartDesign/index.html){style="color: #990000"}[}]{style="color: #990000"}
...
-   [Misc]{.underline}
    ...
    -   Packages
        -   [{]{style="color: #990000"}[eclipseplot](https://cran.r-project.org/web/packages/eclipseplot/index.html){style="color: #990000"}[}]{style="color: #990000"} ([Paper](https://www.bmj.com/content/388/bmj-2024-081199)) - Graphical Visualizations for ROBUST-RCT Risk of Bias Assessments
