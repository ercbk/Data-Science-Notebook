...
-   [MAD Test]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: [{spatstat}]{style="color: #990000"} book, p. 259
        ...
        -   [rmax = 2]{.arg-text} says test the range, $0 \le r \le 2 \; \text{meters}$. Argument from `Kest` which `Lest` is a transformation of.
...
-   [Simulation Envelopes]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: [{spatstat}]{style="color: #990000"} book, p. 235
        ...
        -   Using the L-Function stablilizes the variance and produces a more powerful test.
