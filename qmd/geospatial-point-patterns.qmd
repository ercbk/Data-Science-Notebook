...
-   [K-Function]{.underline}
    ...
    -   Edge [correction]{.arg-text} methods should be applied
        ...
        -   ["isotropic"]{.arg-text}/["Ripley"]{.arg-text}: Implemented for rectangular and polygonal windows (not for binary masks).
        -   ["translate"]{.arg-text}/["translation"]{.arg-text}: The study region is treated as a torus (donut shape), and points near the boundary are "wrapped around" to the opposite side. Implemented for all window geometries, but slow for complex windows.
        -   ["rigid"]{.arg-text}: Averages over all possible rigid motions of the study region, ensuring that edge effects are accounted for. Implemented for all window geometries, but slow for complex windows.
