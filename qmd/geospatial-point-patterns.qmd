...
-   [Pair Correlation ($g$)]{.underline}
    ...
    -   [{spatstat.explore::pcf.fv}]{style="color: #990000"}
        ...
        -   [method =]{.arg-text} - Method "c" (default) has the best all-around performance. Methods "b" to "d" offer improved performance at small distances $r$.
            ...
            -   ["a"]{.arg-text} applies the smooth to $K(r)$, estimates its derivative, an plug into equation
        ...
        -   [Example]{.ribbon-highlight}:
            ...
            ::: {layout-nrow="2"}
            ![Shapley](_resources/Geospatial-Point-Patterns.resources/spdep-corr-pair-shapley-1.png){.lightbox width="432"}

            ![Pair Correlation](_resources/Geospatial-Point-Patterns.resources/spdep-corr-pair-kest-1.png){.lightbox width="432"}
            :::
            ...
            -   $g$ stays \>1 for the entire range of $r$ which suggests clusttering
