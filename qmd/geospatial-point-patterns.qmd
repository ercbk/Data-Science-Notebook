...
-   Packages
    -   [{]{style="color: #990000"}[BalancedSampling](https://cran.r-project.org/web/packages/BalancedSampling/){style="color: #990000"}[}]{style="color: #990000"} - Select **balanced and spatially balanced probability samples** in multi-dimensional spaces with any prescribed inclusion probabilities.
    -   [{]{style="color: #990000"}[groupedHyperframe](https://cran.r-project.org/web/packages/groupedHyperframe/index.html){style="color: #990000"}[}]{style="color: #990000"} - **Grouped Hyper Data Frame**: An Extension of Hyper Data Frame Object
        -   Aggregation of function-value-table hyper column(s) and numeric hyper column(s) over a nested grouping structure
        -   [{]{style="color: #990000"}[groupedHyperframe.random](https://cran.r-project.org/web/packages/groupedHyperframe.random/index.html){style="color: #990000"}[}]{style="color: #990000"} - **Simulated** Grouped Hyper Data Frame
        -   [{]{style="color: #990000"}[hyper.gam](https://cran.r-project.org/web/packages/hyper.gam/index.html){style="color: #990000"}[}]{style="color: #990000"} - **Generalized Additive Models** with Hyper Column
    -   [{]{style="color: #990000"}[kanova](https://cran.r-project.org/web/packages/kanova/index.html){style="color: #990000"}[}]{style="color: #990000"} - One-way and two-way **analysis of variance** for replicated point patterns, grouped by one or two classification factors, on the basis of the corresponding K-functions.
    -   [{]{style="color: #990000"}[rsamplr](https://cran.r-project.org/web/packages/rsamplr/index.html){style="color: #990000"}[}]{style="color: #990000"} - Sampling Algorithms and **Spatially Balanced Sampling**
    ...
    -   [{]{style="color: #990000"}[SepTest](https://cran.r-project.org/web/packages/SepTest/index.html){style="color: #990000"}[}]{style="color: #990000"} - Provides statistical tools for **testing first-order separability in spatio-temporal** point processes, that is, assessing whether the spatio-temporal intensity function can be expressed as the product of spatial and temporal components
    -   [{]{style="color: #990000"}[spcosa](https://git.wur.nl/Walvo001/spcosa){style="color: #990000"}[}]{style="color: #990000"} - Implements algorithms for **spatial coverage sampling** and **random sampling** from **compact** geographical **strata**.
...
-   How the sampling method affects the variance of your mean estimate ([source](https://dosull.github.io/posts/2025-11-14-gia-chapter-2A-spatial-autocorrelation/))\
    ![](_resources/Geospatial-Point-Patterns.resources/autocorr-affects-variance-1.png){.lightbox width="632"}
...
-   [**Observation Window**]{style="color: #009499"} - The area for which the point dataset is exhaustive, or complete.
