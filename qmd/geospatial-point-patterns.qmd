...
-   Modeling
    -   Analyzing data using a summary statistic or summary function is ultimately unsatisfactory.
        ...
        -   If the test rejects the Null, then the question is whether the summary statistic may have been ‘fooled’ by some other aspect of the data, such as the non-uniform density
            of points.
    -   Diagnostics
