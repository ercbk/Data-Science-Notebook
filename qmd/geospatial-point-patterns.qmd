...
-   [Misc]{.underline}
    ...
    -   Edge Effects
        -   For all these methods, the **appropriate window selection is crucial**.
...
-   [Simulation Envelopes]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: [{spatstat.explore::envelope}]{style="color: #990000"}\
        ...
        -   Given how uncentered this envelop is on the theoretical value, it would probably be a good idea to do more than 99 simulations.
