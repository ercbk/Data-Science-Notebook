...
-   [**Homogeneity**]{style="color: #009499"} - In a general sense, this means the points have no preference for any spatial location (e.g. constant intensity)
...
-   [**Stationary**]{style="color: #009499"} - Intensity is constant (homogeneous)
...
-   [Dot Functions]{.underline}
    ...
    -   Example of Guidelines (e.g. `Gdot`)
        -   $\hat G_{i \boldsymbol\cdot} \gt G_{i \boldsymbol\cdot}$ says that category $i$ events are *closer* to the other category event types than expected from a random process, i.e. *Clustered*
        -   $\hat G_{i \boldsymbol\cdot} \approx G_{i \boldsymbol\cdot}$ says that category $i$ events are spatially independent of other category event types
        -   $\hat G_{i \boldsymbol\cdot} \lt G_{i \boldsymbol\cdot}$ says that category $i$ events are *further* from other category event types than expected from a random process, i.e. *regularity (dispersion)*
