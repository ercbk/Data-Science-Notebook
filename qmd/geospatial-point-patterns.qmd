...
-   [**Intensity**]{style="color: #009499"} - The *expected* number of events per unit area — conventionally denoted by $\lambda$. In most cases the process is not know, so its intensity cannot be directly measured.
    -   [Example]{.ribbon-highlight}: Average Intensity
    ...
    -   [Example]{.ribbon-highlight}: Per Quadrat
    ...
    -   [Example]{.ribbon-highlight}: Relative Intensity
    ...
    -   Weighted Intensity
        ...
        -   Example: [{spatstat}]{style="color: #990000"} book, p. 174
...
-   [**Inhomogeneous**]{style="color: #009499"} - The average density of points is spatially varying (i.e. density is a function of location)
    -   On p. 689 in the [{spatstat}]{style="color: #990000"} book, a permutation test procedure is performed to test whether a point pattern is correlation-stationary (inhomogeneous) or locally scaled. Testing for whether the pattern is homogeneous or locally scaled and inhomogeneous, etc. could also have been done
-   [**Interaction**]{style="color: #009499"} - Stochastic dependence between points
