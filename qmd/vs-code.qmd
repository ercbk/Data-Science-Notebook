...
* **ALT/Option + Shift + Right**: hit this twice to select everything within a current bracket(this option is called _smartSelect.grow_ , if it needs to be re-mapped)
