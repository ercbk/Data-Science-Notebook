...
-   Packages
    -   [{]{style="color: #990000"}[rangecondprob](https://cran.r-project.org/web/packages/rangecondprob/index.html){style="color: #990000"}[}]{style="color: #990000"} - Calculate of conditional probabilities for various numeric ranges
        -   e.g. P(exam_lang_score ≥ 80 \| age and height and weight and income
-   Scoring predictions
