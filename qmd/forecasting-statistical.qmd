    ...
    -   Autocorrelation tests
        ...
        -   [Breusch-Godfrey]{.underline} test designed for pure regression or straight AR model
            ...
            -   `forecast::checkresiduals` can calculate it and display it, but you don't have access to the values programmatically
                -   Defaults for [lag]{.arg-text} is $\min(10,n/5)$ for nonseasonal and $\min(2m, n/5)$ for seasonal where the frequency is seasonality, m
...
![](./_resources/Forecasting,_Statistical.resources/gauss_4.jpg){width="332"} ![](./_resources/Forecasting,_Statistical.resources/Screenshot%20(610).png){width="332"}
...
-   Notes
    ...
    -   The equations do this by finding the intersection, which is itself a distribution, of the transformed prediction distribution, $μ_0$, and the measurement distribution, $μ_1$.\
        ![](./_resources/Forecasting,_Statistical.resources/image.1.png){width="332"}
...
![](./_resources/Forecasting,_Statistical.resources/kalflow.png){width="309"}
...
-   $R$ is the measurement noise variance
    -   Controls how quickly the model adapts to changes in the hidden state.\
        ![](./_resources/Forecasting,_Statistical.resources/1-eeu7WescwgB5JPkzFU4Riw.png){width="432"}
