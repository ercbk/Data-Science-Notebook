...
-   [dlnm](https://cran.r-project.org/web/packages/dlnm/index.html) - Collection of functions for distributed lag linear and non-linear models. Includes penalized models
