...
-   [{]{style="color: #990000"}[ardlverse](https://cran.r-project.org/web/packages/ardlverse/index.html){style="color: #990000"}[}]{style="color: #990000"} - Comprehensive Autoregressive Distributed Lag **ARDL** Modeling Framework: Panel, Bootstrap, Quantile-Nonlinear, and Fourier Extensions
-   [{]{style="color: #990000"}[bdlnm](https://cran.r-project.org/web/packages/bdlnm/index.html){style="color: #990000"}[}]{style="color: #990000"} - A **Bayesian** framework for estimating **distributed lag** linear and non-linear models.
...
-   [{]{style="color: #990000"}[BTWAR](https://cran.r-project.org/web/packages/BTWAR/index.html){style="color: #990000"}[}]{style="color: #990000"} - Implements the Butterworth-Induced Autoregressive model, where autoregressive coefficients are obtained from analog Butterworth filter prototypes mapped into the discrete-time domain using the Matched Z-Transform
-   [{]{style="color: #990000"}[dlnm](https://cran.r-project.org/web/packages/dlnm/index.html){style="color: #990000"}[}]{style="color: #990000"} - Collection of functions for **distributed lag** linear and non-linear models. Includes penalized models
-   [{]{style="color: #990000"}[fasster](https://cran.r-project.org/web/packages/fasster/index.html){style="color: #990000"}[}]{style="color: #990000"} - Fast Additive Switching of Seasonality, Trend, and Exogenous Regressors
    -   Combines state space methodology with a switching component in the observation equation to allow flexible modeling of **complex seasonal patterns**, including time-varying effects and **multiple seasonalities**.
-   [{]{style="color: #990000"}[fqardl](https://cran.r-project.org/web/packages/fqardl/index.html){style="color: #990000"}[}]{style="color: #990000"} - **Fourier ARDL** Methods: Quantile, Nonlinear, Multi-Threshold & Unit Root Tests
...
-   [{]{style="color: #990000"}[GACE](https://cran.r-project.org/web/packages/GACE/index.html){style="color: #990000"}[}]{style="color: #990000"} - Provides deterministic forecasting for weekly, monthly, quarterly, and yearly time series using the Generalized Adaptive Capped Estimator.
    -   Looks like a fairly simple model that might be good for a base model
...
-   [{]{style="color: #990000"}[qardlr](https://cran.r-project.org/web/packages/qardlr/index.html){style="color: #990000"}[}]{style="color: #990000"}: Quantile Autoregressive Distributed Lag Model
-   [{]{style="color: #990000"}[smooth](https://cran.r-project.org/web/packages/smooth/index.html){style="color: #990000"}[}]{style="color: #990000"} ([book](https://openforecast.org/adam/)) - Functions implementing Single Source of Error **state space models** for purposes of time series analysis and forecasting.
    -   ADAM (Augmented Dynamic Adaptive Model) is the primary model but also implements Exponential Smoothing, SARIMA, Complex Exponential Smoothing, and Simple Moving Average
    -   Allows dealing with intermittent demand based on the iETS framework
-   [{]{style="color: #990000"}[THETASVM](https://cran.r-project.org/web/packages/THETASVM/index.html){style="color: #990000"}[}]{style="color: #990000"} - Combines the distinct strengths of the THETA model and the Support Vector Machine (SVM) model for time series forecasting.
...
-   [{]{style="color: #990000"}[xtpqardl](https://cran.r-project.org/web/packages/xtpqardl/index.html){style="color: #990000"}[}]{style="color: #990000"} - **Panel Quantile** Autoregressive **Distributed Lag** Model
    -   Estimation of Panel Quantile Autoregressive Distributed Lag (PQARDL) models that combine panel ARDL methodology with quantile regression.
    -   Supports Pooled Mean Group (PMG), Mean Group (MG), and Dynamic Fixed Effects (DFE) estimators across multiple quantiles
-   [{]{style="color: #990000"}[xtcspqardl](https://cran.r-project.org/web/packages/xtcspqardl/index.html){style="color: #990000"}[}]{style="color: #990000"} - Cross-Sectionally Augmented **Panel Quantile ARDL**
...
-   [**Nowcasting**]{style="color: #009499"} - The process of estimating the current state of a phenomenon when the data are incomplete due to reporting delays.
    -   See [Economics \>\> Misc](https://ercbk.github.io/Domain-Knowledge-Notebook/qmd/economics.html#sec-econ-misc){style="color: green"} for packages
...
-   Detrend or Difference
    ...
    -   Testing
        ...
        -   [{]{style="color: #990000"}[boundedur](https://cran.r-project.org/web/packages/boundedur/index.html){style="color: #990000"}[}]{style="color: #990000"} - Unit Root Tests for Bounded Time Series
        -   [{]{style="color: #990000"}[qadf](https://cran.r-project.org/web/packages/qadf/index.html){style="color: #990000"}[}]{style="color: #990000"} - Quantile Autoregressive Distributed Lag Unit Root Test
        -   [unitrootests](https://cran.r-project.org/web/packages/unitrootests/index.html) - Comprehensive Unit Root and Stationarity Tests
            -   Quantile ADF tests ([Paper](https://doi.org/10.1198%2F016214504000001114))
            -   GARCH-based unit root tests with endogenous structural breaks ([Paper](https://doi.org/10.1016%2Fj.eneco.2014.11.021))
            -   Comprehensive Dickey-Fuller, Phillips-Perron, KPSS, ERS/DF-GLS, Zivot-Andrews, and Kobayashi-McAleer tests with an Elder-Kennedy decision strategy ([Paper](https://doi.org/10.1080%2F00220480109595179))
    -   Steps:
        1.  ADF:
...
-   Packages
    ...
    -   [{]{style="color: goldenrod"}[cuthbert](https://state-space-models.github.io/cuthbert/){style="color: goldenrod"}[}]{style="color: goldenrod"} - A JAX library for state-space model inference (filtering, smoothing, static parameter estimation).
