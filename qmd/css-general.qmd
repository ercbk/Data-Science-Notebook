...
-   Resources
    ...
    -   [Learn CSS](https://web.dev/learn/css) - Series of tutorials for various elements (more basic and comprehensive)
    -   [Modern CSS](https://moderncss.dev/) - Series of more advanced tutorials
    -   [Defensive CSS](https://defensivecss.dev/tips/) - Series of more advanced tutorials
