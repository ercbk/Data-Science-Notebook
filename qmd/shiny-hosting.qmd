...
- Packages
  - [{]{style="color: #990000"}[shinyelectron](https://r-pkg.thecoatlessprofessor.com/shinyelectron/){style="color: #990000"}[}]{style="color: #990000"} - Creates a stand-alone, desktop electron app for shiny apps (R or Python; windows, macos, linux)
    - Five different packaging options depending on your use case (e.g. public distribution, webr/pyodide, containerized for complex system deps, etc.)
...
- Resources
  - [Affordable Shiny app hosting for 500 concurrent users](https://www.r-bloggers.com/2025/08/affordable-shiny-app-hosting-for-500-concurrent-users/)
...
## Benchmarks {#sec-shiny-hosting-bench .unnumbered}
...
## Free {#sec-shiny-hosting-free .unnumbered}
...
## Brands {#sec-shiny-hosting-brands .unnumbered}

- [Digital Ocean](https://www.digitalocean.com/)
  - Digital Ocean Droplet - \$4/month and host the apps with shinyproxy or shinyserver
    - For light, intermittent usage
  - [Lightbulb](https://lightbulb.is/) provisions, configures and secures your DigitalOcean server so you can publish Shiny and Golem apps from GitHub - without writing deployment scripts or touching the command line.
- [Huggingface](https://huggingface.co/docs/hub/spaces-sdks-docker-shiny)
- [Kamatera](https://www.kamatera.com/pricing/)
  - \(2025\) The most basic simple configuration is \$4/mo but there are other tiers plus the option of customization
  - "Their support is good regarding SSH and other remote access methods. With Kamatere you will need to set up the server yourself, including installing R, Shiny Server, and any other dependencies your app requires." ([article](https://pacha.dev/blog/2025/11/14/shiny-deployment/))
...
- Posit Connect
  ...
  - Much better than ShinyProxy for scaling up even though ShinyProxy is free ([article](https://www.r-bloggers.com/2023/01/shinyproxy-vs-posit-connect-benchmark-test-for-scaling-shiny-apps/))
  - Benefits
