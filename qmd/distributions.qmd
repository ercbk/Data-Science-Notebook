...
-   [Density Ratio Estimation]{.underline}
    ...
    -   Measures and tests the dissimularity between two sets of data. Handles numeric and categorical data.
    ...
    -   The predicted density ratio value can be regarded as an importance weight. Releasing the predicted density ratio values for each synthetic observation allows data users to reweigh analyses on the synthetic data.
