...
::: {layout-ncol="2"}
![Where k is the number of events in n trials](_resources/Distributions.resources/Beta-binomial_distribution_pmf.webp){width="432"}

![Where $\theta$ is the probability of an event](_resources/Distributions.resources/beta-binom-theta-1.png){width="512"}
:::
...
-   [Example]{.ribbon-highlight}: Gamma distribution as the sums of random exponential variables\
    ![](_resources/Distributions.resources/gamma-sum-of-exp-1.png){width="432"}
