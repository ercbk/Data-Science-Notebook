...
-   Unsupervised Machine Learning problem![](./_resources/NLP,_Topic.resources/image.6.png){width="632"}
    ...
    -   Topics don't come with titles like are shown in figure. Researchers need to determine these topic categories on their own
        -   Example: 2020 Election Tweets![](./_resources/NLP,_Topic.resources/Screenshot%20(1074).png){width="532"}![](./_resources/NLP,_Topic.resources/Screenshot%20(1075).png){width="532"}
            -   Each row is a topic
...
-   Latent Semantic Analysis (LSA) (Deerwester¹ et al. 1990), probabilistic Latent Semantic Analysis (pLSA) (Hofmann², 1999), Latent Dirichlet Allocation (LDA) (Blei³ et al., 2003) and Non-Negative Matrix Factorization (Lee³ et al., 1999)
    ...
    -   Document-Term Matrix (DTM) aka Term-Document Matrix (TDM) created![](./_resources/NLP,_Topic.resources/image.png){width="532"}
...
-   [Process]{.underline}
    -   Truncated SVD applied to the Document-Term Matrix (DTM) (See above) ![](./_resources/NLP,_Topic.resources/image.1.png){width="532"}
...
-   [Model (Plate Notation)]{.underline}\
    ![](./_resources/NLP,_Topic.resources/image.4.png){width="274"}
...
-   [BERTopic]{.underline}
    ...
    -   Currently has a broader coverage of embedding models (Oct 2022)\
        ![](./_resources/NLP,_Topic.resources/Screenshot%20(1050).png){width="432"}
-   [Top2Vec]{.underline}
...
-   Generate more coherent, interpretable topics than traditional topic models when using text from noisy domains like social media
    ...
    -   [Example]{.ribbon-highlight}: Domain = Covid-19 pandemic\
        ![](./_resources/NLP,_Topic.resources/image.7.png){width="432"}
