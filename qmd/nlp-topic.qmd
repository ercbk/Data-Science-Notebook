...
-   Packages
    ...
    -   [{]{style="color: #990000"}[mlstm](https://cran.r-project.org/web/packages/mlstm/index.html){style="color: #990000"}[}]{style="color: #990000"} - Fits latent Dirichlet allocation (LDA), supervised topic models, and multilevel supervised topic models for text data with multiple outcome variables. Core estimation routines are implemented in C++ using the 'Rcpp' ecosystem.
