...
-   Unsupervised Machine Learning problem![](./_resources/NLP,_Topic.resources/image.6.png){.lightbox width="632"}
    ...
    -   Topics don't come with titles like are shown in figure. Researchers need to determine these topic categories on their own
        -   Example: 2020 Election Tweets![](./_resources/NLP,_Topic.resources/Screenshot%20(1074).png){.lightbox width="532"}![](./_resources/NLP,_Topic.resources/Screenshot%20(1075).png){.lightbox width="532"}
            -   Each row is a topic
...
-   Latent Semantic Analysis (LSA) (Deerwester¹ et al. 1990), probabilistic Latent Semantic Analysis (pLSA) (Hofmann², 1999), Latent Dirichlet Allocation (LDA) (Blei³ et al., 2003) and Non-Negative Matrix Factorization (Lee³ et al., 1999)
    ...
    -   Document-Term Matrix (DTM) aka Term-Document Matrix (TDM) created![](./_resources/NLP,_Topic.resources/image.png){.lightbox width="532"}
...
-   [Process]{.underline}
    -   Truncated SVD applied to the Document-Term Matrix (DTM) (See above) ![](./_resources/NLP,_Topic.resources/image.1.png){.lightbox width="532"}
