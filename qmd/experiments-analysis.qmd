...
-   Analysis of substudies must be separate
    -   Example of **Study Effects**: 2 Studies with the same treatment (Lumiracoxib) but different controls (ibuprofen, naproxen) ([article](https://www.linkedin.com/pulse/studying-effects-studies-stephen-senn))![](./_resources/Experiments,_Analysis.resources/1640543316808.png){.lightbox width="632"}
        -   Cells are p-values
...
-   Comparison\
    ![](./_resources/Experiments,_Design.resources/Screenshot%20(1048).png){.lightbox width="500"}
