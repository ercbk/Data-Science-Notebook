...
## Preprocessing {#sec-fcast-ml-preproc}
...
-   Difference until stationary
    ...
    -   Forecasts will need to be back-transformed![](./_resources/Forecasting,_ML.resources/image.png)
        ...
        -   Then recursively for the next forecasts in the horizon\
            ![](./_resources/Forecasting,_ML.resources/image.1.png)
-   Log transform
...
## Multi-Step Forecasting {#sec-fcast-ml-mstep}
...
-   Misc
    ...
    -   Notes from: [6 Methods for Multi-step Forecasting](https://towardsdatascience.com/6-methods-for-multi-step-forecasting-823cbde4127a)
        -   Example dataset\
            ![](./_resources/Forecasting,_ML.resources/Screenshot%20(1091).png){width="532"}
            -   t-3 through t-0 are the predictors
            -   t+1 through t+4 are potential outcome variables

-   [Recursive]{.underline} (aka [Iterative]{.underline}) - Training a single model for one-step ahead forecasting. Then, the model's one-step ahead forecast is used as data to get the 2nd-step ahead forecast.
...
-   [Example]{.ribbon-highlight}: Preprocessing training data for 1 then 2 steps ahead and forecasting ([post](https://github.com/WinVector/Examples/blob/main/TS/TS_example.md),  Code \>\> Time Series \>\> direct-multistep-forecasting-regression.R)
    ...
    -   1-Step Ahead Training Data
        -   Before Preprocessing\
            ![](./_resources/Forecasting,_ML.resources/1aheadorig.1.png){width="532"}
        ...
        -   After Preprocessing\
            ![](./_resources/Forecasting,_ML.resources/1ahead.png){width="532"}
            -   The model is fit using this data
    -   2-Step Ahead Training Data
        -   Before Preprocessing\
            ![](./_resources/Forecasting,_ML.resources/2aheadorig.1.png){width="532"}
        ...
        -   After Preprocessing\
            ![](./_resources/Forecasting,_ML.resources/2ahead.1.png){width="532"}
            -   The model is fit using this data
    -   Forecast\
        ![](./_resources/Forecasting,_ML.resources/pred.png){width="432"}
...
## Feature Engineering {#sec-fcast-ml-feateng}
