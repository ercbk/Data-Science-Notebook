...
-   Misc
    ...
    -   Resources
        ...
        -   [Statistical Learning With Sparsity](https://hastie.su.domains/StatLearnSparsity/) (Hastie, Tibshirani, Wainright)
...
-   [Example]{.ribbon-highlight}: [{correlation}]{style="color: #990000"}
    ...
    -   Visualization\
        ![](_resources/Association-General.resources/misc-partial-network-1.png){width="432"}
...
-   [Graphical LASSO]{.underline}
    ...
    -   The terms in the inverse covariance matrix (ICT) are *not equivalent* but are *proportional* to the partial correlation between the two corresponding variables
        ...
        -   Setting the terms on the diagonal to zero prevents variables from having connections with themselves in a network graph if you want to visualize the relationships
            ...
            -   Nodes are variables and edges are the partial correlations.
    ...
    -   [Example]{.ribbon-highlight}: Stock Analysis using [{glasso}]{style="color: #990000"} ([link](https://robotwealth.com/the-graphical-lasso-and-its-financial-applications/))
        ...
        -   Post has an interesting analysis of the non-connected variables
