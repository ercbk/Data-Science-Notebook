...
-   For the correleation between two variables where the data is repeated measures, see the 2-Stage approach in [Econometrics, Mixed Models \>\> Model Equation](econometrics-mixed-effects-frequentist.qmd#sec-econ-me-freq-modeq){style="color: green"}
