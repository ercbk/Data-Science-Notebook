...
-   [dcor]{.underline}
    ...
    -   [Misc]{.underline}
        ...
        -   Packages
            -   [{]{style="color: #990000"}[dcortools](https://cran.r-project.org/web/packages/dcortools/index.html){style="color: #990000"}[}]{style="color: #990000"} (Used by Paper) - Tons of options; Can use {RFast} for calculations
                -   `distcor(X, Y)` - dCorV, Biased Distance Correlation
                -   `distcor(X, Y, bias.corr = T)` - dCorU, Unbiased Distance Correlation
            -   [{]{style="color: #990000"}[energy](https://mariarizzo.github.io/energy/){style="color: #990000"}[}]{style="color: #990000"}
