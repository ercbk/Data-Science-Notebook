# Multilevel, Longitudinal {#sec-multlong .unnumbered}

## Misc {#sec-multlong-misc .unnumbered}

-   Also see [Econometrics, Mixed Effects >> Considerations >> Variable Assignment](econometrics-mixed-effects-frequentist.qmd#sec-econ-me-freq-consid){style="color: green"}
...
## Multilevel {#sec-multlong-mult .unnumbered}
...
### Univariate {#sec-multlong-mult-uni .unnumbered}
...
-   Level 1 and Level 2
    ...
    -   Continuous
        ...
        -   [Example]{.ribbon-highlight}:\
            ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.png){width="432"}
...
### Bivariate {#sec-multlong-mult-bi .unnumbered}
...
-   Boxplots (Categorical)\
    ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.2.png){width="532"}
    ...
    -   Mean outcome (per subject) vs covariate\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.6.png){width="532"}
        -   \* Removes dependency
        -   Interpretation: looks like some decent variation between categories
-   Scatter (Continuous)\
    ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.3.png){width="432"}
    ...
    -   Mean outcome (per subject) vs covariate\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.7.png){width="532"}
        -   \* Removes dependency
        -   Interpretation: PEM not showing much of an correlation if any
-   Facetting previous plots by subject\
    ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.5.png){width="532"}\
    ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.4.png){width="532"}
    -   Left
...
### Trivariate {#sec-multlong-mult-tri .unnumbered}

-   Scatter, color by random variable\
    ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.1.png)
...
## Longitudinal {#sec-multlong-long .unnumbered}

-   [Misc]{.underline}
    -   Repeated measures that have a sequential or time component
    -   packages: [{brolgar}]{style="color: #990000"}

### Univariate {#sec-multlong-long-uni .unnumbered}

-   Continuous Outcome vs. Time
    -   Facetted by Observational Unit (e.g. school)\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.10.png){width="532"}\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.8.png){width="532"}
        -   Linear Fit and Line Chart
    -   Spaghetti\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.9.png){width="532"}

### Bivariate {#sec-multlong-long-bi .unnumbered}
...
-   Continuous Outcome vs Time
    ...
    -   Facetted by Categorical\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.11.png){width="532"}
    -   Facetted by Binned Continuous\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.12.png){width="532"}

-   Time Endpoints\
    ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/Screenshot%20(a1).png){width="432"}
...
### Linear parameters {#sec-multlong-long-linpar .unnumbered}
...
-   [Univariate]{.underline}
    ...
    -   Parameter Distributions\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.13.png){width="432"}
    -   Correlation\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.14.png){width="432"}
...
-   [Bivariate]{.underline}
    -   Process
        ...
        -   Aggregate results
    -   Parameter Distributions\
        ![](./_resources/EDA,_Multilevel,_Longitudinal.resources/image.15.png){width="432"}
