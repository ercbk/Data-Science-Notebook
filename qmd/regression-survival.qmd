...
-   Packages
    ...
    -   [{]{style="color: #990000"}[pammtools](https://adibender.github.io/pammtools/){style="color: #990000"}[}]{style="color: #990000"} - Piece-wise exponential Additive Mixed Models (PAMMs) for time-to-event data. (i.e. GAMs for survival modeling)
