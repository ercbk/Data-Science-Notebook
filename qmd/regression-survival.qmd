...
-   Packages
    ...
    -   [{]{style="color: #990000"}[survival](https://cran.r-project.org/web/packages/survival/index.html){style="color: #990000"}[}]{style="color: #990000"}
...
-   Misc
    ...
    -   Packages
        ...
        -   [{]{style="color: #990000"}[survAUC](https://cran.r-project.org/web/packages/survAUC/index.html){style="color: #990000"}[}]{style="color: #990000"} - Has other methods, but the best approach based on other papers seems to Uno's IPCW approach.
