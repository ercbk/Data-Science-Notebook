...
# Survival {#sec-reg-surv}

## Misc {#sec-reg-surv-misc}
...
-   Packages
    ...
    -   [{]{style="color: #990000"}[survAH](https://www.uno1lab.com/survAH/){style="color: #990000"}[}]{style="color: #990000"} - Performs two-sample comparisons based on average hazard with survival weight (AHSW)
-   Notes from
...
-   [**Hazard Ratio**]{style="color: #009499"} (aka [**Relative Risk**]{style="color: #009499"} of an event): Risk of an event given category / risk of an event given by reference category
    ...
    -   Coefficient of the Cox Proportional Hazards model (e.g. [paper](https://twitter.com/EricTopol/status/1612485677509382144))\
        ...
        -   HR of 2 is equivalent to raising the entire survival curve for a control subject to the second power to get the survival curve for an exposed subject
            -   [Example]{.ribbon-highlight}: if a control subject has 5y survival probability of 0.7 and the exposed:control HR is 2, the exposed subject has a 5yr survival probability of 0.49
...
## Cox's Proportional Hazards {#sec-reg-surv-coxph}
...
### Random Survival Forests {#sec-reg-surv-ml-rsf}
...
### Gradient Boosting Survival Trees {#sec-reg-surv-ml-gbst}
...
### Survival Support Vector Machine {#sec-reg-surv-ml-ssvm}
