...
-   Packages
    ...
    -   [{{]{style="color: goldenrod"}[diaquiri](https://ropensci.github.io/daiquiri/){style="color: goldenrod"}[}}]{style="color: goldenrod"}![](./_resources/EDA,_Time_Series.resources/image.1.png){width="632"}![](./_resources/EDA,_Time_Series.resources/image.png){width="632"}
...
-   [Outcome Variable Distribution]{.underline}
    ...
    -   [Example]{.ribbon-highligh}\
        ![](_resources/EDA,_Time_Series.resources/gghistogram-1.png){width="432"}
...
-   [STL Decomposition]{.underline}
    ...
    -   Example: {timetk}\
        ![](_resources/EDA,_Time_Series.resources/timetk-stl-decomp-1.jpg){width="487"}
    ...
    -   [Daily Seasonal Adjustment (DSA)]{.underline}
        ...
        -   Daily data can have multiple seasonalities present
            -   Raw Time Series\
                ![](./_resources/EDA,_Time_Series.resources/1-D074QuDWqHGSttFx6tKgjg.jpeg){width="632"}
            -   DSA Processed Time Series\
                ![](_resources/EDA,_Time_Series.resources/dsa-example-1.webp){width="632"}
...
-   [Additive or Multiplicative Structure]{.underline}
    ...
    -   Does the amplitude of the seasonal or cyclical component increase over time? ![](./_resources/EDA,_Time_Series.resources/Screenshot%20(248).png){width="432"}
...
-   [Quantile values per frequency unit (by group and total)]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: {timetk} Calendar Effects\
        ![](_resources/EDA,_Time_Series.resources/timetk-calendar-effects.jpg){width="486"}
...
-   Outliers
    ...
    -   [Example]{.ribbon-highlight}: {timetk}\
        ![](_resources/EDA,_Time_Series.resources/timetk_anomaly-1.png){width="632"}
...
-   [Statistical Features vs Outcome]{.underline}
    ...
    -   First Autocorrelation Coefficient vs Categorical vs Binary Outcome
        ...
        ![](_resources/EDA,_Time_Series.resources/autocor-vs-cat-vs-cat.png){width="632"}
...
-   [PCA the Features]{.underline}
    -   Identify characteristics for high dimensional data (From [fpp3](https://otexts.com/fpp3/exploring-australian-tourism-data.html))\
        ![](_resources/EDA,_Time_Series.resources/pca-1.png){width="432"}
    ...
    -   Visualize Outliers\
        ![](_resources/EDA,_Time_Series.resources/pcaoutliers-1.png){width="532"}
...
-   [Lag Scatter Plots]{.underline}
    -   Lag scatterplots between target series and lags of the target series (i.e. y~t~ vs y~t+h~)\
        ![](_resources/EDA,_Time_Series.resources/astsa-lag1-1.png){width="532"}
    ...
    -   Lag scatterplots between target series and lags of the predictor Series (i.e. y~t~ vs x~t+h~)\
        ![](_resources/EDA,_Time_Series.resources/astsa-lag2-1.png){width="532"}
...
-   [Partial Autocorrelation]{.underline}
    ...
    -   Example: `forecast::Pacf(plot = TRUE)` or `forecast::ggPacf`\
        ![](_resources/EDA,_Time_Series.resources/pacf-1.png){width="432"}

    -   [Example]{.ribbon-highlight}: {timetk} plots ACF and PACF charts\
        ![](_resources/EDA,_Time_Series.resources/timetk-acf-pacf-1.png){width="632"}
...
-   [ACF]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: `forecast::Acf(plot = TRUE)` or `forecast::ggAcf`
        ...
        ![](./_resources/EDA,_Time_Series.resources/acfstationary-1.png){width="632"}
