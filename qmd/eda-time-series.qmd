...
-   Packages
    ...
    -   [{]{style="color: #990000"}[lomb](https://cran.r-project.org/web/packages/lomb/index.html){style="color: #990000"}[}]{style="color: #990000"} - Computes the **Lomb-Scargle Periodogram** (aka **Least-Squares Spectral Analysis (LSSA)**) and actogram
