...
-   STL Decomposition
    ...
    -   Daily Seasonal Adjustment (DSA)
        -   Daily data can have multiple seasonalities present![](./_resources/EDA,_Time_Series.resources/1-D074QuDWqHGSttFx6tKgjg.jpeg){width="632"}
...
-   ACF
    ...
    -   [Example]{.ribbon-highlight}: `forecast::Acf(plot = TRUE)` or `forecast::ggAcf` ![](./_resources/EDA,_Time_Series.resources/acfstationary-1.png){width="632"}
