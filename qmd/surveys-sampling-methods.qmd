...
-   **Sampling Frame** - An exhaustive list of all the individuals which comprise the target population (Also see [Surveys, Design](Surveys,%20Design) \>\> Sources of Error \>\> Coverage or Frame Error)\
...
-   Domain Parameter Estimation
    ...
    -   Variance for Estimated Total\
        ![](./_resources/Surveys,_Sampling_Methods.resources/image.7.png)

        -   **S2D**\
            ![](./_resources/Surveys,_Sampling_Methods.resources/image.8.png)

        -   **CV2D**\
            ![](./_resources/Surveys,_Sampling_Methods.resources/image.9.png)

        -   Assumes the population sizes, N and ND, are "large enough."

        -   For the Alternative Estimated Total formula (see above)\
            ![](./_resources/Surveys,_Sampling_Methods.resources/image.10.png)
...
-   Horvitz-Thompson estimator (without replacement selection)
    ...
    -   Estimated Total, **Ŷ**, for the study variable\
        ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1280).png)
...
-   See "Decreasing the sampling variance of the treatment effect" section
...
-   Estimated Total, **Ŷ**, for the study variable and the Estimated Mean of the study variable, **Ȳ** (respectively)\
    ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1271).png)
...
-   Variance for Estimated Total assuming SRS within strata\
    ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1272).png)
    ...
    -   Stratum Dispersion: **S2h** should be similar to the sample dispersion for SRS below, except the domain of the variables is within stratum, h (e.g. n → nh, ȳ → ȳh, etc.)
        -   Sample Dispersion for SRS\
            ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1272).1.png)
-   Variance for Estimated Mean assuming SRS within strata V(ȲSTSRS) = (1 - f) S2w / nh
    ...
    -   Within-Stratum Dispersion: **S2w**\
        ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1273).png)
        -   S2h: See above
        -   N is the population size and Nh is the population strata size for strata, h
        -   Wh is the frequency weight where Wh = Nh / N
-   Design weights: **di**\
    ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1273).1.png)
...
-   Stratum sample size allocation methods
    ...
    -   Proportional Allocation
        ...
        -   nproph = (n\*Nh) / N = n\*Wh
        -   Variance\
            ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1274).png)
    -   Optimal or Neyman Allocation
        -   Seeks to minimize the variance under the cost constraint\
            ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1274).1.png)
        ...
        -   Strata Sample Size *with* Cost Constraint\
            ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1274).2.png)
        -   Strata Sample Size *without* Cost Constraint\
            ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1275).png)
        -   Variance\
            ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1275).1.png)
    ...
    -   Balanced Allocation\
        ![](./_resources/Surveys,_Sampling_Methods.resources/Screenshot%20(1276).png)
