...
- Packages
  ...
  - [{]{style="color: #990000"}[saferDev](https://safer-r.github.io/saferDev/){style="color: #990000"}[}]{style="color: #990000"} - Set of functions that perform checks according to the [safer-r project](https://github.com/safer-r) recommendations for R function development.
    - This includes checking argument values, ensuring correct specification of all mandatory arguments for embedded functions, as well as their explicit package namespace qualification, among other things.
