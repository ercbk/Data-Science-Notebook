...
-   Packages
    ...
    -   [{]{style="color: #990000"}[LBBNN](https://cran.r-project.org/web/packages/LBBNN/index.html){style="color: #990000"}[}]{style="color: #990000"} ([Paper](https://www.mdpi.com/2227-7390/12/6/788)) - Latent Binary Bayesian Neural Networks Using 'torch'
        -   Trains binary classification', 'multiclass classification', 'regression', or 'custom' models.
    -   [{]{style="color: #990000"}[tabpfn](https://tabpfn.tidymodels.org/){style="color: #990000"}[}]{style="color: #990000"}, [{]{style="color: goldenrod"}[tabpfn](https://github.com/PriorLabs/TabPFN){style="color: goldenrod"}[}]{style="color: goldenrod"} ([Examples and Best Practices](https://tinyurl.com/tabpfn-colab-local))- A foundation model for tabular data that outperforms traditional methods while being dramatically faster
        ...
        -   TabPFN-2.5 can handle close to 100,000 data points and around 2,000 features ([article](https://towardsdatascience.com/exploring-tabpfn-a-foundation-model-built-for-tabular-data/))
