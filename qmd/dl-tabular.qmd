...
-   DeepETA: Uber's ETA model ![](./_resources/DL,_Tabular.resources/figure6.png){width="632"}
    -   Model for residual calculation![](./_resources/DL,_Tabular.resources/figure2.png){width="632"}
        ...
        -   **Self-attention** in transformers is a sequence-to-sequence operation that takes in a sequence of vectors and produces a reweighted sequence of vectors![](./_resources/DL,_Tabular.resources/figure3.png){width="532"}
