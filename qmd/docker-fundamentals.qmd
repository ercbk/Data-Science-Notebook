...
## Networking Containers {#sec-docker-fund-nc}
...
-   Create custom network
    ...
    -   Add container to custom network
        -   Add --net \<network name\> to the run-container instruction
            -   [Example]{.ribbon-highlight}: `docker container run -it -\-rm name web2 -p 5000:5000 -e FLASK\_APP=app.py -d -\-net firstnetwork web2`
            -   [Example]{.ribbon-highlight}: `docker container run -it -\-rm name redis -p 6379:6379 -d -\-net firstnetwork redis:3.2-alpine`
