...
## Optimizing {#sec-docker-fund-opt}
...
-   He builds dependency files of the system dependency files (\*\* only for Alpine Linux \*\*)
...
## Running Scripts When a Container Starts {#sec-docker-fund-arswacs}
...
## Docker Utility Functions {#sec-docker-fund-duf}
