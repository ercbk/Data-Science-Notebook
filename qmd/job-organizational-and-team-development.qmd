# Organizational and Team Development {#sec-job-orgdev}

## Misc {#sec-job-orgdev-misc}
...
-   Buying data A common failure mode is to build a business on top of somebody else's data. If you depend on a single upstream source for your data inputs, they can simply raise prices until they capture all of the economics of your product. That's a losing proposition. So you should try to build your own primary data asset, or work with multiple upstream providers such that you're not at the mercy of any single one.
...
## Starting a Data Science Department {#sec-job-orgdev-startdsd}
...
-   Data team placement within the organization
    -   Push for centralization in the reporting structure, but keeping the work management decentralized.\
        ![](./_resources/Job,_Organizational_and_Team_Development.resources/image.2.png)
...
-   Early Projects
    ...
    -   If data is decentralized, create a data warehouse that houses all data\
        ![](./_resources/Job,_Organizational_and_Team_Development.resources/image.1.png)
    ...
    -   Work with every department team and make sure they have their own dashboard with the top set of metrics they care about.\
        ![](./_resources/Job,_Organizational_and_Team_Development.resources/image.3.png)
...
## Data Literacy {#sec-job-orgdev-datlit}
...
## Developing a Data Driven Organization {#sec-job-orgdev-daddo}
...
## Data Maturity {#sec-job-orgdev-datmat}
...
-   Components (see [Databases, Warehouses \>\> Designing a Warehouse](db-warehouses.qmd#sec-db-ware-dsgn){style="color: green"})
    -   Metamodeling:
...
## Developing a Data Strategy {#sec-job-orgdev-datstrat}
...
-   Misc
    -   Planning
        ...
        -   Workflow Example: B2C (business-to-consumer) model\
            ![](./_resources/Job,_Organizational_and_Team_Development.resources/image.png)
...
## Determining a Data Team's ROI {#sec-job-orgdev-dtroi}
...
## Developing a Data Platform {#sec-job-orgdev-devdatplat}
...
## Developing an On-Call Environment {#sec-job-orgdev-daoce}
