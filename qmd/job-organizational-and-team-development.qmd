# Job, Organizational and Team Development
...
* Considerations for transitioning to cloud infrastruction
...
* Considerations
	* Data
		...
		* Is there a more efficient storage and processing pipeline?
			* Transfer data to centralized relational db or warehouse (See [DB, Relational](DB, Relational) >> Transitioning from Spreadsheet to DB)
...
* Data team placement within the organization
	* Push for centralization in the reporting structure, but keeping the work management decentralized.![](./_resources/Job,_Organizational_and_Team_Development.resources/image.2.png)
...
* Develop Relationships
	...
	* Develop a strong relationship with IT so you get some of the technical obstacles removed _quickly_.
...
* Create developement, staging, and production environments
	* Development
		* Reproducibility
			...
			* packages, libraries
				* [{renv}]{style='color: #990000'} \- See [Renv](Renv)
				* [{{poetry}}]{style='color: goldenrod'}, {pip-compile-multi}}, etc. - [Python, General](Python, General) >> Enviroment, Dependencies
		* Develop internal packages
			...
			* Wrapper functions for connecting to separate databases (See [DB, Relational](DB, Relational) >> Misc >> Wrapper for db connections)
...
* Early Projects
	...
	* If data is decentralized, create a data warehouse that houses all data![](./_resources/Job,_Organizational_and_Team_Development.resources/image.1.png)
	...
	* Work with every department team and make sure they have their own dashboard with the top set of metrics they care about.![](./_resources/Job,_Organizational_and_Team_Development.resources/image.3.png)
	...
	* Produce something quick initially (establishes respect for your expertise)
		...
		* Find a relatively small but high-impact problem.  (see [Low Hanging Fruit](Low Hanging Fruit), [Project, Planning](Project Management))
		* Nail it and make sure that it is recognized as solving a high-priority problem.
* Create an environment/culture
	* Limit ad-hoc requests
		* e.g. creating one-time reports and pulling data
		* See [On the job](On the job) >> Requests
...
* Levels ( https://aryng.com/blog/data-literacy-personas ):
...
* Create a data literacy plan ( https://mitsloan.mit.edu/ideas-made-to-matter/how-to-build-data-literacy-your-company?utm_campaign=Data_Elixir&utm_source=Data_Elixir_323 )
	...
	* Steps:
		...
		2. Start with a baseline of employee skills
			...
			* Example survey: https://aryng.com/data-literacy-test
				...
				* shinysurvey pkg could be used to develop something suitable for a company's particular business model
		...
		6. Track progress and develop metrics
			* No real examples of metrics.
		7. Leadership must be involved
...
Developing a Data Driven Organization
![](https://i2.wp.com/doordash.engineering/wp-content/uploads/2020/09/data-hierarchy-table-14.jpg?resize=1024%2C902&ssl=1)![](https://i2.wp.com/doordash.engineering/wp-content/uploads/2020/09/collect-data-12.jpg?resize=1024%2C846&ssl=1)
...
* Stakeholders need to know what levers to pull that will affect lead indicators before being given metrics that measure those indicators (i.e. the tool or report they're asking for).
	* This is relevant to the "can you tell me what decisions you are going to make" question in the Dealing with Stakeholders section. If they know what decision they want to make (i.e. levers to pull) and that decision can reasonably generate business value, then tool you create to calculate the metric will be used and used correctly.
* The lead indicators they're asking for need to be relevant to the decision they want to make.
	* Asking to include employee weight in an employee churn model would be unreasonable.
* The stakeholder/business user needs to provide an action plan that answers 4 questions
	...
	4. What levers will they move to action on the results?
		...
		* 2 and 3 (also maybe 1) sound like questions for the data scientist and not necessarily the business user. The dude who wrote this article is a data engineer so I guess he's writing from that perspective. This list of questions is likely what should be answered by the data scientist _and_ business user before building an expensive pipeline.
* Companies launching data driven initiatives should focus on small areas of primary need first. Advance these areas to a high degree before spreading out. Smaller focused areas that produce high quality will increase confidence of stakeholders. Starting wide and producing low quality will litter the decision making landscape with false conclusions and conflicting truths. Therefore, decreasing stakeholder confidence
...
* Components (see [DB, Warehouses](DB, Warehouses) >> Designing a Warehouse)
	* Metamodeling:
...
* Dimensions to Assess Data Maturity Within an Organization
	...
	* Processes — The processes and workflows, including the documentation of data modeling methodologies, the development of data modeling templates and standards, and the establishment of quality control and review processes.
		...
		* Conceptual & Logical Models - The _process_ of creating these models should have an owner and there should be a structured process to create new logical attributes, and to then have them reviewed, approved, and published.
...
* Misc
	* Planning
		...
		* Workflow Example: B2C (business-to-consumer) model![](./_resources/Job,_Organizational_and_Team_Development.resources/image.png)
...
* Performing an organization assessment
	...
	* Main Topics: Mission and Theory of Change, Stakeholders, and Data Gap Analysis
	* Mission and Theory of Change
		...
		* Example![](./_resources/Job,_Organizational_and_Team_Development.resources/1-Ap92XjwEYV-kuAou_2nicg.png)
	* Stakeholders
...
* Data Advantage Matrix
	...
	* Matrix Format![](./_resources/Job,_Organizational_and_Team_Development.resources/1-0PEOIumIzBMwOK5gqFANjQ.png)
		* Types (Y-Axis)
	...
	* Example (SaaS software startup)![](./_resources/Job,_Organizational_and_Team_Development.resources/1-BwZR-KuOkYDhFppIF_zGKQ.png)
	* Example (Uber-like company)![](./_resources/Job,_Organizational_and_Team_Development.resources/1-nC3CFFylcrebHiebn8Roig.png)
...
* Misc
	...
	* See notebook
	* [Visualizing Machine Learning Thresholds to Make Better Business Decisions](https://blog.insightdatascience.com/visualizing-machine-learning-thresholds-to-make-better-business-decisions-4ab07f823415)![](./_resources/Job,_Organizational_and_Team_Development.resources/1-vSxUtKZDg6PcRKWFU4bpSw.png)
...
* For automating tasks, get an estimate of how much time and how many people it takes for that task to be completed during the project's planning stages.
	* using their salaries, estimate hourly wage and calculate sum(employee\_wage \* time\_spent\_on\_task)
	...
	1. Siloed data teams
		...
		* Solutions
			...
			* Track Decision Impact (DI) metrics ($), which doesn't focus on intrinsic error (e.g. RMSE, MAE, F1, etc.), but rather on the quality of the decisions made that involved your data product.
				...
				* Also see [Demand Planning](Logistics) >> Decision Impact Metrics
				* Example with forecasting![](./_resources/Job,_Organizational_and_Team_Development.resources/0-l5tNmIVCL_C-samu.png)
					...
					* The maximum value that could still be delivered by improving the actual forecast process
						* DIa-o = DIa - DIo
	2. Planning
		* _Objectives_ and _key results_ (OKR) is a goal-setting framework for defining and tracking objectives (O) and their outcomes (KR).
			* ![](./_resources/Job,_Organizational_and_Team_Development.resources/unknown_filename.png)
...
Developing a Data Platform
![](./_resources/Job,_Organizational_and_Team_Development.resources/My-Post-Copy-2-819x1024.png)
...
* Data Ingestion
	* Tools
		* Ingestion
			...
			* See [Product Development](Product Development) >> Behavioral Data
		* Orchestration
			* Apache Airflow, Prefect, and Dagster
			* See [Production, Tools](Production, Tools) >> ETL, ELT Orchestration
* Data Storage and Processing
	* [Snowflake](https://www.snowflake.com/), [Google BigQuery](https://cloud.google.com/bigquery), [Amazon Redshift](https://aws.amazon.com/redshift/?whats-new-cards.sort-by=item.additionalFields.postDateTime&whats-new-cards.sort-order=desc), [Firebolt](https://www.firebolt.io/), [Microsoft Azure](https://www.google.com/search?q=microsoft+azure&rlz=1C5CHFA_enUS905US905&oq=microsoft+azure&aqs=chrome..69i57j0i433j0j0i433j0j0i433j0l2j0i433i457j0.4251j1j4&sourceid=chrome&ie=UTF-8#:~:text=Microsoft%20Azure%3A%20Cloud,us)%3A%20389/55.49K), [Amazon S3](https://aws.amazon.com/s3/), [Databricks](https://databricks.com/), [Dremio](https://www.dremio.com/)
	* Also see [DB, Warehouses](DB, Warehouses), [DB, Engineering](DB, Engineering) >> Data Lakes
	* Resources
...
* Data Transformation and Modeling
	* Tools
		* [dbt](https://www.getdbt.com/) – Short for data build tool, is the open source leader for [transforming data](https://blog.getdbt.com/what--exactly--is-dbt--2/) once it’s loaded into your warehouse. 
			* See [Production, Tools](Production, Tools) >> ELT/ETL Operations
...
* Business Intelligence and Analytics
	* Tools
		...
		* R
* Data Observability
	* Also see [Production, ML Monitoring](Production, ML Monitoring) \>> Misc, Investigating Data Drift for metrics and methods of data validation
	* Circumstances where it would be a good time to implement this stage:
		...
		* Your team has more data _consumers_ than you did 1 year ago
	...
	* Data Reliability
		* ![](./_resources/Job,_Organizational_and_Team_Development.resources/image.4.png)
		* Also see
			...
			* [Glossary: DS terms](Glossary_ DS terms)
		* SLAs
			* It improves the communication between engineers and stakeholders by clearly defining the scope of data reliability and what “okay” and “not okay” means. Making it crystal clear avoids the needless discussion on what does and doesn’t need attention.
				* Gives engineers an _error budget_ which is a metric to prevent engineers from burning out and it helps the team allocate their time wisely
		...
		* SLOs![](./_resources/Job,_Organizational_and_Team_Development.resources/image.5.png)
		...
		* Steps
			* Create the SLA with your stakeholders
				...
				* Start low so engineers don’t need to run 24/7 rotations and stakeholders are typically ok with a few hours of downtime initially (99% = ~1.68 hours downtime per week). As the situation gets more stable, you can increase it to the ideal number. (99.99% = few minutes downtime per _month_)
				* [Example]{.ribbon-highlight}: Critical Revenue Table on BigQuery
					...
					* Correctness 99%: Amount fields like gross\_booking, net\_booking, net\_revenue should be calculated correctly.
			* Select SLIs
			...
			* Define the SLO and set up alerts
				...
				* [Example]{.ribbon-highlight}: See SLO and SLI examples![](./_resources/Job,_Organizational_and_Team_Development.resources/image.6.png)
...
* Create Table of Production Issues![](./_resources/Job,_Organizational_and_Team_Development.resources/image.7.png)
	* The more detailed the guideline, the more streamlined the on-call process will be.
* Create a Workflow![](./_resources/Job,_Organizational_and_Team_Development.resources/image.8.png)
	...
	* Main Steps
		...
		* Identify the category of alerts, the scale of the impact, and its urgency. Every on-call should be able to assess the urgency of the issue based on its category, impact, and SLA requirements. By creating “data products” with clear requirements, teams can benefit from the process that enables them to identify the impact and urgency efficiently. I recommend article — [Writing data product pipelines with Airflow](https://medium.com/miro-engineering/writing-data-product-pipelines-with-airflow-1ace222f8f5a), a nice practice to write data requirements as code in Airflow dags.
...
* On-call journal![](./_resources/Job,_Organizational_and_Team_Development.resources/image.9.png)
