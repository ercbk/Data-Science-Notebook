...
-   Workflows
    -   Select variables $\rightarrow$ Select Years $\rightarrow$ Select Data Format $\rightarrow$ Download
-   [Example]{.ribbon-highlight}: NHIS
    ...
    -   Create Extract\
        ![](_resources/Surveys,_Census_Data.resources/ipums-create-extract-1.png){.lightbox}\
        \
