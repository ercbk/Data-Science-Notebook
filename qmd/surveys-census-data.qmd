...
-   [Misc]{.underline}
    ...
    -   There's not *really* a lot to getting the data, but there are plenty of steps which can seem a little daunting if you haven't dealt with this sort of process before. Some of the tedious aspects of getting the data:
...
-   [Getting the Data via Website]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: NHIS
        ...
        -   Variables\
            ...
            -   Other methods for browsing variables by some category
        ...
        -   Read Variable Details\
            ![](_resources/Surveys,_Census_Data.resources/ipums-hs-var-det-1.png){.lightbox width="432"}
            -   Clicking on the name of the variable sends you to its details page
            -   Honestly everything here is potentially useful for your analyses.
                ...
                -   [NHIS Sources]{.arg-text}: Says which version of the survey was used to obtain the variable
                    -   e.g. SEX
                        ...
                        -   2018 - Person (core questionnaire)
        -   Select Variables\
        ...
        -   Review Variables\
            ...
            -   Note the list of preselected variables. Currently it seems like [PSU]{.var-text}, [STRATA]{.var-text}, and maybe [SERIAL]{.var-text} are the only id variables I'm interested in. A closer look at the ID variables:
                ...
                -   [NHISPID]{.var-text} - Same as NHISHID but for persons
                    -   So [not currently a useful variable]{.underline}
        ...
        -   Decide on File Format and Create Extract\
            ![](_resources/Surveys,_Census_Data.resources/ipums-dat-format-1.png){.lightbox width="432"}
        ...
        -   Download Data and the DDI file\
            ![](_resources/Surveys,_Census_Data.resources/ipums-download-1.png){.lightbox width="432"}
            -   The Data Documentation Initiative (DDI) is a standard for documenting social science datasets. It's an XML file with the meta data on the survey design and variables.
