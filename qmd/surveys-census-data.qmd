...
-   Workaround for Trump's Executive Order that halts access the Census Bureau's shapefiles (Tigris shapefiles should be back up)
...
-   [Example]{.ribbon-highlight}: [{mapgl}]{style="color: #990000"} Median Home Value by State\
    ...
    r <- dplyr::range(us_value$estimate, na.rm = TRUE)
