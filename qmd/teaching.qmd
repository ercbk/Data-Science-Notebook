...
-   Packages
    -   [{]{style="color: #990000"}[sandpaper](https://carpentries.github.io/sandpaper/){style="color: #990000"}[}]{style="color: #990000"} - Generates websites for workshop lessons - The Carpentries Lesson Infrastructure Engine
    -   [{]{style="color: #990000"}[tidyexplain](https://www.garrickadenbuie.com/project/tidyexplain/){style="color: #990000"}[}]{style="color: #990000"} - Visual animations of dplyr verbs
-   Resources
    -   [The R Workshop Book](https://www.r-workshop.org/) - A traditional approach that teaches how the programming language works and builds up to working with data.
        -   Contains materials for:
            -   “Introduction to R for Data Analysis” which is a 2 day workshop
            -   “Advanced R for Data Analysis” which is a 1 day workshop
    -   [R for Data Science](https://r4ds.hadley.nz/) - Teaches how to get your data into R, get it into the most useful structure, transform it, and visualize.
        -   Starts working with data and creating visualizations up front
    -   [Applied Data Skills](https://psyteachr.github.io/ads-v3/)
...
-   Mathematical explanations should flow from the more concrete to the more abstract ([3Blue1Brown](https://www.youtube.com/watch?v=ojjzXyQCzso&t=500s))\
    ![](_resources/Teaching.resources/blues-abstraction-1.png){.lightbox width="382"}
    -   Where categories are the most abstract and quanties are the most concrete.
    -   [Example]{.ribbon-highlight}: Adding Fractions
