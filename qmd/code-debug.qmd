...
- `set_function_params`: Helper function that assigns all argument values of a function to the global environment ([source](https://bryer.org/posts/2026-05-05-Setting_Function_Parameters_for_Debugging.html))
...
- [{]{style="color: #990000"}[boomer](https://moodymudskipper.github.io/boomer/){style="color: #990000"}[}]{style="color: #990000"} - Debugging tools that let you inspect the intermediate results of a call
