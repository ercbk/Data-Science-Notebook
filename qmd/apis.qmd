...
-   [Serialization]{.underline}
    ...
    -   Comparison
        ...
        | [Serialization/deserialization speed]{.underline} | Often **faster**, especially as file sizes increas, since it doesn’t need to convert to/from text strings. | Often **slower**, because it requires parsing or formatting text. |
