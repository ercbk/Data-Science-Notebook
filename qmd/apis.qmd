...
-   Packages
    ...
    -   [{]{style="color: goldenrod"}[tenacity](https://tenacity.readthedocs.io/en/latest/){style="color: goldenrod"}[}]{style="color: goldenrod"} - A general-purpose retrying library, written in Python, to simplify the task of adding retry behavior to just about anything (See [{requests}](apis.qmd#sec-apis-reqlib){style="color: green"} \>\> Rate Limiting \>\> Example)
