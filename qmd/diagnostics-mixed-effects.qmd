...
-   Also see
    ...
    -   [Econometrics, Mixed Effects \>\> BMLR Ch.8 \>\> Model Building Workflow \>\> Unconditional Means](econometrics-mixed-effects-frequentist.qmd#sec-econ-me-freq-bmlrch8-mbwkfw-ri){style="color: green"} for an ICC example
    -   [Econometrics, Mixed Effects \>\> Examples](econometrics-mixed-effects-frequentist.qmd#sec-econ-me-freq-examp){style="color: green"} \>\> Random Intercept-Only model for an ICC example
