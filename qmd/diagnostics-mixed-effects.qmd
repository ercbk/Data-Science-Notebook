...
-   Packages
    ...
    -   [{]{style="color: #990000"}[glmm.hp](https://cran.r-project.org/web/packages/glmm.hp/index.html){style="color: #990000"}[}]{style="color: #990000"} - Hierarchical Partitioning of Marginal R2 for Generalized Mixed-Effect Models
