...
- Packages
  - [{]{style="color: #990000"}[Inflongitudinal](https://cran.r-project.org/web/packages/Inflongitudinal/index.html){style="color: #990000"}[}]{style="color: #990000"} - Provides methods for detecting influential subjects in longitudinal data, particularly when observations are collected at irregular time points.
    - Identifies subjects whose response trajectories deviate substantially from population-level patterns, helping to diagnose anomalies and undue influence on model estimates.
...
- Papers
  - [Comparing the Accuracy of Three Predictive Information Criteria for Bayesian Linear Multilevel Model Selection](https://osf.io/preprints/psyarxiv/p2n8a_v4)
