...
* Aspect-based Sentiment Analysis (ASBA)
	...
	* Analysis
		* Polarity histogram related to aspect![](./_resources/NLP,_Sentiment.resources/1-bwlBUvy7Gs-FAmnotuhjYA.png)
			* Interpretation
		...
		* Descriptors![](./_resources/NLP,_Sentiment.resources/1-dbMcH-zAx14oLtd9AawTSA.png)
			* Interpretation
