...
-   Packages
    -   [{]{style="color: #990000"}[TextAnalysisR](https://mshin77.github.io/TextAnalysisR/){style="color: #990000"}[}]{style="color: #990000"} - Comprehensive toolkit for text mining and natural language processing with an interactive Shiny interface.
        -   Import documents from multiple formats (PDF, DOCX, XLSX, CSV, TXT) using Marker for PDF extraction
        -   Preprocess with quanteda, and perform linguistic analysis via spacyr
        -   Topic modeling (stm, BERTopic), semantic analysis, sentiment analysis, and network visualization with plotly.
        -   Features AI-assisted workflows via LangGraph and Ollama for local LLMs, WCAG 2.1 AA accessibility, multi-language support, and enterprise security for production deployment.
-   Lexicons
