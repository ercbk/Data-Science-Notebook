...
-   If you have zeros, then its common to add 1 to the predictor values
    ...
    -   \* Don't use these for outcome variables (See [Regression, Other \>\> Zero-Inflated/Truncated](regression-other.qmd#sec-reg-other-zeroinftrunc){style="color: green"} \>\> Continuous for methods, [Thread](https://twitter.com/jiafengkevinc/status/1602403378809647104) for discussion and link to a paper on the alternatives)
