      ...
      - [Example]{.ribbon-highlight}:
        ...
        cv_krige_bt <- cv_krige_log |>
          ...
          mutate(
            ...
            # global smearing
            pred_smear_global = exp(predicted) * smear_factor_global,
        ...
        #>   method                  ME   MAE  RMSE
        #>   <chr>                <dbl> <dbl> <dbl>
        #> 1 pred_smear_global   -0.449  5.58  8.22
        #> 2 pred_median          1.14   5.41  8.22
        #> 3 pred_smear_seasonal -0.459  5.58  8.23
        #> 4 pred_gaussian       -2.89   6.42  8.92
        ```
        ...
        - [pred_gaussian]{.var-text} really sucks. Normal assumption must not fail hard.
