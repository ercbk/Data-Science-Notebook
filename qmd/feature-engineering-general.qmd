...
-   If you have zeros, then its common to add 1 to the predictor values
    ...
    -   \* Reminder: Don't use these for outcome variables (See [Regression, Other \>\> Zero-Inflated/Truncated](regression-other.qmd#sec-reg-other-zeroinftrunc) \>\> Continuous, [Thread](https://twitter.com/jiafengkevinc/status/1602403378809647104))
...
-   Combos
    ...
    -   Log + scale by mean
        -   [Example]{.ribbon-highlight} SR Ch8 pg 246
