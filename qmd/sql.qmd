...
-   [Example]{.ribbon-highlight}: Add data via .csv
    ...
    -   [assignments]{.var-text} is the table; [category][assignments]{.var-text}, [name][assignments]{.var-text}, [due_date][assignments]{.var-text}, [weight][assignments]{.var-text} are fields that you want to import from the csv file
