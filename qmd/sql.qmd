...
-   `COALESCE`
    ...
    -   Make hierarchical subtotals output more readable
        ...
        ![](_resources/SQL.resources/coalesce-rollup.png){width="432"}
...
-   `CASE WHEN`
    ...
    ![](_resources/SQL.resources/binning-case-when.jpg){width="300"}
