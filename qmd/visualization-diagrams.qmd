...
-   Tools
    -   [Draw.io](https://www.drawio.com/) - Has a [desktop app](https://github.com/jgraph/drawio-desktop/releases) and a VS Code extension. Seems to be the one that Dancho uses.
