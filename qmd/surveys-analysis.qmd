...
-   [**Design Effect**]{style="color: #009499"} - A measure of the expected impact of a sampling design on the variance of an estimator for some parameter of a population. ([wiki](https://en.wikipedia.org/wiki/Design_effect))
