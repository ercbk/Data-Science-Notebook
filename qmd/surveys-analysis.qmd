...
-   Packages
    ...
    -   [bbw](https://rapidsurveys.io/bbw/) - The **blocked weighted bootstrap** is an estimation technique for use with data from two-stage cluster sampled surveys in which either prior weighting or posterior weighting is implemented
-   Resources
