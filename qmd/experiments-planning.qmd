# Planning {#sec-exp-plan}

## Misc {#sec-exp-plan-misc}
...
## Considerations {#sec-exp-plan-cons}
...
## Sample Size/Power/MDE {#sec-exp-plan-smppow}

### Approximate Sample Size {#sec-exp-plan-smppow-apxsmp}
...
### Increasing Power {#sec-exp-plan-smppow-incpwr}
...
### [{PUMP}]{style="color: #990000"} {#sec-exp-plan-smppow-pump}
...
## Post-Experiment Evaluation Checklist {#sec-exp-plan-peec}
...
## Decreasing the Sampling Variance of the Treatment Effect {#sec-exp-plan-dsvte}
...
-   Winsorize ([{]{style="color: #990000"}[DescTools::Winsorize](https://andrisignorell.github.io/DescTools/reference/Winsorize.html){style="color: #990000"}[}]{style="color: #990000"}), dichotomizing, etc. will help decrease the variance significantly, but introduce more bias
...
### Stratified Sampling ![](./_resources/Experiments,_General.resources/0-J8zjvPFHFXLzz8S-.png){width="432"}
...
### Post-Stratification ![](./_resources/Experiments,_General.resources/0-pIj3JA8zlR7tiBb8.png){width="432"}
...
### CUPED ![](./_resources/Experiments,_General.resources/0-ib5g0xgoCjnx0nIk.png){width="432"}
...
-   Variance is reduced by calculating a weighted variance based on the variance of an individual's pre-experiment data![](./_resources/Experiments,_General.resources/0-9KenRS_cWlPpfbpj.png){width="432"}
    -   Y is the outcome variable
