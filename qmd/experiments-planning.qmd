...
-   Packages
    -   [{]{style="color: #990000"}[DeclareDesign](https://github.com/DeclareDesign/DeclareDesign){style="color: #990000"}[}]{style="color: #990000"} - A system for describing research designs in code and simulating them in order to understand their properties (Also see book)
-   Resources
