...
![](./_resources/Experiments,_General.resources/0-ib5g0xgoCjnx0nIk.png){.lightbox width="432"}
...
-   Variance is reduced by calculating a weighted variance based on the variance of an individual's pre-experiment data\
    ![](./_resources/Experiments,_General.resources/0-9KenRS_cWlPpfbpj.png){.lightbox width="332"}
    -   Y is the outcome variable
