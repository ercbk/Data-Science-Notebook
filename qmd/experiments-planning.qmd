...
-   Error\
    ![](./_resources/Experiments,_General.resources/image.png){width="432"}
...
-   `PUMP::pump_power`
    ...
    -   Example
        ...
        -   Results\
            ![](./_resources/Experiments,_General.resources/Screenshot%20(979).png){width="432"}
    ...
    -   `pump_sample()` calculates the sample size given target power (e.g. 0.80) and MDES
        ...
        -   Example\
            ...
            -   Results\
                ![](./_resources/Experiments,_General.resources/Screenshot%20(982).png){width="332"}
...
![](./_resources/Experiments,_General.resources/0-J8zjvPFHFXLzz8S-.png){width="332"}
...
![](./_resources/Experiments,_General.resources/0-pIj3JA8zlR7tiBb8.png){width="332"}
...
![](./_resources/Experiments,_General.resources/0-ib5g0xgoCjnx0nIk.png){width="432"}
...
-   Variance is reduced by calculating a weighted variance based on the variance of an individual's pre-experiment data\
    ![](./_resources/Experiments,_General.resources/0-9KenRS_cWlPpfbpj.png){width="332"}
    -   Y is the outcome variable
...
-   Does the same thing as CUPAC to get the control covariate, but instead using the CUPED equation with θ to get Ycuped, it estimates Ycuped using OLS regression.\
    ![](./_resources/Experiments,_General.resources/0-FZBHn5GVEJGrvhsC.png){width="332"}
