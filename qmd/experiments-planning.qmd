...
- Resources
  - [Bayesian Clinical Trial Design Course](https://hbiostat.org/bayes/) (Harrell)
    - [Goal-Driven Flexible Bayesian Design](https://hbiostat.org/bayes/design)
...
- Common Issues ([source](https://statmodeling.stat.columbia.edu/2026/08/02/what-gets-you-is-not-what-you-dont-know-but-what-you-dont-know-you-dont-know/))
  - Biased measurements
  - Selection bias into the observed dataset
  - Differences between treatment and control groups
  - Nonstationarity or, in general, differences between sample and population of interest
  - Biased or noisy statistical estimates
  - Missing data
  - Problems with functional forms (for example, using a linear model for a nonlinear relation, or not including important interactions)
  - Problems with error terms (dependence, choice of distribution, etc.)
  - Unmodeled spillovers, hierarchical structure, or other violations of causal model assumptions,
  - Researcher degrees of freedom and forking paths
...
- Packages
  ...
  - [{]{style="color: #990000"}[bayespmtools](https://github.com/resplab/bayespmtools){style="color: #990000"}[}]{style="color: #990000"} ([Paper](https://onlinelibrary.wiley.com/doi/10.1002/sim.70389)) - Performs **Bayesian** sample size, precision, and value-of-information analysis for **external validation of existing multi-variable prediction models** **(Harrell-supported**)
  ...
  - [{]{style="color: #990000"}[gsDesignNB](https://cran.r-project.org/web/packages/gsDesignNB/index.html){style="color: #990000"}[}]{style="color: #990000"} - Sample Size and Simulation for **Negative Binomial** Outcomes
  ...
  - [{]{style="color: #990000"}[mixpower](https://cran.r-project.org/web/packages/mixpower/index.html){style="color: #990000"}[}]{style="color: #990000"} - A comprehensive, **simulation-based** toolkit for power and sample-size analysis for **linear and generalized linear mixed-effects models**
  ...
  - [{]{style="color: #990000"}[pmsampsize](https://cran.r-project.org/web/packages/pmsampsize/index.html){style="color: #990000"}[}]{style="color: #990000"} - Computes the minimum sample size required for the development of a new **multivariable prediction model** (continuous, binary or survival (time-to-event) outcomes) using [Riley et al (2018)](https://onlinelibrary.wiley.com/doi/10.1002/sim.7992) criteria.
  ...
  - [{]{style="color: #990000"}[pwranova](https://mutopsy.github.io/pwranova/){style="color: #990000"}[}]{style="color: #990000"} ([vignette](https://joss.theoj.org/papers/10.21105/joss.10123)) - Performs power analysis for **between-, within-, and mixed factor ANOVA** designs, with full support for main effects, interactions, and planned contrasts (user-defined contrast weights).
