...
-   Taste variation due to unobserved factors
...
-   Random Coefficients
    ...
    $$
    U_{ni} = \hat{\beta}_n \boldsymbol{x}_{nj} + \epsilon_{nj}
    $$

    -   This is a random utility model with individual coefficients --- meaning each decision-maker has a $\beta$
