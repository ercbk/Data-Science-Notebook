...
-   [{]{style="color: #990000"}[bmco](https://cran.r-project.org/web/packages/bmco/index.html){style="color: #990000"}[}]{style="color: #990000"} - Bayesian Analysis for Multivariate Categorical Outcomes
    -   Includes basic tests using multivariate Bernoulli distributions, subgroup analysis via generalized linear models, and multilevel models for clustered data.
...
-   [{]{style="color: #990000"}[mcglm](https://github.com/wbonat/mcglm){style="color: #990000"}[}]{style="color: #990000"} ([Vignette](https://www.jstatsoft.org/article/view/v084i04)), [{]{style="color: goldenrod"}[mcglm](https://mcglm.readthedocs.io/en/latest/){style="color: goldenrod"}[}]{style="color: goldenrod"} ([JOSS](https://joss.theoj.org/papers/10.21105/joss.06037)) - Fits multivariate covariance generalized linear models (McGLMs)
