...
-   Packages
    ...
    -   [{]{style="color: #990000"}[mnlogit](https://www.jstatsoft.org/article/view/v075i03){style="color: #990000"}[}]{style="color: #990000"} - (CRAN archived with no github) efficient estimation of MNL for large
