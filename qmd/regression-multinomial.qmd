...
-   [Example]{.ribbon-highlight}: Convert data to {dfidx} format
    ...
    -   Convert **Long**
        ...
        print(tibble(heating_long_dfidx), n = 5)
        #> # A tibble: 4,500 × 8
        #>    income agehed rooms region    ic    oc choice idx$idcase $alt 
        #>     <dbl>  <dbl> <dbl> <fct>  <dbl> <dbl> <lgl>       <dbl> <fct>
        #>  1      7     25     6 ncostl  860.  553. FALSE           1 ec   
        ...
        -   `idx`: Since the df is already in long format, the id variabler ("idcase") has multiple observations for each id. Therefore, there needs be more than 1 variable to create a unique identifier.
