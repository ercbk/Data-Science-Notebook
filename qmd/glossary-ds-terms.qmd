# Glossary: DS terms {#sec-ds-gloss}
...
-   OOD - out-of-distribution - data which differ from the training data and on which a model might underperform Open Cohort - subjects can leave or be added over time.
