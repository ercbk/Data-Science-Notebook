...
-   Models with large numbers (100s) of features increases the opportunity for feature drift\
    ![](./_resources/Feature_Engineering,_Time_Series.resources/1-8r1PGJhLRwVfTpIdbwi76Q.png){width="432"}
...
-   Package feature set comparison
    ...
    -   feature redundancy\
        ![](./_resources/Feature_Engineering,_Time_Series.resources/FChllqkVUAAp3rh%20(3).jpg){width="432"}
        -   Says catch22 features have fewer things in common with each other that the other packages
    -   Computation time\
        ![](./_resources/Feature_Engineering,_Time_Series.resources/FChliV5VkAEL-y7.jpeg){width="632"}
...
-   As splines
    ...
    -   [Example]{.ribbon-highlight}: [{mgcv}]{style="color: #990000"}\
        ![](./_resources/Feature_Engineering,_Time_Series.resources/Screenshot%20(1374).png){width="532"}
...
### Rolling {#sec-feat-eng-ts-eng-roll .unnumbered}
