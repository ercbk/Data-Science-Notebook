...
-   Packages
    ...
    -   [{]{style="color: #990000"}[hdbcp](https://cran.r-project.org/web/packages/hdbcp/index.html){style="color: #990000"}[}]{style="color: #990000"} - Bayesian Change Point Detection for High-Dimensional Data
