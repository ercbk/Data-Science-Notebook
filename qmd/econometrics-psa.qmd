...
-   Bootstrapping
    ...
    -   `control.ratio` and `treat.ratio` parameters allow for undersampling in the case of imbalanced data
    ...
    -   Balance Plot
        -   Metric: Average Balance (t.test mean difference) across all covariates
