...
1.  Finish video
    -   Currently working on: Sensitivity Analysis
    ...
    -   Matching - Each treatment unit is paired with a comparison unit base upon the pre-treatment covariates
        ...
        -   Balance Assessment\
            ...
            psa::MatchBalance(df = lalonde, 
                              formu = lalonde.formu,
                              formu.Y = update.formula(lalonde.formu, 
                                                       re78 ~ .),
                              M = 1, 
                              estimand = 'ATT', 
                              ties = FALSE) |> 
            ...
            -   Charts
                ...
                -   Top-Right: Standardized Estimate for each covariate. A variable that's CI *doesn't* include 0 indicates an imbalance. (e.g. [nodegr]{.var-text})
                    ...
                    -   The estimate here looks like the after-adjustment estimate from the Covariate Balance Plot except with error bars.
...
-   Selection Bias Ratio
    ...
    -   Example: In smoking studies, the ratio is around 6 which means the results are very robust to unobserved confounders. Anything around 1 is considered sensitive to confounders.
