...
-   Process\
    ![](_resources/Econometrics-PSA.resources/workflow-1.png){width="632"}
...
-   Methods:
    ...
    -   Matching - Each treatment unit is paired with a comparison unit base upon the pre-treatment covariates
        ...
        -   Dependent Sample Assessment Plot\
            ![](_resources/Econometrics-PSA.resources/match-assess-1.png){width="532"}
        ...
        -   Balance Assessment\
            ![](_resources/Econometrics-PSA.resources/match-bal-assess-1.png){width="632"}
...
-   Visualization
    ...
    -   Distribution of propensity scores\
        ![](_resources/Econometrics-PSA.resources/ps-distr-1.png){width="532"}
    ...
    -   Covariate Balance Plot\
        ![](_resources/Econometrics-PSA.resources/covar-bal-1.png){width="532"}
    ...
    -   Boxplot by Propensity Score Strata by Treatment\
        ![](_resources/Econometrics-PSA.resources/strat-box-1.png){width="532"}
    ...
    -   Stacked Bar Chart by Propensity Score Strata by Treatment\
        ![](_resources/Econometrics-PSA.resources/strat-bar-1.png){width="532"}
    ...
    -   Propensity Score Assessment Plot\
        ![](_resources/Econometrics-PSA.resources/ps-assess-1.png){width="432"}
    ...
    -   LOESS Plot\
        ![](_resources/Econometrics-PSA.resources/loess-1.png){width="532"}
    ...
    -   Stratification Plot\
        ![](_resources/Econometrics-PSA.resources/strat-ttest-indep-2.png){width="632"}
...
-   Bootstrapping
    ...
    -   [Example]{.ribbon-highlight}
        ...
        -   By default, `PSAboot` uses logistic regression (i.e. `boot.strata`) [{partykit::ctree}]{style="color: #990000"} ([See Algorithms, ML \>\> Trees \>\> Distributional Trees/Forests](algorithms-ml.html#sec-alg-ml-trees-distree){style="color: green"}), [{rpart}]{style="color: #990000"} (decision trees), [{Matching}]{style="color: #990000"}, and [{MatchIt}]{style="color: #990000"}, but `boot.weighting` is also available by manually specifying the functions through the [methods]{.arg-text} argument.
    ...
    -   Balance Plot\
        ![](_resources/Econometrics-PSA.resources/boot-bal-dens-1.png){width="532"}
    ...
    -   Box Plot\
        ![](_resources/Econometrics-PSA.resources/boot-box-1.png){width="532"}
    ...
    -   Correlation Between Boot Distributions\
        ![](_resources/Econometrics-PSA.resources/boot-matrix-1.png){width="432"}
