...
-   Packages
    ...
    -   [{]{style="color: #990000"}[RIIM](https://cran.r-project.org/web/packages/RIIM/index.html){style="color: #990000"}[}]{style="color: #990000"} - Randomization-based inference for average treatment effects in potentially inexactly matched observational studies. It implements the inverse post-matching probability weighting framewor
