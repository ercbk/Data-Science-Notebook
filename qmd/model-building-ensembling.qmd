...
* Feature-Weighted Linear Stacking (FWLS) ([Paper](https://arxiv.org/abs/0911.0460))
	...
	* Meta-features - should be discrete variables
		* Example (product sales model): current season, year, information about the products, and vendors variables![](./_resources/Model_Building,_Ensembling.resources/0-TKwF6j5rLGbOtvyS.png)
			* "benchmark" is just a 28-day MA model, prediction\_CNNLSTM is a DL model, and prediction\_XGBoost is an xgboost model
...
* With tidymodels objects
	from drob 1:58:08, [Predicting box office performance](https://www.youtube.com/watch?v=IkTfKnUoYf0)
...
* Steps:
	1. Add models and tune a penalyzed regression model to determine weights
		* blend\_predictions args: penalty, mixture, metric, control
			* control is for tune::control\_grid
