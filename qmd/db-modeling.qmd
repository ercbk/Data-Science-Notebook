...
-   Packages
    -   [{]{style="color: #990000"}[ReDaMoR](https://patzaw.github.io/ReDaMoR/){style="color: #990000"}[}]{style="color: #990000"} - Allows the manipulation of relational data models in R. It provides functions to create, import and save relational data models.
