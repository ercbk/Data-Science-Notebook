...
![](./_resources/Model_building,_sklearn.resources/1-ksGzeuAWrfPr_pjm4MLncw.png){width="498"}
...
-   K-Fold\
    ![](./_resources/Model_building,_sklearn.resources/image.1.png){width="508"}
    ...
    -   Shuffling: minimizes the risk of overfitting by breaking the original order of the samples\
        ![](./_resources/Model_building,_sklearn.resources/image.png){width="508"}

-   StratifiedKFold\
    ![](./_resources/Model_building,_sklearn.resources/image.2.png){width="508"}
...
-   ShuffleSplit, StratifiedShuffleSplit\
    ![](./_resources/Model_building,_sklearn.resources/image.3.png){width="508"}
...
-   TimeSeriesSplit\
    ![](./_resources/Model_building,_sklearn.resources/image.4.png){width="508"}
