...
-   End WSL session and go back to running VS Code locally with File \> Close Remote Connection.
...
-   [tarborist](https://open-vsx.org/extension/tylermorganwall/tarborist) - Static analysis for navigating and debugging complex R targets pipelines
