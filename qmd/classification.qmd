...
-   [**Calibrated**]{style="color: #14adff"}- When the predicted probabilities from a model match the observed distribution of probabilities for each class.
...
### Basic Workflow {#sec-class-calib-basflow  .unnumbered}
