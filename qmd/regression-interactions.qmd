...
-   Resources
    -   [{marginaleffects}]{style="color: #990000"} [book](https://marginaleffects.com/vignettes/get_started.html) - Docs for the package but also tons of examples; [python]{style="color: goldenrod"} and [r]{style="color: #990000"} code
