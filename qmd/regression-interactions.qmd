...
-   Packages
    -   [{]{style="color: #990000"}[APCinteraction](https://github.com/tranbaokhue/APCinteraction){style="color: #990000"}[}]{style="color: #990000"} - A nonparametric R package for detecting interaction in two-way ANOVA designs with balanced replication using all possible crossed comparisons (APC).
