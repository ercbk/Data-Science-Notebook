...
-   Packages
    -   [{]{style="color: #990000"}[marginaleffects](https://marginaleffects.com/){style="color: #990000"}[}]{style="color: #990000"}
        ...
        -   Functions
            ...
            -   `comparisons` - Family of functions that can compute and plot *relationships between
                two or more predictions*. This allows users to report many of the most common quantities of interest in statistical analyses: **contrasts, differences, risk ratios, odds ratios, lift, or even arbitrary user-defined functions of two predictions.**
    ...
    -   [{]{style="color: #990000"}[modelbased](https://easystats.github.io/modelbased/){style="color: #990000"}[}]{style="color: #990000"} - Easystats package built on top of marginaleffects and emmeans
...
-   Center continuous variables
    -   Centering fixes collinearity issues when creating powers and interaction terms ([CV post](https://stats.stackexchange.com/a/29782))
        ...
        -   Possibly may not always be the case. See paper, [Centering in Multiple Regression Does Not Always Reduce Multicollinearity: How to Tell When Your Estimates Will Not Benefit From Centering](https://journals.sagepub.com/doi/10.1177/0013164418817801)
...
-   [Example]{.ribbon-highlight}: Spam or Ham ([source](https://cogpsychreserve.netlify.app/posts/logistict.rope/beyondexclamation))
    ...
    -   Scaling the predictors first since our prior will have a mean of 0
    ...
    bayestestR::ci(main_effects, method = "HDI")
    ...
    -   Computes the average marginal effects which tell us how much each feature changes the probability of spam classification, averaged across all observations
    ...
    1.  How [incoherence's]{.var-text} effect changes with [word count]{.var-text}.
    2.  How [incoherence's]{.var-text} effect changes with [exclamation count]{.var-text}.
    3.  How [aggression's]{.var-text} effect changes with [exclamation count]{.var-text}.
    4.  How [aggression's]{.var-text} effect changes with [word count]{.var-text}.
