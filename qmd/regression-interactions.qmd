...
-   [Example]{.ribbon-highlight}: Spam or Ham
    ...
    -   By default, [{marginaleffects}]{style="color: #990000"} credible intervals in bayesian models are built as equal-tailed intervals. This can be changed to a highest density interval by setting a global option:
