...
-   Resources
    -   [{marginaleffects}]{style="color: #990000"} [book](https://marginaleffects.com/vignettes/get_started.html) - Docs for the package but also tons of examples; python and r code
...
-   [**Simple Effect**]{style="color: #009499"} - When a Independent Variable interacts with a moderator variable (MV), it's the differences in predicted values of the outcome variable at a particular *level* of the MV
    ...
    -   Simple Effect, rather than **Simple Slope**, is used when the moderator is a categorical variable instead of continuous, otherwise they're essentially the same thing.
    ...
    -   IMO this is the value is more useful than than a contrast of marginal effects
        -   For the contrast of marginal effects, the p-values are unhelpful and the interpretation of the results is kind of janky (see interpretation in continuous:continuous \>\> Test pairwise differences (contrasts) of marginal effects section).
...
-   [**Simple Slopes**]{style="color: #009499"} - When a Independent Variable interacts with a moderator variable (MV), it is the slope of that IV at a particular *value* of the MV.
    ...
    -   The Simple Slope represents a conditional effect, and specifically the effect of that predictor when the moderator is 0.
        ...
        -   Interpretation: Simple Slope, $\beta_1$, is the expected change in $Y$ after 1 unit change in $X_1$ when $X_2 = 0$
    ...
    -   Vs. Average Marginal Effect (AME)
