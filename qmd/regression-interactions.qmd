...
-   [**Moderator Variable (MV)**]{style="color: #009499"} - a predictor that changes the relationship of the IV on the DV, and it can be continuous or discrete. Used in an interaction to estimate its effect. (also see [Causal Inference \>\> Moderation Analysis](causal-inference.qmd#sec-causinf-modanal){style="color: green"})
...
-   [**Simple Effect**]{style="color: #009499"} - When a Independent Variable interacts with a moderator variable (MV), it's the differences in predicted values of the outcome variable at a particular levels or values of the MV
...
-   [**Simple Slopes**]{style="color: #009499"}: when a Independent Variable interacts with a moderator variable (MV), its slope at a particular level or value of the MV

    -   The Simple Slope represents a conditional effect, and specifically the effect of that predictor when the moderator is 0.
        ...
        -   Interpret Simple Slope, $\beta_1$, as the expected change in $Y$ after 1 unit change in $X_1$ when $X_2 = 0$
            -   i.e. The difference in predicted values when $X_1$ increases by one unit while keeping $X_2$ held constant at 0
                ...
                #> 0.09534522
                ```
        -   When the moderator is centered at the mean, it is the Simple Slope at the mean of the moderator — also called the “**Main Effect**.”

    -   Vs. Marginal Effects

        -   Simple slopes are specific to interaction effects, while marginal effects can be calculated for any variable.
        -   Simple slopes show the relationship between two variables at a specific point, while marginal effects show the average relationship across all values of the other variables.
        -   Simple slopes help you understand how interaction effects work, while marginal effects help you quantify the overall effect of a variable.
...
-   [Example]{.ribbon-highlight}: Does the effect of workout duration (IV) on weight loss (Outcome) change due to the intensity of your workout (Moderator)?
    ...
    -   [Calculate marginal effects for the IV at 3 representative values for the moderator variable]{.underline}
        ...
        -   Interpretation:
            ...
            -   marginal effect of Hours is significant only for mean Effort levels and above (i.e. CIs for mean and high effort don't include 0)
    ...
    -   [Test pairwise differences (contrasts) of simple effects]{.underline}
...
-   [Example]{.ribbon-highlight}:
    ...
    -   [Simple effects at values of the IV]{.underline}
        ...
        -   [Example]{.ribbon-highlight}: ([article](https://cscu.cornell.edu/wp-content/uploads/84_lgsint.pdf))
            ...
            -   [Simple Effects: Odds Ratios]{.underline}\
                ![](./_resources/Regression,_Interactions.resources/Screenshot%20(837).png){width="400"}
            ...
            -   Simple Effects: Probabilities\
                ![](./_resources/Regression,_Interactions.resources/Screenshot%20(838).png){width="462"}
    ...
    -   [Plot the simple effects]{.underline}\
        ![](./_resources/Regression,_Interactions.resources/image.png){width="532"}
        ...
        -   [{marginaleffects}]{style="color: #990000"}
            -   You change the `comparisons` (see above) type arg to "type = link" to get log-ORs (aka logits) instead of probabilities and then plot\
                ![](./_resources/Regression,_Interactions.resources/image.2.png){width="532"}
        -   Interpretation
    ...
    -   [Plot simple effects and facet by values of the adjustment variable]{.underline}\
        ![](./_resources/Regression,_Interactions.resources/image.1.png){width="632"}
...
-   Types
    ...
    -   [Continuous:Discrete]{.underline} --- difference in the marginal effect of the continuous predictor between two selected values of the discrete predictor
        -   [Example]{.ribbon-highlight}: Poisson outcome (population)\
            ...
            -   Specific values for x1 and x2 must be chosen to the calculate the value of the effect\
                ![](./_resources/Regression,_Interactions.resources/Screenshot%20(1202).png){width="532"}
            ...
            -   Visual\
                ![](./_resources/Regression,_Interactions.resources/image.3.png){width="382"}
