...
-   [Example]{.ribbon-highlight}: Spam or Ham
    -   Set-Up
        ...
        -   By default, {marginaleffects} credible intervals in bayesian models are built as equal-tailed intervals. This can be changed to a highest density interval by setting a global option:
