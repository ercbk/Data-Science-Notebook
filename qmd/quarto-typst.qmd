...
- Packages
  ...
  - [{]{style="color: #990000"}[gribouille](https://m.canouil.dev/gribouille/){style="color: #990000"}[}]{style="color: #990000"} - Compose charts by layering data, aesthetic mappings, geoms, scales, and themes. The same grammar as ggplot2 and plotnine, drawn natively in Typst.
...
- Including [{gt}]{style="color: #990000"} tables ([source](https://bsky.app/profile/sivuyilenzimeni.com/post/3mencxoea7s22))
