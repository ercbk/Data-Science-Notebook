...
-   Basket Complementary ([article](https://realworlddatascience.net/news-and-views/datasciencebites/posts/2023/03/02/basket-complementarity.html))\
    ![](./_resources/Algorithms,_Product.resources/image.1.png){.lightbox}
...
-   Compare cohorts by month
    ...
    -   Example\
        ![](./_resources/Algorithms,_Product.resources/1-fNuC2YvkGNAIjaqFia6_TQ.png)
...
-   As a percent\
    ![](./_resources/Algorithms,_Product.resources/1-zMbZ1kd5TxRwUW2lE1dMEw.png)
...
-   Compare cohorts by period\
    ![](./_resources/Algorithms,_Product.resources/1-hiH0xEGNLzVFhtWhPoGeqA.png)
...
-   Heatmap table\
    ![](./_resources/Algorithms,_Product.resources/1-PnsaN6fC1i97_x-Bnbzzkg.png)
