...
-   Packages
    -   [{]{style="color: #990000"}[foretell](https://github.com/sriharitn/foretell){style="color: #990000"}[}]{style="color: #990000"} - Project Customer Retention based on Fader and Hardie et. al. Probability Mixture Models
