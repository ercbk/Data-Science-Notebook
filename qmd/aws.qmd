...
* https://ercbk.signin.aws.amazon.com/console
...
* **EC2**
	...
	* left\_panel -- Network and Security
		...
		* Key Pairs
			* a form of tags that you can use to access your instance more easily,
				...
				* pairs are key:value. Example: key= sales, value  = sales\_forecast
		* Network Interfaces
	...
	* **Connect to/ Terminate Instance (also see Docker -- aws -- create cluster ssh -- open port)**
		...
		* Terminate
			* left panel -- instances -- instances
				* select instance you want to terminate -- right click instance\_id (or anywhere on row) --- instance state -- terminate
	...
	* **Configure Load Balancer and Application ports (also see Docker notebook, aws load balancer section)**
...
* **S3**
	...
	* Create Bucket Policy to allow for public download (from a weblink)
		...
		3. Bucket policy requires a json expression
			...
			6. Amazon Resource Name
				...
				* your substituting your bucket\_name/key\_name into the expression
					* for key name he used \* to signify "everything", but I think this would be your path to the resources (not including bucket\_name)
	...
	* View buckets you have permissions with
