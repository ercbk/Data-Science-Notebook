...
-   Packages
    ...
    -   [{]{style="color: #990000"}[staRburst](https://starburst.ing/){style="color: #990000"}[}]{style="color: #990000"} - Lets you run parallel R code on AWS with zero infrastructure management.
        -   Scale from your laptop to 100+ cloud workers with a single function call.
        -   Supports both EC2 (recommended for performance and cost) and Fargate (serverless) backends.
