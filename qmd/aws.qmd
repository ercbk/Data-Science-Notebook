...
-   Packages
    ...
    -   [{]{style="color: #990000"}[sixtyfour](https://cran.r-project.org/web/packages/sixtyfour/index.html){style="color: #990000"}[}]{style="color: #990000"} - An opinionated interface to Amazon Web Services, with functions for interacting with 'IAM' (Identity and Access Management), 'S3' (Simple Storage Service), 'RDS' (Relational Data Service), Redshift, and Billing
