...
## Misc {#sec-dl-graph-misc .unnumbered}

-   Packages
    -   [{]{style="color: #990000"}[torchgnn](https://josiahparry.github.io/torchgnn/){style="color: #990000"}[}]{style="color: #990000"} - Graph Neural Networks for [{torch}]{style="color: #990000"} in R
