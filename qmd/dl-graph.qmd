...
* [**Isomorphism**]{style='color: #14adff'} \- two graphs are isomorphic if there is a mapping between their nodes in which we can conclude that these graphs are in fact the same
