...
* Statistical Rethinking
	...
	* Formulating an intercept prior
	* Formulating a slope prior
	* Formulating a sigma prior
	* Extracting a prior
	* Simulating a prior predictive distribution
	* Conjugate priors
* Prior Elicitation
...
* Misc
	...
	* Comparing the posteriors with the priors![](./_resources/Bayes,_priors.resources/image.1.png)
...
* [Example]{.ribbon-highlight} (Ch 11 pg 335-6)
	* With logistic regression, flat Normal priors aren't priors with a high sd.![](./_resources/Bayes,_priors.resources/Screenshot (199).png)
...
* [Example]{.ribbon-highlight}
	...
	* ![](./_resources/Bayes,_priors.resources/Screenshot (220).png)
...
* Formulating a slope prior
	...
	* `example` (pg 336-7)
		* With logistic regression, flat Normal priors aren't priors with a high sd.![](./_resources/Bayes,_priors.resources/Screenshot (200).png)
	...
	* `example` (pg 357)
		...
		* ![](./_resources/Bayes,_priors.resources/Screenshot (222).png)
...
* outcome: total\_tools, predictor: log\_population
* Bottom row fig titles have a typo. Should be a ~ dnorm(3, 0.5) since it's the Intercept prior
* variables have been standardized; total\_tools simulated with intercept + predictor priors. So the y axis is simulating the potential fitted values.
* top left (0 is mean of log\_population):
	* large sd: mostly results in explosive growth of tools just after mean of log\_population or explosive decline just before mean log\_population (unlikely)
* top right (0 is mean of log\_population)
...
* Formulating a sigma prior
	...
	* Tightening the spread of the Exponential distribution by using a Gamma distribution ([Thread](https://twitter.com/SolomonKurz/status/1592645019273682945))![](./_resources/Bayes,_priors.resources/image.png)
		* You can keep "mean = 1" (aka exponential(1) and adjust the "sd".
			* See [Distributions](Distributions) >> Gamma for details on the process
...
* Extracting a prior from a model
	* Example Logistic Regression (sect 11.1.1 pg 336)
		* Intercept
...
![](./_resources/Bayes,_priors.resources/unnamed-chunk-9-1.png)
...
![](./_resources/Bayes,_priors.resources/unnamed-chunk-37-1.png)
...
![](./_resources/Bayes,_priors.resources/unnamed-chunk-4-1.png)
...
![](./_resources/Bayes,_priors.resources/unnamed-chunk-5-1.png)
	...
	* Process
		1. Elicit location parameter (e.g. via Trial Roulette) from the expert
			* Trial Roulette (see paper in Misc for details)
				...
				* Example: From MATCH website which was an earlier implementation of [{SHELF}]{style='color: #990000'}![](./_resources/Bayes,_priors.resources/Screenshot (906).png)
...
* Evaluating Expert Distribution(s)
	* Misc
		* Might be better to use another measure instead of K-L divergence (see Inspect the distributions visually section below)
			* e.g Jensen-Shannon Divergence, Population Stability Index (see [Production, ML Monitoring](Production, ML Monitoring) for details)
