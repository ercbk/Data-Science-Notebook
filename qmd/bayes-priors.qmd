# Priors {#sec-priors .unnumbered}

## Misc {#sec-priors-misc .unnumbered}
...
-   Prior sensitivity analysis
    ...
    -   {[BayesSenMC](https://cran.r-project.org/web/packages/BayesSenMC/index.html)}
...
-   Statistical Rethinking
    ...
    -   Comparing the posteriors with the priors\
        ![](./_resources/Bayes,_priors.resources/image.1.png){width="532"}

## Preprocessing {#sec-priors-preproc .unnumbered}
...
## Get Prior Recommendations {#sec-priors-getprecs .unnumbered}
...
## Formulating an Intercept Prior {#sec-priors-finterp .unnumbered}
...
-   [Example]{.ribbon-highlight} (Ch 11 pg 335-6)
    ...
    -   With logistic regression, flat Normal priors aren't priors with a high sd.\
        ![](./_resources/Bayes,_priors.resources/Screenshot%20(199).png){width="332"}
...
-   [Example]{.ribbon-highlight}
    ...
    -   In poisson regression, flat normal priors aren't priors with high s.d.\
        ![](./_resources/Bayes,_priors.resources/Screenshot%20(220).png){width="332"}
...
## Formulating a Slope Prior {#sec-priors-fslopp .unnumbered}
...
-   [Example]{.ribbon-highlight} SR pg 336-7
    ...
    -   With logistic regression, flat Normal priors aren't priors with a high sd.\
        ![](./_resources/Bayes,_priors.resources/Screenshot%20(200).png){width="332"}
...
-   [Example]{.ribbon-highlight}: pg 357
    ...
    ![](./_resources/Bayes,_priors.resources/Screenshot%20(222).png){width="532"}
...
## Formulating a Sigma Prior {#sec-priors-fsigp .unnumbered}
...
-   Tightening the spread of the Exponential distribution by using a Gamma distribution ([Thread](https://twitter.com/SolomonKurz/status/1592645019273682945))\
    ![](./_resources/Bayes,_priors.resources/image.png){width="532"}
...
## Extracting a Prior From a Model {#sec-priors-eapfam .unnumbered}

-   Example: Logistic Regression (SR sect 11.1.1 pg 336)
    -   Intercept

        ![](./_resources/Bayes,_priors.resources/unnamed-chunk-9-1.png){width="332"}
...
## Simulating a Prior Predictive Distribution {#sec-priors-simppd .unnumbered}
...
-   [Example]{.ribbon-highlight}: SR pg 176
    ...
    -   Visualize with ggplot
        ...
        ![](./_resources/Bayes,_priors.resources/unnamed-chunk-37-1.png){width="432"}
...
-   [Example]{.ribbon-highlight}:
    ...
    -   Possible Intercept Priors
        ...
        ![](./_resources/Bayes,_priors.resources/unnamed-chunk-4-1.png){width="432"}
    ...
    -   Sampling of lines from $\beta_0$ and $\beta_1$ priors
        ...
        ![](./_resources/Bayes,_priors.resources/unnamed-chunk-5-1.png){width="432"}
...
## Conjugate Priors {#sec-priors-conjp .unnumbered}
...
## Prior Elicitation {#sec-priors-pelic .unnumbered}
    ...
    -   Process
        1.  Elicit location parameter (e.g. via Trial Roulette) from the expert
            -   Trial Roulette (see paper in Misc for details)
                ...
                -   [Example]{.ribbon-highlight} From MATCH website which was an earlier implementation of [{SHELF}]{style="color: #990000"}![](./_resources/Bayes,_priors.resources/Screenshot%20(906).png){width="632"}
