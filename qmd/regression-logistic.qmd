...
-   [Example 2]{.ribbon-highlight}: Interactions
    ...
    ``` r
    avg_slopes(m_bin_int, 
               variables = "age_cats",
               by = "passengerClass")
    #>    Contrast passengerClass Estimate Std. Error        z Pr(>|z|)     S  2.5 %  97.5 %
    #> 10-30 - <10            1st  -0.0206     0.2218  -0.0928  0.92605   0.1 -0.455  0.4141
    #> >30 - <10              1st  -0.1551     0.2193  -0.7072  0.47942   1.1 -0.585  0.2748
    #> 10-30 - <10            2nd  -0.5821     0.0426 -13.6617  < 0.001 138.7 -0.666 -0.4986
    #> >30 - <10              2nd  -0.6476     0.0466 -13.8914  < 0.001 143.3 -0.739 -0.5562
    #> 10-30 - <10            3rd  -0.1867     0.0710  -2.6304  0.00853   6.9 -0.326 -0.0476
    #> >30 - <10              3rd  -0.2566     0.0744  -3.4495  < 0.001  10.8 -0.402 -0.1108
    #>
    #> Term: age_cats
    #> Type:  response
