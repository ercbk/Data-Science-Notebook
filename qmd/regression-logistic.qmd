...
-   [Example 2]{.ribbon-highlight}: Interactions
    ...
    -   [Age]{.var-text} was centered and the influential point was removed.
    ...
    -   (Not shown) [For the centered age model, the marginal means, slopes, and their contrasts are the same. Only thing you need to do for any table or visualization is back-transform the centered values back to the orginal ages (add mean to age value).]{.underline}
    ...
    -   The spline model seems to have a slightly better AICc and R^2^.
