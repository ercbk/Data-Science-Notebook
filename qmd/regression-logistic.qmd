...
-   [Example 2]{.ribbon-highlight}: Interactions
    ...
    performance::check_model(m_bin_int_bal)
    performance::check_model(m_spl_int_cent)
    ...
    -   Technically you can't compared Residual Deviance scores since I removed an observationThe spline model seems to have a slightly better AICc and R^2^.
    ...
    -   For the spline model (continuous:categorical), a few of the point estimates have sizable uncertainty (SEs) associated with them. This is likely due to the collinearity that's still present between the interaction and main effects terms (high VIFs).
    ::::::
