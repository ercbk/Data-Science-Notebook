...
-   See [Thread](https://fosstodon.org/@teunbrand/111733396842023203) on an analysis workflow using {targets}
...
-   Slide Report Examples
    -   Good Data\
        ![](_resources/Project-Analyses.resources/data-meta-ex-good-1.png){width="432"}
    -   Bad Data\
        ![](_resources/Project-Analyses.resources/data-meta-ex-bad-1.png){width="432"}
