...
-   See [Thread](https://fosstodon.org/@teunbrand/111733396842023203) on an analysis workflow using [{targets}]{style="color: #990000"}
...
-   Process
    ...
    2.  Creating a MECE framework/ decomposing the problem
        -   Creating an [Issue Tree](https://en.wikipedia.org/wiki/Issue_tree)
            -   This are basicially the same thing as [Driver Trees](https://ercbk.github.io/Domain-Knowledge-Notebook/qmd/kpis.html#sec-kpis-dtree){style="color: green"} except that intead of breaking down a KPI into it's constituent metrics, you're breaking down an issue into potential solutions.
        ...
        -   Utilize the issue tree to create a ghost deck of the final output. A ghost deck is a wireframe of the slides that the consultant will deliver at the end of the engagement. Having the ghost allows consistent and precise alignment among team members as well as with the client. The rest of the study is about filling in the ghost pages.
            -   It's framing your thoughts about solutions and creating hypotheses before diving into collecting data
            -   It's the client and the consultant mapping out and agreeing on the deliverable.
    3.  Analyzing data as a means to updating their understanding of the problem
        -   The wireframe of the deliverable guides you on the data to collect and the analyses to conduct.
        -   Process
            -   The hypothesis from the ghost deck states which branch of their issue tree is most important. This will be at the top level of the issue tree.
            -   The consultant purposefully seeks out only the necessary data to confirm or refute the hypothesis and performs the analysis.
            -   The result of the analysis is a “so-what” (or synthesis) revealing which branches of the issue tree are a dead end.
            -   The synthesis is brought back to the original issue tree, adjustments are made and the cycle repeats as often as needed.
                -   Data analysis is not an end, but a means to refining the understanding of the problem and narrowing the issue tree.
-   [Example]{.ribbon-highlight}
    -   Problem Statement: "Your client is a large manufacturing company whose CEO has hired the Firm to help diagnose why profit has been flat over the past five years."
        ...
        -   Profit Margin is calculated by dividing the profit figure by revenue and multiplying by 100. So it's a percentage and can be compared against competitors in the same industry. Profit by itself would probably indicate a purpose that's more inward looking.
    -   Issue Tree
...
-   Bottom-up problem-solving begins with understanding the problem statement.
-   Then, one gathers a relevant data set and analyzes it for an indication of the underlying issue.
-   Perhaps this analysis involves graphing the data and performing some calculations.
-   Most often one forms insights and the cycle repeats with further data collection and analysis.
-   In this way, one builds a picture of the problem and solutions over time.
