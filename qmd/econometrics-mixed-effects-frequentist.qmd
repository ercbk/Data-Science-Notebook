...
-   [Motivation for using a Random Effects model]{.underline}
    ...
    -   These subgroup means significantly *deviate* from the big group mean.
        -   i.e. We suspect there to be between-subject variance and not just within-subject variance (linear model).
            ...
            -   The **Between-Subject Variance** isn't clearly depicted IMO. It captures the differences between individual subjects or groups in their average responses or outcomes.
                ...
                -   $\bar X$ is the overall mean of all observations pooled across groups.
...
-   2-stage model
    ...
    -   2^nd^ Stage\
        ...
        -   $A_i$ is a design matrix
            -   Typically an identity matrix it's a more complex model
        -   $b_i$ is the between-subject error. Isn't actually a subject-level vector of residuals. It's an estimated distribution.
...
-   Random Effects Variables
    -   Intercepts variables (e.g. v1) should be grouping variables (i.e. discrete or categorical) (e.g school, department)
    -   Slopes variables (e.g. v2) should be continuous within-subject variables (e.g time)
        -   These variables should also be included in the fixed effects
-   Fixed Effects should include within-subject variables (e.g slope variables) and between-subject variables (e.g. gender)
...
-   Check Degrees of Freedom in Fixed Effects Estimates
    ...
    -   Example
        ...
        -   The dof spikes to [162]{.arg-text} for the [Days]{.var-text} fixed effect which is close to the number of total observations at 180. This indicates a misspecified model.
            -   The [24.4905]{.arg-text} is actually okay the intercept.
