        ...
        -   If you have few data points in a group, the group's effect estimate will be based partially on the more abundant data from other groups. (2 min [video](https://www.youtube.com/watch?v=qMe7qwNMe-s))
            ...
            -   You can visualize the amount of regularization by comparing the conditional modes (see [Model Equation](econometrics-mixed-effects-frequentist.qmd#sec-econ-me-freq-modeq){style="color: green"} \>\> Conditional Modes) to the group means in the observed data.
                -   [Example]{.ribbon-highlight}\
                    ...
                    -   The conditional modes (gold) are all closer to the horizontal line representing the grand mean.
                    -   There are few data points in the first five subjects, so in general, they *pulled* more than the last five subject which have many more data points.
                        ...
                        -   Points already close to grand mean can't be *pulled* as much since they're already very close to the grand mean (e.g. subjects 3 and 5)
...
-   Issues with actually using a 2-stage approach
...
-   Conditional Modes
    ...
    -   Subject (aka unit) based esimates (e.g. the average rating (response) for judge 5 (grouping variable))
