...
-   Motivation for using a Random Effects model
    ...
    -   These *deviations* follow a distribution, typically Gaussian.
        ...
        -   GEEs are a semi-parametric option for panel data (See [Regression, Other](Regression,%20Other) \>\> Generalized Estimating Equations (GEE))
...
-   Specifications and Notation
    ...
    -   Varying Slopes: `(0 + v2| v1)`
        ...
        -   [Example]{.ribbon-highlight}: faculty SALARY (outcome) increase at different rates (slopes) depending on the DEPARTMENT (random variable).![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(926).png)![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(919).png)
    ...
    -   Varying Slopes and Intercepts: `(1 + v2 | v1)` or just `(v2 | v1)` (See examples)
        ...
        -   [Example]{.ribbon-highlight}: each DEPARTMENT (random variable) has a different starting (intercepts) SALARY (outcome variable) for their faculty members (observations), while the annual rate (slope) at which salaries increase varies depending on DEPARTMENT![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(922).png)![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(921).png)
    ...
    -   Nested effects
        ...
        -   Unit IDs may be repeated within groups. 
            -   [Example]{.ribbon-highlight}: `lme4::lmer(score ~ time  + (time | school/student_id))`
                ...
                -   You can verify this by calling `ranef` on the fitted model. It’ll show you the unique combinations of students within schools used in the model.
...
-   Strategy
    ...
    -   Process
        -   EDA at each level (see [EDA, Hierarchical](EDA,%20Hierarchical))
...
-   [Example]{.ribbon-highlight}: random intercept-only model (aka unconditional means model) from https://www.alexcernat.com/etimating-multilevel-models-for-change-in-r/
...
-   [Example]{.ribbon-highlight} (ggeffects error bar plot)
    ...
    -   Description:
        -   outcome: Distance; fixed effect: Season; random_effect: Athlete![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/staticunnamed-chunk-6-1.png)
...
Beyond Multiple Linear Regression ([link](https://bookdown.org/roback/bookdown-BeyondMLR/)) Chapter 8 (Introduction to Multilevel Models)
...
-   2-Stage Model
    ...
    -   Specification
        -   Level 1![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(929).png)
            -   bi is the fixed effect for subject/unit i  and observation j (i.e. each subject has repeated observations)
        -   Level 2![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(930).png)
...
-   Multi-Level
    ...
    -   Specification (composite model of level 1 and level 2 equations)![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(932).png)
    ...
    -   Interpretation (
        -   see 2-stage model for definitions for ai and bi
            ...
            -   Orchestral Instrumentalists (Orchi = 1) ai = (α0 + α1) + ui
...
-   Interpretations
    -   Fixed effects:
        ...
        -   \^β1 = −1.4 --- Orchestral instrumentalists (orch = 1) have an estimated mean decrease in performance anxiety (outcome) of 2.3 points when playing in large ensembles (large = 1) instead of solos or small ensembles (large = 0), 1.4 points greater than the mean decrease among keyboard players and vocalists (orch = 0).
            -   He's calculating simple slope/marginal effect (see [Regression, Interactions](Regression,%20Interactions)) and choosing to use that as the interpretation for the interaction term
...
-   Simple to Complex Model Building Workflow (using {lme4})
    ...
    -   **Unconditional Means (aka Random Intercepts)**
        -   Specification
            -   Level 1![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(931).png)
                -   ai is the true mean response of all observations for subjecti.
            -   Level 2![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(932).1.png)
                -   each subject's intercept is assumed to be a random value from a normal distribution centered at α0 with variance σ2u.
            -   Composite![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(933).png)
        -   Model
...
-   Interpretation
    ...
    -   ICC![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(935).png)
...
-   **Random Slopes and Intercepts Model (with 1 covariate)**
    -   1 - Level 1
    -   Specification
        -   Level 1![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(937).png)
        -   Level 2![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(938).png)
        -   Composite![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(939).png)
    -   Model
...
-   **Pseudo-R2** (Not always a reliable performance measure)![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(941).png)
...
-   **Random Slopes and Intercepts Model (with 2 covariates)**
    ...
    -   Pseudo-R2![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(945).png)
...
-   **Random Intercepts (with 2 covariates)**
    ...
    -   Specification
        -   Level 1![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(937).png)
        -   Level 2![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(948).png)![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(949).png)
...
-   **Random Slopes and Intercepts Model (with 3 covariates)**
    ...
    -   Specification
        -   Level 1![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(937).png)
        -   Level 2![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(956).png)
        -   Composite![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(957).png)
    -   Model
...
-   **Final Model**
    ...
    -   Specification
        -   Level 1![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(957).1.png)
        -   Level 2![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(958).png)
            -   Variance-Covariance matrix![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(959).png)
