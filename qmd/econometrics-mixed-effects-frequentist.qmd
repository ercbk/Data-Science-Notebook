...
-   Misc
    -   Also see [BMLR Ch 8 \>\> Model Building Workflow: Simple to Complex](econometrics-mixed-effects-frequentist.qmd#sec-econ-me-freq-bmlrch8-mbwkfw){style="color: green"}
...
-   [Example]{.ribbon-highlight}: Random Intercept w/1 covariate
