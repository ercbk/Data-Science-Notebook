...
-   Conditional Modes
    ...
    -   These are essentially just fitted values for a mixed effects model. The difference is having a different intercept value for each subject id and/or a different slope for each subject id.
    ...
    -   Get the conditional modes
        ...
        -   [Example]{.ribbon-highlight}
            ...
            new_dat <- dat.mod |> 
              distinct(id, grp.all)
            me_preds <- predict(mod.lmer2, new_dat)
