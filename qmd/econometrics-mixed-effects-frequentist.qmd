...
-   Mixed Effects Model = Random Effects model = Multi-Level model = Hierarchical model
    -   I've placed this model under econometrics, but it's not considered an "econometrics" model given how widely it's utilized across many disiplines and the history of it's development.
-   Bayesian
    -   Resources
