...
-   Packages
    ...
    -   [{]{style="color: #990000"}[mixedup](https://m-clark.github.io/mixedup/){style="color: #990000"}[}]{style="color: #990000"} - Helper functions to extract certain estimates (e.g. random and fixed effects, variance components, correlation structures, heterogeneous variances, etc.)
        -   Supports lme4, glmmTMB, nlme, mgcv, rstanarm, brms
    ...
    -   [Interpretation]{.underline}
        ...
        -   Random effects:
            ...
            -   Between-Case variance in the rates of change of [log income]{.var-text} over time
                ...
                -   2 standard deviations = $2 \cdot 0.1181 = 0.2362$. Therefore, for $95\%$ of the population, the effect of [wave0]{.var-text} can vary from $0.0419 - 0.2362 = -0.1943$ to $0.0491 + 0.2 362 = 0.2781$ from person to person.
