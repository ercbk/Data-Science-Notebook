# Mixed Effects, Frequentist {#sec-econ-me-freq .unnumbered}
...
-   Advantages of a mixed model (y \~ x + (x \| g)) vs a linear model with an interaction (y \~ x \* g)
    ...
    -   Example of model formula interpretation\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/FLvupd_WYAQPIzA.png){width="490"}
-   Packages
...
-   [Motivation for using a Random Effects model]{.underline}
    ...
    -   These *deviations* follow a distribution, typically Gaussian.
        ...
        -   GEEs are a semi-parametric option for panel data (See [Regression, Other \>\> Generalized Estimating Equations (GEE)](regression-other.html#sec-reg-other-gee){style="color: green"})
...
-   $\mathbb{E}(\alpha_i\;|\;x_{it}) = 0$: No time-constant unobserved heterogeneity
    ...
    -   [Example]{.ribbon-highlight}: Violation\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/unnamed-chunk-21-1.png){width="432"}
...
-   $\mathbb{E}(\epsilon_{it}|x_{it}) = 0$: No time-varying unobserved heterogeneity
...
-   Varying Intercepts: `(1 | v1)`
    ...
    -   [Example]{.ribbon-highlight}: Each DEPARTMENT (random variable) has a different starting (intercepts) SALARY (outcome variable) for their faculty members (observations), while the annual rate (slope) at which salaries increase is consistent across the university (i.e. effect is constant between-DEPARTMENTS)\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(925).png){width="332"}\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(917).png)
...
-   Varying Slopes: `(0 + v2| v1)`
    ...
    -   [Example]{.ribbon-highlight}: faculty SALARY (outcome) increase at different rates (slopes) depending on the DEPARTMENT (random variable).\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(926).png){width="332"}\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(919).png)
        -   Where j\[i\] is the index for "department"
...
-   Varying Slopes and Intercepts: `(1 + v2 | v1)` or just `(v2 | v1)` (See examples)
    ...
    -   [Example]{.ribbon-highlight}: Each DEPARTMENT (random variable) has a different starting (intercepts) SALARY (outcome variable) for their faculty members (observations), while the annual rate (slope) at which salaries increase varies depending on DEPARTMENT\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(922).png){width="332"}\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(921).png)
        -   Where j\[i\] is the index for "department"
...
-   Also see [Diagnostics, Mixed Effects](diagnostics-mixed-effects.qmd#sec-diag-me){style="color: green"}
...
-   **InterClass Coefficient (ICC)**: The proportion of variation that is between-cases\
    ...
    -   Statistical power is a function of ICC ([article](https://www.rdatagen.net/post/2023-04-18-generating-variable-cluster-sizes-to-assess-power-in-cluster-randomize-trials/))\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/image.png){width="432"}
...
-   [Example]{.ribbon-highlight}: Random Intercept w/covariate
...
![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/unnamed-chunk-8-1.png){width="432"}
...
![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/unnamed-chunk-9-1.png){width="432"}
...
-   [Example]{.ribbon-highlight} (ggeffects error bar plot)
    ...
    -   Description:
        -   outcome: Distance; fixed effect: Season; random_effect: Athlete![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/staticunnamed-chunk-6-1.png){width="432"}
...
## Beyond Multiple Linear Regression {#sec-econ-me-freq-bmlr .unnumbered}

### Chapter 8: Introduction to Multilevel Models {#sec-econ-me-freq-bmlr-ch8 .unnumbered}
-   [Chapter 8](https://bookdown.org/roback/bookdown-BeyondMLR/ch-multilevelintro.html)
-   Variable types
    -   Level One: variables measured at the most frequently occurring observational unit
...
-   2-Stage Model
    ...
    -   Specification
        -   Level 1\
            ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(929).png)
            -   bi is the fixed effect for subject/unit i  and observation j (i.e. each subject has repeated observations)
        -   Level 2\
            ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(930).png)
...
-   Multi-Level
    ...
    -   Specification (composite model of level 1 and level 2 equations)\
        ![](./_resources/Econometrics,_Mixed_Effects,_Frequentist.resources/Screenshot%20(932).png)
...
### Chapter 9: Two-Level Longitudinal Data {#sec-econ-me-freq-bmlr-ch9 .unnumbered}

-   [Chapter 9](https://bookdown.org/roback/bookdown-BeyondMLR/ch-lon.html)
-   Research Questions
