...
-   Packages
    -   [{]{style="color: goldenrod"}[BayesReconpy](https://github.com/supsi-dacd-isaac/BayesReconPy){style="color: goldenrod"}[}]{style="color: goldenrod"} ([JOSS](https://joss.theoj.org/papers/10.21105/joss.08336)) - Implements methods for probabilistic forecast reconciliation in Python. It reconciles hierarchies containing real-valued time series, discrete time series and a mixture of real-valued and discrete time series (mixed hierarchies).
    ...
    -   [{]{style="color: #990000"}[FoRecoML](https://cran.r-project.org/web/packages/FoRecoML/index.html){style="color: #990000"}[}]{style="color: #990000"} - Nonlinear forecast reconciliation with machine learning in cross-sectional, temporal, and cross-temporal frameworks.
