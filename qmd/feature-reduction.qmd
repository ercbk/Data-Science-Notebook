...
-   [Score]{.underline}\
    ![](./_resources/Feature_Reduction.resources/2366394336ffe4a6115881586f83d7e1.png){width="332"}
...
-   [Loadings]{.underline}\
    ![](./_resources/Feature_Reduction.resources/a6d71e21d4b297e8329c743c27938485.png){width="332"}
...
-   [Bi-Plot]{.underline}\
    ![](./_resources/Feature_Reduction.resources/0efe80c561a690a62b6dca162f5b9a13.png){width="332"}
...
-   [Interpretation]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: Bluejays
        -   Loadings\
            ![](./_resources/Feature_Reduction.resources/Screenshot%20(175).png){width="332"}

            -   PC2 represents the difference between bill size and skull size

        -   Loadings together with components plot\
            ![](./_resources/Feature_Reduction.resources/Screenshot%20(174).png){width="532"}
        ...
        -   Variance Explained\
            ![](./_resources/Feature_Reduction.resources/Screenshot%20(176).png){width="332"}
...
-   [Example]{.ribbon-highlight}: How much variation in a principal component can be explained by a categorical variable
    ...
    -   Adjusted R-squared: 0.8782\
        ![](./_resources/Feature_Reduction.resources/unnamed-chunk-7-1.png){width="332"}
...
-   [Mahalanobis Distance (MD)]{.underline}
    ...
    -   Displays the Mahalanobis distance (MD) for each observation and a reference line to identify outliers. The Mahalanobis distance is the distance between each data point and the centroid of multivariate space (the overall mean).\
        ![](./_resources/Feature_Reduction.resources/d349962d5f160247bd0a59ab00b3700c.png){width="332"}
...
-   [Leverage Points and Orthogonal Outliers]{.underline}
    ...
    -   Type determined by (see article for the math)
        ...
        -   Outliers are determined by Chi-Square test very similar to the Mahalanobis Distance method (see above).
            -   ![](./_resources/Feature_Reduction.resources/a14a590765997e1ee4237d709ab257a8.jpeg){width="332"}
            -   ![](./_resources/Feature_Reduction.resources/7b6db31e05cc082c8a294f5c9235e5dc.jpeg){width="332"}![](./_resources/Feature_Reduction.resources/1dd9c5064ccba6411dd4ac4ca303e4d2.jpeg){width="332"}
...
-   Comparison with PCA
    ...
    -   Factor Analysis is a latent variable measurement model
        -   The causal relationship is flipped in FA as compared to PCA.\
            ![](./_resources/Feature_Reduction.resources/KGM_Sept2016_Image2.png){width="332"}\
...
-   Process\
    ![](./_resources/Feature_Reduction.resources/1-saMdHDc81HA46DhLXow-Cg.png){width="432"}
...
-   Sparse Autoencoder (SE)\
    ![](./_resources/Feature_Reduction.resources/1-cs1t0PLZF4tsnRcY9GTFKA.png){width="532"}
    -   Uses regularization
