...
- Packages
  - [{]{style="color: #990000"}[apollo](https://cran.r-project.org/web/packages/apollo/index.html){style="color: #990000"}[}]{style="color: #990000"} - A very flexible tool for the estimation and application of choice models in R.
    - Users are able to write their own model functions or use a mix of already available ones.
    - Random heterogeneity, both continuous and discrete, and at the level of individuals and choices, can be incorporated for all models.
  - [{]{style="color: #990000"}[cash](https://cran.r-project.org/package=cash){style="color: #990000"}[}]{style="color: #990000"} - **Game-theoretic simulation of competitive reactions** among firms based on discrete choice models to improve decision making beyond traditional product (line) optimization
  - [{]{style="color: #990000"}[choicedata](https://cran.r-project.org/web/packages/choicedata/index.html){style="color: #990000"}[}]{style="color: #990000"} - Offers a set of objects tailored to simplify working with choice data. It enables the computation of choice probabilities and the likelihood of various types of choice models based on given data.
  - [{]{style="color: #990000"}[ChoiceModelR](https://cran.r-project.org/web/packages/ChoiceModelR/index.html){style="color: #990000"}[}]{style="color: #990000"} - Implements an MCMC algorithm to estimate a hierarchical multinomial logit model with a normal heterogeneity distribution.
  - [{]{style="color: #990000"}[fsprobit](https://github.com/delimited0/fsprobit){style="color: #990000"}[}]{style="color: #990000"} ([Paper](https://arxiv.org/abs/2407.09371))- Efficiently estimates large probit models on data with high-dimensional correlated discrete responses.
  - [{]{style="color: #990000"}[logitr](https://jhelvy.github.io/logitr/){style="color: #990000"}[}]{style="color: #990000"} ([Paper](https://www.jstatsoft.org/article/view/v105i10)) - Fast Estimation of Multinomial (MNL) and Mixed Logit (MXL) Models with Preference Space and Willingness to Pay Space Utility Parameterizations
  - [{]{style="color: #990000"}[validateHOT](https://github.com/JoshSchramm94/validateHOT){style="color: #990000"}[}]{style="color: #990000"} - Provides functions to evaluate validation tasks, perform market simulations, and convert raw utility estimates into scores that are easier to interpret
    - Validation metrics
...
- Resources
  - Urban Transportation Planning, [Ch. 4 Mode and Destination Choice](https://byu-transpolab.github.io/ceen565/chap-modechoice.html)
- Papers
  - [How-To: Model Destination Choice](https://rosap.ntl.bts.gov/view/dot/55803)
  - [Semiparametric APC Analysis of Destination Choice Patterns: Using Generalized Additive Models to Quantifythe Impact of Age, Period and Cohort on Travel Distances](https://github.com/bauer-alex/TravelDistAPC)
- Use Cases:
  - A widely used technique for the elicitation of consumer preferences and therefore foundation for product design
...
- [Example]{.ribbon-highlight}: Visualization
  ...
  - Kernel Density of Estimated Utilities
    ...
    ![](_resources/Econometrics-Discrete-Choice-Models.resources/binlogit-viz-kern-1.png){.lightbox width="332"}
  ...
  - Fraction of Choice (Adoption) vs Estimated Utility
    ...
    ![](_resources/Econometrics-Discrete-Choice-Models.resources/binlogit-viz-adoption.png){.lightbox width="332"}
...
- [Marginal Effects]{.underline}
  ...
  - [Cross Marginal Effect]{.underline} $$\text{CME} = \frac {\partial P_{ni}} {\partial z_{nj}} = -\beta_z P_{ni}P_{nj}$$
...
- [Elasticity]{.underline}
  ...
  - [Cross Elasticity]{.underline} $$E_{iz_{ni}} = -\beta_z z_{nj} P_{nj}$$
...
- [Estimator Options]{.underline} (See Week 13, video 5 lecture for details)
  ...
  - MSM - Some kind of method of moments algorithm
    - Method of Moments Characteristics ([link](https://towardsdatascience.com/why-and-when-to-use-the-generalized-method-of-moments-625f76ca17c0))
