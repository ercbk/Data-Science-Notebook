...
-   tl;dr:
    -   The Utility equation is the model equation.
        ...
        -   Observed Utility are our data, and Unobserved Utility are the residuals.
...
## Random Utility Models {#sec-decint-randutmod}
...
-   [Choice Probability for alternative, i, and decision-maker, n]{.underline}
    ...
    -   The probability that decision-maker, $n$, chooses alternative, $i$
        ...
        -   When data is at the market level, the $n$ index (i.e. individual) is removed from the equation above and the LHS becomes *Market Share* (See [Terms](regression-multinomial.qmd#sec-reg-multin-terms){style="color: green"}). The difference in market share between alternatives (e.g. brands) is:
            ...
            -   The index, $m$, is typically a reference level called the "outside option" (See [Terms](regression-multinomial.qmd#sec-reg-multin-terms){style="color: green"}) which is alternative of NOT doing an action where the utility is 0.
...
-   Utility
    -   Example: Go to college or get a job
        -   Decision maker attends college $iff \;\; TU_C > TU_W$

        -   2 Periods: Before College and After College
            ...
            -   $U_1W$ - Utility in period 1 from four years of working
            -   $U_{2j}^C$ - Utility in period 2 from job $j$ after attending college
            -   $U_{2j}^W$ - Utility in period 2 from job $j$ after working
            -   $\lambda$ reflects relative weighting of the two periods

        -   3 Periods: Before College, After College, and Start of Retirement
            ...
            -   $\theta$ - Reflects relative weighting of three periods
-   [Bellman Equation]{.underline}
    -   Incorporates Discounted Utility (See [Terms](regression-multinomial.qmd#sec-reg-multin-terms){style="color: green"}) into the Value Functions
    -   Value Functions
        ...
        -   Value Function
            ...
            -   $\delta$ - discount rate on utility in future periods (See [Terms](regression-multinomial.qmd#sec-reg-multin-terms){style="color: green"})
...
-   [Utility Model]{.underline}
    ...
    -   Therefore observed utility, $V$, gets separated into 2 componets, Consumer and Market.
        ...
        -   $p_{jm}$ - Price of product $j$ in market $m$
            ...
            -   1 product can be the "outside product" or purchase nothing category (See [Terms](regression-multinomial.qmd#sec-reg-multin-terms){style="color: green"}) which could be a vector of 0s
