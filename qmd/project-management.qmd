...
-   Misc
    -   Don’t start with the tech, start with the business need*.*
        -   Example: Spend time with customers, map their pain points, and ask: “If this technology worked perfectly, would it actually matter to them?”
-   Initiation
...
-   Execution & Controlling
    ...
    -   Communication with Stakeholders
        -   Concise and consistent weekly email to stakeholders
        -   Key Points
