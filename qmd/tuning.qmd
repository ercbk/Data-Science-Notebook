...
-   [Example]{.ribbon-highlight}: XGBoost ([article](https://towardsdatascience.com/pair-wise-hyperparameter-tuning-with-the-native-xgboost-api-2f40a2e382fa))
    ...
    -   Process
        ...
        -   etc.
-   Viz\
    ![](./_resources/Tuning.resources/image.5.png){width="432"}\
    ![](./_resources/Tuning.resources/image.4.png){width="432"}
...
-   Misc
    -   Implicit features selection is performed by splitting, but performance decreases substantially if over 100 noise-like features are added & drastically if over 500 noise-like features\
        ![](./_resources/Tuning.resources/image.2.png){width="532"}
-   Hyperparameters
    -   **mtry**: the number of trees at each node
        ...
        -   Increasing it improves performance in the presence of noise\
            ![](./_resources/Tuning.resources/image.3.png){width="532"}
...
-   Hyperparameters
    ...
    -   Regularization
        -   **reg_lambda (aka lambda)**, **reg_alpha (aka alpha), and gamma**:
            ...
            -   Also see
                -   [Algorithms, ML \>\> Boosting \>\> XGBoost](%7Balgorithms-ml.qmd#sec-alg-ml-boost-xgb%7D){style="color: green"} \>\> regularization
...
-   Misc
    ...
    -   Composite Structures
        -   W/sequential model pipelines (bottom to top)\
            ![](./_resources/Tuning.resources/image.1.png){width="432"}
            -   "dtr" = decision tree regression
        -   W/feature engineering models\
            ![](./_resources/Tuning.resources/image.png){width="532"}
...
-   Sequential Tuning
    ...
    -   [Example]{.ribbon-highlight}\
        ![](./_resources/Tuning.resources/Screenshot%20(913).png){width="432"}
        -   Structure
...
-   Simultaneous Tuning
    ...
    -   [Example]{.ribbon-highlight}\
        ![](./_resources/Tuning.resources/Screenshot%20(915).png){width="432"}
...
-   Weight Decay\
    ![](./_resources/Tuning.resources/image.6.png){width="632"}
