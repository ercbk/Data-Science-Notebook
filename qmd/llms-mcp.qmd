...
-   Skills (not sure where to put this section yet)

    -   Packages
        -   [{]{style="color: #990000"}[wf](https://cran.r-project.org/web/packages/wf/index.html){style="color: #990000"}[}]{style="color: #990000"} - Manage skills for large language model coding agents.
            -   Supports installing skills from 'GitHub' or local directories, tracking versions in a lock file, and keeping installations current.
            -   Installations can be scoped to a single project or shared globally across projects.
    -   Terms ([source](https://rworks.dev/posts/claude-skills-for-r-users/#quick-definitions))
        -   [Claude Code]{style="color: #009499"} ([Website](https://claude.com/product/claude-code)): A command-line interface (CLI) that brings Claude into your terminal.
        -   [CLAUDE.md]{style="color: #009499"} ([Docs](https://claude.com/blog/using-claude-md-files)): A configuration file where you can give Claude Code project-specific context, preferences, and instructions.
            -   [Sarah Johnson's for developing using tidyverse](https://gist.github.com/sj-io/3828d64d0969f2a0f05297e59e6c15ad)
        -   [CLAUDE Skill]{style="color: #009499"} ([Docs](https://claude.com/skills)): Reusable, specialized commands that help Claude handle common development tasks more consistently.
    -   Resources
        -   [How to Create a Skill](https://rworks.dev/posts/claude-skills-for-r-users/#how-to-add-a-claude-skill)
        ...
        -   [Awesome RStats Skills](https://github.com/christopherkenny/awesome-rstats-skills)
        -   [claude.nagdy.me](https://claude.nagdy.me/) - 11 interactive modules with terminal simulators, config builders, and quizzes. No setup required.
    -   Skills
        -   R
            ...
            -   [Get latest posit news skill](https://github.com/jeremy-allen/claude-skills/blob/main/deliver-posit-news/SKILL.md)
            ...
            -   [r-performance](https://github.com/ab604/claude-code-r-skills/tree/main/.claude/skills/r-performance)
                -   Teaches R performance optimization through profiling and benchmarking with profvis, bench::mark, vctrs, and parallel processing, including decision guidance on data.table vs dplyr trade-offs.
            -   [review-r](https://github.com/pedrohcgs/claude-code-my-workflow/tree/main/.claude/skills/review-r)
                -   Comprehensive review of R scripts across code quality, reproducibility, domain correctness, and professional standards. Generates detailed reports without modifying source files
            -   Packages
                -   [marginaleffects skill](https://github.com/vincentarelbundock/marginaleffects-SKILL) for both R and Python and both Claude and Codex
        -   Tools/Platforms
            -   [Dagster Claude Skills](https://github.com/dagster-io/skills)
            -   [DuckDB Skills](https://github.com/duckdb/duckdb-skills)
            -   [Hugging Face Skills](https://github.com/huggingface/skills) - Definitions for AI/ML tasks like dataset creation, model training, and evaluation. They are interoperable with all major coding agent tools like OpenAI Codex, Anthropic's Claude Code, Google DeepMind's Gemini CLI, and Cursor.
