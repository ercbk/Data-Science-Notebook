...
-   Notes from:
    ...
    -   Paper: [PSAgraphics: An R Package to Support Propensity Score Analysis](https://www.jstatsoft.org/article/view/v029i06#:~:text=PSAgraphics%20is%20an%20R%20package,having%20adjusted%20for%20covariate%20differences.)
...
-   Visualization
    ...
    -   Boxplot by Propensity Score Strata by Treatment
        ...
        -   Connected dots are the means within each distribution and numbers below each box are its sample size.
            ...
            -   Setting [trim = 0.5]{.arg-text} will connect medians
...
-   I have PCIe x1, x16, and a x16 that only has x4 bandwidth
-   Want western digital internal SSD 2TB PCIe for PC
    -   Will need to add drivers or something Bios to recognize PCIe NVMe SSD as a boot drive
