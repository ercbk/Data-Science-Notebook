...
-   salad items
    -   tomatoes that also can be used for burger
    -   artichoke hearts
-   dressing
-   chicken tenders
-   dessert
...
-   API: Strategies for long-running tasks
