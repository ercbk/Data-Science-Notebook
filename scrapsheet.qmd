...
-   Example: spatstat preprocessing
...
-   Example: Get point counts for each quadrat by region/subregion
...
-   Example: Toronto Fast Food\
    ...
    #> Multitype, with levels = Chicken, Hamburger, Pizza, Sub 
    #> window: polygonal boundary
    #> enclosing rectangle: [609550.5, 651611.8] x [4826375, 4857439] units

    qct_ff <- quadratcount(ppp_ff, nx = 3, ny = 3) # <2>
    table(qct_ff) # <3>
    ...
    -   To automatically create a window object using the boundaries from a sf object, [{sf}]{style="color: #990000"} needs to be loaded.
