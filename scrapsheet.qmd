...
-   **Not Actionable:** *Users under the age of 25 hardly use audiobooks.* → Is this good, bad? Should they be listening to audiobooks and is there anything we should do about it?

-   **Actionable:** *Users under the age of 25 hardly use audiobooks because they never explore the feature in the app. However users who listen to audiobooks have a 20% higher retention rate.* → This information tells us that audiobooks represent a potential opportunity to increase retention amongst younger users, however there seems to be more work to be done to encourage users exploring this feature.
