...
-   Notes not created but not added \_quarto.yml
    -   ide-positron
    -   llms-preprocessing
    -   llms-production
    -   job-consulting
...
-   todo
    ...
    -   Preprocessing
        ...
        -   aggregating census tract geometry variables to the NOX model geometry (towns?)
...
-   Preprocessing
    ...
    # remove censored home values and create a new nb list and add weights
    # this results in nodes w/o neighbors and 3 subgraphs
    ...
    # The NOX_ID variable specifies the upper-level aggregation, letting us aggregate the tracts to air pollution model output zones
    agg_96 <- list(as.character(boston_506$NOX_ID))
    boston_96 <- 
      aggregate(boston_506[, "NOX_ID"], 
                by = agg_96,
                unique)
    ...
    boston_96$NOX <- 
      aggregate(boston_506$NOX, 
                ...
                mean)$x
    boston_96$CHAS <-
      aggregate(as.integer(boston_506$CHAS)-1, 
                agg_96, 
                max)$x
    ```

-   Uses a discrete location/id variable as the group variable (i.e. varying intercepts by location). NOX_ID is the location variable for the NOX modelled values.
    ...
    -   lme4
        ...
        -   Not sure why Matrix needs to be called

    -   [hglm](https://cran.r-project.org/web/packages/hglm/index.html)
...
-   Simultaneous Autoregressive (SAR), Conditional Autoregressive (CAR), and Intrinsic CAR (ICAR) models use spatially structured random effects
    ...
    -   Examples
        ...
        -   [hglm](https://cran.r-project.org/web/packages/hglm/index.html) (CAR)
        ...
        -   [R2BayesX](https://cran.r-project.org/web/packages/R2BayesX/index.html) (ICAR)
        ...
        -   [INLA](https://www.r-inla.org/home) (ICAR)
