...
-   Used because we suspect there to be between-subject variance and not just within-subject variance (i.e. linear model).
-   2-stage model
    -   first stage\
        $$
        Y_i = Z_i\beta_i + \epsilon_i, \quad \epsilon \sim \mathcal N (0, \sigma^2I_{n_i})
        $$
