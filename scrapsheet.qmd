...
-   Spatial ME
    -   misc
        -   glmmTMB uses functions of the distance between observations, and fitted variograms to model the spatial autocorrelation present
    -   Data
    ...
    -   Uses a discrete location/id variable as the group variable (i.e. varying intercepts by location). NOX_ID is the location variable for the NOX modelled values.
        ...
        -   INLA
            ...
            ```
    -   Conditional Autoregressive (CAR) and Intrinsic CAR (ICAR) models in spatially structured random effects
