...
-   dressing
    -   season's
    -   ranch?
-   honey (or spicy?) mustard (tenders' dip)
-   yogurt
-   Claussan dill spears
-   Snack
    -   2 nuts
    -   2 candies
    -   1 chip
...
-   Packages
    ...
    -   [{]{style="color: #990000"}[veesa](https://cran.r-project.org/web/packages/veesa/index.html){style="color: #990000"}[}]{style="color: #990000"} - Pipeline for Explainable Machine Learning with Functional Data
